...
-   :wrench: **Developer Experience**
    ...
    Pre-configured quality tools, **100% code coverage** (1043 tests), architecture enforcement, hardened Docker template.
...
| Report | Description |
|--------|-------------|
| [🧪 Coverage Report](https://gabrielima7.github.io/TaipanStack/htmlcov/) | Full HTML coverage report — 100% (1043 tests) |
