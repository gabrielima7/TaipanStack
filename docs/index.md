...
[![CI](https://github.com/gabrielima7/TaipanStack/actions/workflows/ci-push-validate.yml/badge.svg?branch=main)](https://github.com/gabrielima7/TaipanStack/actions/workflows/ci-push-validate.yml)
...
-   :wrench: **Developer Experience**
    ...
    Pre-configured quality tools, **100% code coverage** (1,250 tests), architecture enforcement, hardened Docker template.
...
| Report | Description |
|--------|-------------|
| [🧪 Coverage Report](https://gabrielima7.github.io/TaipanStack/htmlcov/) | Full HTML coverage report — 100% (1,250 tests) |
