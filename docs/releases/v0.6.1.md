...
- **Cyclomatic Complexity Reductions**: Proactively refactored and extracted nested structures into dedicated private helpers across:
  - Adaptive resilience metrics generation, rate limiter finite validation, and retry attempt logic (`AdaptiveCircuitBreaker.metrics`, `RateLimiter._validate_finite`, `Retrier._should_retry`) (PR #1124).
  - Adaptive resilience and JWT validation (`AdaptiveCircuitBreaker._evaluate_trip`, `_validate_jwt_algorithms`) (PR #1104).
...
**Full Changelog:** [v0.6.0...v0.6.1](https://github.com/gabrielima7/TaipanStack/compare/v0.6.0...v0.6.1)
