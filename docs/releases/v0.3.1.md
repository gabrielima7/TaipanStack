---
description: "TaipanStack v0.3.1 release: advanced type hinting, monitoring callbacks, and security edge-case hardening."
---
...
**Files**:
- [`src/taipanstack/core/result.py`](https://github.com/gabrielima7/TaipanStack/blob/main/src/taipanstack/core/result.py)
- [`src/taipanstack/utils/retry.py`](https://github.com/gabrielima7/TaipanStack/blob/main/src/taipanstack/utils/retry.py)
- [`src/taipanstack/utils/circuit_breaker.py`](https://github.com/gabrielima7/TaipanStack/blob/main/src/taipanstack/utils/circuit_breaker.py)
...
**Files**:
- [`src/taipanstack/security/guards.py`](https://github.com/gabrielima7/TaipanStack/blob/main/src/taipanstack/security/guards.py)
- [`src/taipanstack/security/sanitizers.py`](https://github.com/gabrielima7/TaipanStack/blob/main/src/taipanstack/security/sanitizers.py)
- [`src/taipanstack/security/validators.py`](https://github.com/gabrielima7/TaipanStack/blob/main/src/taipanstack/security/validators.py)
...
**Files**:
- [`pyproject.toml`](https://github.com/gabrielima7/TaipanStack/blob/main/pyproject.toml)
- [`src/taipanstack/__init__.py`](https://github.com/gabrielima7/TaipanStack/blob/main/src/taipanstack/__init__.py)
...
**Files**:
- [`README.md`](https://github.com/gabrielima7/TaipanStack/blob/main/README.md)
- [`CHANGELOG.md`](https://github.com/gabrielima7/TaipanStack/blob/main/CHANGELOG.md)
...
| Report | Link |
|--------|------|
| **Coverage HTML** | [gabrielima7.github.io/TaipanStack/htmlcov/](https://gabrielima7.github.io/TaipanStack/htmlcov/) |
| **Benchmark Dashboard** | [gabrielima7.github.io/TaipanStack/dev/bench/](https://gabrielima7.github.io/TaipanStack/dev/bench/) |
