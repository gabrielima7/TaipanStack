...
tests_dir       = "tests/test_property_sanitizers_standard.py,tests/test_security_validators_standard.py,tests/test_security_guards_standard.py,tests/test_security_ssrf_standard.py"
```
...
| **Ruff lint** | Fixed `ARG001`, `D401`, `PLC0415` in `docs/overrides/hooks.py`.|
...
**Full Changelog:** [v0.3.2...v0.3.3](https://github.com/gabrielima7/TaipanStack/compare/v0.3.2...v0.3.3)
