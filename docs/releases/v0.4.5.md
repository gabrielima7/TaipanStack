...
- **Enhanced Test Suite**: The test suite now comprises **1,249 passing tests**, including new chaos experiments for state corruption.
- **Infrastructure Fixes**: Resolved `pip-audit` strictly treating editable installs as failures and stabilized benchmark concurrency in CI.
