...
def test_chaos_rate_limit_lock_mutation_lock_state():
...
def test_chaos_rate_limit_state_mutation_to_none():
...
@pytest.mark.asyncio
async def test_chaos_rate_limit_async_decorator_exception_for_async():
...
def test_chaos_rate_limit_sync_decorator_exception_for_sync():
...
def test_chaos_rate_limit_time_mutation_or_string():
...
def test_chaos_rate_limit_capacity_mutation_to_none():
...
def test_chaos_rate_limit_time_window_mutation_to_none():
...
def test_chaos_rate_limit_tokens_mutation_or_inf():
...
def test_chaos_rate_limit_consume_negative_tokens_tokens_consumption():
    """Chaos test: Negative tokens consumption."""
    limiter = RateLimiter(max_calls=10, time_window=1.0)
    assert limiter.consume(tokens=-5.0) is True


def test_chaos_rate_limit_current_time_exception_in_timemonotonic():
...
def test_chaos_rate_limit_apply_new_tokens_mutation_in_applynewtokens():
...
def test_chaos_rate_limit_try_consume_mutation_in_tryconsume():
...
def test_chaos_rate_limit_apply_new_tokens_success_to_capacity():
...
def test_chaos_rate_limit_apply_new_tokens_cap_at_capacity():
...
def test_chaos_rate_limit_add_tokens_invalid_new_tokens_is_none():
...
def test_chaos_rate_limit_try_consume_success_and_failure():
...
def test_chaos_rate_limit_process_consumption_true_true_path():
    """Test _process_consumption wrapper true path."""
    limiter = RateLimiter(max_calls=10, time_window=1.0)
    assert limiter._process_consumption(tokens=1.0) is True


def test_chaos_rate_limit_validate_and_add_tokens_type_mutation_bad_type():
    """Test _validate_and_add_tokens bad type."""
    limiter = RateLimiter(max_calls=10, time_window=1.0)
    assert limiter._validate_and_add_tokens("bad") is False  # type: ignore


def test_chaos_rate_limit_validate_and_add_tokens_infinite_validateandaddtokens_infinite():
...
@pytest.mark.asyncio
async def test_chaos_rate_limit_async_wrapper_limit_exceeded_consume_false():
...
def test_chaos_rate_limit_sync_wrapper_limit_exceeded_consume_false():
...
@pytest.mark.asyncio
async def test_chaos_rate_limit_async_wrapper_success_consume_true():
...
def test_chaos_rate_limit_sync_wrapper_success_consume_true():
...
def test_chaos_rate_limit_init_nan_on_naninf():
