...
def test_fuzz_project_name_malformed_max_length_maxlength_types(
    max_length,
) -> None:
...
@settings(max_examples=100, suppress_health_check=[HealthCheck.too_slow])
def test_fuzz_project_name_malformed_allow_hyphen_allowhyphen_types(
    allow_hyphen,
) -> None:
...
@settings(max_examples=100, suppress_health_check=[HealthCheck.too_slow])
def test_fuzz_project_name_malformed_allow_underscore_allowunderscore_types(
    allow_underscore,
) -> None:
