...
def test_chaos_rate_limit_type_mutation_rate_limit_survives_type_mutation_tokens_expected():
    limiter = RateLimiter(10, 10.0)
...
def test_chaos_rate_limit_type_mutation_rate_limit_survives_type_mutation_add_tokens_expected():
    limiter = RateLimiter(10, 10.0)
...
def test_chaos_rate_limit_type_mutation_rate_limit_survives_type_mutation_new_tokens_expected():
    limiter = RateLimiter(10, 10.0)
