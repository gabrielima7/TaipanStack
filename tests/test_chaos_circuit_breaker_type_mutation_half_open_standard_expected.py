...
def test_chaos_circuit_breaker_type_mutation_half_open_circuit_breaker_type_corruption_half_open_attempts_negative_standard_expected() -> (
    None
):
...
def test_chaos_circuit_breaker_type_mutation_half_open_circuit_breaker_type_corruption_half_open_attempts_zero_standard_expected() -> (
    None
):
    breaker = CircuitBreaker(
        name="test_half_open", failure_threshold=3, success_threshold=2
...
def test_chaos_circuit_breaker_type_mutation_half_open_circuit_breaker_type_corruption_half_open_attempts_corrupted_standard_expected() -> (
    None
):
    breaker = CircuitBreaker(
        name="test_half_open", failure_threshold=3, success_threshold=2
