...
def test_circuit_breaker_type_corruption_half_open_attempts_execution_success() -> None:
...
def test_circuit_breaker_type_corruption_success_count_execution_success() -> None:
    breaker = CircuitBreaker(
...
def test_circuit_breaker_type_corruption_failure_count_in_update_execution_success() -> None:
    breaker = CircuitBreaker(
...
def test_circuit_breaker_type_corruption_handle_failure_closed_direct_execution_success() -> None:
    breaker = CircuitBreaker(
