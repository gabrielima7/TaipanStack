...
def test_chaos_circuit_breaker_nan_config_chaos_circuit_breaker_config_rejects_nan_failure_threshold_in_circuitbreakerconfig():
...
def test_chaos_circuit_breaker_nan_config_chaos_circuit_breaker_config_rejects_nan_success_threshold_in_circuitbreakerconfig():
    """Chaos test: Inject NaN for success_threshold in CircuitBreakerConfig."""
    with pytest.raises(ValueError, match="finite"):
        CircuitBreakerConfig(success_threshold=float("nan"))


def test_chaos_circuit_breaker_nan_config_chaos_circuit_breaker_config_rejects_nan_timeout_in_circuitbreakerconfig():
