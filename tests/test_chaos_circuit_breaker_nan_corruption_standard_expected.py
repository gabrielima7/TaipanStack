...
def test_circuit_breaker_corrupt_failure_count_to_nan_closed_standard_expected():
    # Setup
...
def test_circuit_breaker_corrupt_failure_count_to_string_closed_standard_expected():
    # Setup
    breaker = CircuitBreaker(failure_threshold=5)
    breaker._state.state = CircuitState.CLOSED
...
def test_circuit_breaker_corrupt_failure_count_to_nan_update_standard_expected():
    # Setup
    breaker = CircuitBreaker(failure_threshold=5)
    breaker._state.state = CircuitState.CLOSED
    breaker._state.failure_count = float("nan")  # simulate memory corruption
...
def test_circuit_breaker_corrupt_failure_count_to_string_update_standard_expected():
    # Setup
    breaker = CircuitBreaker(failure_threshold=5)
    breaker._state.state = CircuitState.CLOSED
    breaker._state.failure_count = "corrupted"  # simulate memory corruption
...
def test_circuit_breaker_corrupt_half_open_attempts_to_nan_standard_expected():
    # Setup
...
def test_circuit_breaker_corrupt_half_open_attempts_to_string_standard_expected():
    # Setup
    breaker = CircuitBreaker(success_threshold=2)
    breaker._state.state = CircuitState.HALF_OPEN
...
def test_circuit_breaker_record_success_open_state_standard_expected():
    # Setup
