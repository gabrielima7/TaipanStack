...
def test_utils_cache_cached_sync_standard_expected() -> None:
...
def test_utils_cache_cached_sync_err_branch_standard_expected() -> None:
    call_count = 0
...
@pytest.mark.asyncio
async def test_utils_cache_cached_async_err_branch_expected_standard_expected() -> None:
    call_count = 0
...
@pytest.mark.asyncio
async def test_utils_cache_async_cache_stampede_prevention_expected_standard_expected() -> None:
...
def test_utils_cache_cached_sync_lru_eviction_standard_expected() -> None:
...
@pytest.mark.asyncio
async def test_utils_cache_cached_async_lru_eviction_expected_standard_expected() -> None:
...
def test_utils_cache_invalid_max_size_standard_expected() -> None:
