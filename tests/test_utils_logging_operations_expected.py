...
class TestLogOperation:
    ...
    def test_utils_logging_expected_exceptions_handling_expected(
        self, caplog: pytest.LogCaptureFixture
    ) -> None:
    ...
    def test_utils_logging_expected_exceptions_caught_and_logged_expected(
        self, caplog: pytest.LogCaptureFixture
    ) -> None:
...
class TestFormatConstants:
    ...
    def test_utils_logging_default_format_has_required_fields_expected(self) -> None:
    ...
    def test_utils_logging_json_format_is_valid_json_template_expected(self) -> None:
...
class TestCorrelationId:
    ...
    def test_utils_logging_correlation_id_processor_with_id_expected(self) -> None:
    ...
    def test_utils_logging_correlation_id_processor_without_id_expected(self) -> None:
