...
@pytest.mark.asyncio
async def test_chaos_circuit_breaker_exceptions_mutation_chaos_circuit_breaker_type_mutation_failure_exceptions_async_raise_expected():
    cb = CircuitBreaker()
    object.__setattr__(cb.config, "failure_exceptions", "corrupted")
...
@pytest.mark.asyncio
async def test_chaos_circuit_breaker_exceptions_mutation_chaos_circuit_breaker_type_mutation_failure_exceptions_async_raise_not_failure_expected():
    cb = CircuitBreaker(failure_exceptions=(TypeError,))
