...
class TestSecurityConfig:
    ...
    def test_config_models_paranoid_level(self) -> None:
        """Test paranoid security level."""
        config = SecurityConfig(level="paranoid")
        assert config.level == "paranoid"

    def test_config_models_frozen_config(self) -> None:
        """Test that config is immutable."""
        config = SecurityConfig()
        with pytest.raises(ValidationError):
            config.level = "standard"  # type: ignore[misc]

    def test_config_models_extra_fields_forbidden(self) -> None:
...
class TestDependencyConfig:
    ...
    def test_config_models_custom_dependencies(self) -> None:
...
class TestLoggingConfig:
    ...
    def test_config_models_valid_levels(self) -> None:
        """Test all valid log levels."""
        for level in ["DEBUG", "INFO", "WARNING", "ERROR", "CRITICAL"]:
            config = LoggingConfig(level=level)  # type: ignore[arg-type]
            assert config.level == level

    def test_config_models_invalid_level_rejected(self) -> None:
...
class TestStackConfig:
    ...
    def test_config_models_valid_project_name(self) -> None:
        """Test valid project names."""
        config = StackConfig(project_name="my_awesome_project")
        assert config.project_name == "my_awesome_project"

    def test_config_models_invalid_project_name_rejected(self) -> None:
    ...
    def test_config_models_valid_python_version(self) -> None:
        """Test valid Python versions."""
        config = StackConfig(python_version="3.11")
        assert config.python_version == "3.11"

    def test_config_models_invalid_python_version_rejected(self) -> None:
    ...
    def test_config_models_path_with_dots_not_traversal_accepted(
        self, tmp_path: Path
    ) -> None:
    ...
    def test_config_models_direct_validate_project_dir_call(self) -> None:
    ...
    def test_config_models_validate_project_dir_traversal_direct_call(
        self,
    ) -> None:
    ...
    def test_config_models_path_with_double_dots_in_name_rejected(
        self,
    ) -> None:
    ...
    def test_config_models_paranoid_requires_all_tools(self) -> None:
    ...
    def test_config_models_invalid_python_version_too_old(self) -> None:
