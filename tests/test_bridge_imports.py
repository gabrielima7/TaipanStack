...
class TestRequireDependency:
    ...
    def test_bridge_imports_missing_module_with_extra(self) -> None:
...
class TestGetAttrOrErr:
    ...
    def test_bridge_imports_existing_attr(self) -> None:
    ...
    def test_bridge_imports_missing_attr(self) -> None:
