...
@given(st.text())
def test_fuzz_guard_file_extension_null_bytes_are_rejected(filename: str) -> None:
...
def test_fuzz_guard_file_extension_whitespace_and_dots_extension_check(
    padding: str,
) -> None:
...
def test_fuzz_guard_file_extension_empty_after_strip_handled_correctly() -> None:
...
def test_fuzz_guard_file_extension_empty_name_are_handled() -> None:
...
def test_fuzz_guard_file_extension_massive_strings_dos_property_are_active(
    ext: str,
) -> None:
...
def test_fuzz_guard_file_extension_massive_strings_dos_are_active() -> None:
