...
class TestBackwardCompatShims:
    ...
    def test_backward_compat_shims_circuit_breaker_shim_exports_execution_success(
        self,
    ) -> None:
    ...
    def test_backward_compat_shims_circuit_breaker_shim_matches_canonical_execution_success(
        self,
    ) -> None:
    ...
    def test_backward_compat_shims_retry_shim_exports_execution_success(self) -> None:
    ...
    def test_backward_compat_shims_retry_shim_matches_canonical_execution_success(
        self,
    ) -> None:
    ...
    def test_backward_compat_shims_resilience_shim_exports_execution_success(
        self,
    ) -> None:
    ...
    def test_backward_compat_shims_resilience_shim_matches_canonical_execution_success(
        self,
    ) -> None:
