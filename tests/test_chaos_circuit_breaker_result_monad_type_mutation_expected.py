...
def test_chaos_circuit_breaker_corrupted_state_fallthrough_expected() -> None:
...
def test_chaos_circuit_breaker_half_open_attempts_negative_expected() -> None:
...
def test_chaos_circuit_breaker_corrupted_half_open_attempts_expected() -> None:
...
def test_chaos_circuit_breaker_handle_failure_closed_corrupted_failure_count_expected() -> (
    None
):
