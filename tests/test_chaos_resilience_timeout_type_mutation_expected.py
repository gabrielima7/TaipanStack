...
def test_chaos_resilience_timeout_type_mutation_chaos_resilience_timeout_type_mutation_a_string() -> (
    None
):
...
@pytest.mark.asyncio
async def test_chaos_resilience_timeout_type_mutation_async_a_string() -> None:
    """Simulate a severe production failure where timeout 'seconds' is corrupted to a string."""
