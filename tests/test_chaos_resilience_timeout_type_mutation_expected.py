...
def test_chaos_resilience_timeout_type_mutation_chaos_resilience_timeout_type_mutation_expected() -> (
    None
):
...
@pytest.mark.asyncio
async def test_chaos_resilience_timeout_type_mutation_async_expected() -> None:
    """Simulate a severe production failure where timeout 'seconds' is corrupted to a string."""
