...
@pytest.mark.asyncio
async def test_chaos_orchestrator_resource_exhaustion_orchestrator_bulkhead_oserror_chaos_returns_err_in_orchestrator() -> (
    None
):
...
@pytest.mark.asyncio
async def test_chaos_orchestrator_resource_exhaustion_orchestrator_bulkhead_memoryerror_chaos_returns_err_in_orchestrator() -> (
    None
):
...
@pytest.mark.asyncio
async def test_chaos_orchestrator_resource_exhaustion_orchestrator_bulkhead_runtimeerror_chaos_returns_err_in_orchestrator() -> (
    None
):
...
@pytest.mark.asyncio
async def test_chaos_orchestrator_resource_exhaustion_orchestrator_bulkhead_oserror_chaos_with_fallback_test_fallback() -> (
    None
):
...
@pytest.mark.asyncio
async def test_chaos_orchestrator_resource_exhaustion_orchestrator_bulkhead_memoryerror_chaos_with_fallback_test_fallback() -> (
    None
):
...
@pytest.mark.asyncio
async def test_chaos_orchestrator_resource_exhaustion_orchestrator_bulkhead_runtimeerror_chaos_with_fallback_test_fallback() -> (
    None
):
