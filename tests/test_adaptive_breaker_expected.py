...
class TestAdaptiveCircuitBreaker:
    ...
    def test_adaptive_breaker_record_failure_below_throughput_expected(
        self,
    ) -> None:
    ...
    def test_adaptive_breaker_trips_open_on_enough_failures_expected(
        self,
    ) -> None:
    ...
    def test_adaptive_breaker_stays_closed_if_under_target_rate_expected(
        self,
    ) -> None:
    ...
    def test_adaptive_breaker_half_open_failure_returns_to_open_expected(
        self,
    ) -> None:
