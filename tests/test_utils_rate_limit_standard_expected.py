...
class TestRateLimiter:
    ...
    def test_utils_rate_limit_chaos_inf_capacity_return_standard_expected(self) -> None:
        with pytest.raises(ValueError):
            RateLimiter(float("inf"), 1.0)

    def test_utils_rate_limit_chaos_nan_capacity_return_standard_expected(self) -> None:
        with pytest.raises(ValueError):
            RateLimiter(float("nan"), 1.0)

    def test_utils_rate_limit_chaos_corrupted_bucket_standard_expected(self) -> None:
    ...
    def test_utils_rate_limit_chaos_nan_inf_time_standard_expected(self) -> None:
        limiter = RateLimiter(10, 1.0)
        limiter.tokens = 0
    ...
    def test_utils_rate_limit_chaos_consume_nan_now_standard_expected(self) -> None:
        import time
    ...
    def test_utils_rate_limit_chaos_consume_adds_tokens_corrupted_new_tokens_standard_expected(
        self,
    ) -> None:
        limiter = RateLimiter(10, 1.0)
        limiter.tokens = 0
    ...
    def test_utils_rate_limit_chaos_consume_adds_tokens_corrupted_tokens_sum_standard_expected(
        self,
    ) -> None:
        limiter = RateLimiter(10, 1.0)
    ...
    def test_utils_rate_limit_invalid_initialization_standard_expected(self) -> None:
    ...
    def test_utils_rate_limit_consume_refill_standard_expected(
...
class TestRateLimitDecorator:
    ...
    def test_utils_rate_limit_sync_rate_limit_standard_expected(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_utils_rate_limit_async_rate_limit_standard_expected(self) -> None:
