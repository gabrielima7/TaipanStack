...
class TestCheckAll:
    ...
    @pytest.mark.asyncio
    async def test_watchdog_health_exploding_counted_as_unhealthy(self) -> None:
...
class TestHealthPinger:
    ...
    @pytest.mark.asyncio
    async def test_watchdog_health_health_change_callback(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_watchdog_health_opens_breaker_on_failure(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_watchdog_health_does_not_close_breaker_on_recovery(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_watchdog_health_no_duplicate_callback_on_same_status(self) -> None:
...
@pytest.mark.asyncio
async def test_watchdog_health_standard_watchdog_health_health_pinger_check_all_err_branch() -> (
    None
):
...
@pytest.mark.asyncio
async def test_watchdog_health_standard_watchdog_health_health_pinger_run_err_branch() -> (
    None
):
