...
def test_fuzz_sanitize_filename_replacement_type_fuzz_sanitize_filename_malformed_replacement_expected(
    replacement,
) -> None:
...
@settings(max_examples=100, suppress_health_check=[HealthCheck.too_slow])
def test_fuzz_sanitize_filename_replacement_type_fuzz_sanitize_filename_malformed_preserve_extension_expected(
    preserve_extension,
) -> None:
...
@settings(max_examples=100, suppress_health_check=[HealthCheck.too_slow])
def test_fuzz_sanitize_filename_replacement_type_fuzz_sanitize_filename_malformed_max_length_expected(
    max_length,
) -> None:
