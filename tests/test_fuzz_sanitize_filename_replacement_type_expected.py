...
def test_fuzz_sanitize_filename_replacement_type_fuzz_sanitize_filename_malformed_replacement_replacement_types(
    replacement,
) -> None:
...
@settings(max_examples=100, suppress_health_check=[HealthCheck.too_slow])
def test_fuzz_sanitize_filename_replacement_type_fuzz_sanitize_filename_malformed_preserve_extension_preserveextension_types(
    preserve_extension,
) -> None:
...
@settings(max_examples=100, suppress_health_check=[HealthCheck.too_slow])
def test_fuzz_sanitize_filename_replacement_type_fuzz_sanitize_filename_malformed_max_length_maxlength_types(
    max_length,
) -> None:
