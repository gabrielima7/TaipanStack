...
class TestAdaptiveRetry:
    ...
    def test_adaptive_retry_learned_delay_from_successes_expected(
        self,
    ) -> None:
    ...
    def test_adaptive_retry_failure_does_not_affect_delay_expected(
        self,
    ) -> None:
    ...
    def test_adaptive_retry_max_delay_exponential_fallback_expected(
        self,
    ) -> None:
