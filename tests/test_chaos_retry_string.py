...
def test_chaos_retry_string_max_attempts() -> None:
...
@pytest.mark.asyncio
async def test_chaos_retry_string_max_attempts_async() -> None:
    @retry(max_attempts="3")  # type: ignore
...
def test_chaos_retry_string_max_attempts_failure() -> None:
