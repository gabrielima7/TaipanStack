...
class TestRateLimiter:
    def test_utils_rate_limit_chaos_inf_time_window_return_execution_success(
        self,
    ) -> None:
        with pytest.raises(ValueError):
            RateLimiter(10, float("inf"))

    def test_utils_rate_limit_chaos_negative_time_window_return_execution_success(
        self,
    ) -> None:
        with pytest.raises(ValueError):
            RateLimiter(10, -1.0)

    def test_utils_rate_limit_chaos_inf_capacity_return_execution_success(self) -> None:
        with pytest.raises(ValueError):
            RateLimiter(float("inf"), 1.0)

    def test_utils_rate_limit_chaos_nan_capacity_return_execution_success(self) -> None:
        with pytest.raises(ValueError):
            RateLimiter(float("nan"), 1.0)

    def test_utils_rate_limit_chaos_corrupted_bucket_execution_success(self) -> None:
    ...
    def test_utils_rate_limit_chaos_nan_inf_time_execution_success(self) -> None:
        limiter = RateLimiter(10, 1.0)
        limiter.tokens = 0
    ...
    def test_utils_rate_limit_chaos_consume_nan_now_execution_success(self) -> None:
        import time
    ...
    def test_utils_rate_limit_chaos_consume_adds_tokens_corrupted_new_tokens_execution_success(
        self,
    ) -> None:
        limiter = RateLimiter(10, 1.0)
        limiter.tokens = 0
    ...
    def test_utils_rate_limit_chaos_consume_adds_tokens_corrupted_tokens_sum_execution_success(
        self,
    ) -> None:
        limiter = RateLimiter(10, 1.0)
    ...
    def test_utils_rate_limit_chaos_consume_zero_or_negative_tokens_execution_success(
        self,
    ) -> None:
        limiter = RateLimiter(10, 1.0)
    ...
    def test_utils_rate_limit_invalid_initialization_execution_success(self) -> None:
    ...
    def test_utils_rate_limit_consume_success_execution_success(self) -> None:
    ...
    def test_utils_rate_limit_consume_refill_execution_success(
...
class TestRateLimitDecorator:
    ...
    def test_utils_rate_limit_sync_rate_limit_execution_success(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_utils_rate_limit_async_rate_limit_execution_success(self) -> None:
