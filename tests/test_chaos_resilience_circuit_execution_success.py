...
def test_chaos_resilience_circuit_circuit_breaker_on_state_change_chaos_execution_success():
...
def test_chaos_resilience_circuit_circuit_breaker_on_state_change_chaos_without_structlog_execution_success(
    monkeypatch,
):
...
def test_chaos_resilience_circuit_circuit_breaker_chaos_config_mutations_execution_success():
...
def test_chaos_resilience_circuit_structlog_warning_without_callback_execution_success(
...
def test_chaos_resilience_circuit_structlog_fallback_noop_when_unavailable_execution_success(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
