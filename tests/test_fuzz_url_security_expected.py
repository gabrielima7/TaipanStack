...
def test_fuzz_url_security_fuzz_url_massive_strings_dos_are_active(
    url: str,
) -> None:
...
def test_fuzz_url_security_fuzz_url_null_bytes_null_bytes(url: str) -> None:
...
def test_fuzz_url_security_fuzz_url_unprintable_chars_unprintable_unicode(
    chars: str,
) -> None:
...
def test_fuzz_url_security_url_port_integer_conversion_dos_url_parsers() -> None:
...
def test_fuzz_url_security_url_tld_ipv6_handling_on_ipv6() -> None:
...
def test_fuzz_url_security_url_credentials_bypassing_tld_check_on_netloc() -> None:
