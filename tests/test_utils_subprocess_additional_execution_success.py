...
def test_utils_subprocess_additional_utils_subprocess_raise_on_error_execution_success():
    import subprocess
...
def test_utils_subprocess_additional_allowed_keys_custom_execution_success():
    from taipanstack.utils.subprocess import _get_allowed_keys

    assert _get_allowed_keys(["TEST_VAR"]) == {"TEST_VAR"}


def test_utils_subprocess_additional_filter_environment_empty_execution_success():
    from taipanstack.utils.subprocess import _filter_environment

    assert _filter_environment(None, []) == {}


def test_utils_subprocess_additional_run_safe_command_check_true_execution_success():
    import subprocess
...
def test_utils_subprocess_additional_filter_environment_empty_allowed_execution_success():
    from taipanstack.utils.subprocess import _filter_environment

    assert _filter_environment({"PATH": "/bin"}, []) == {}


def test_utils_subprocess_additional_filter_environment_none_allowed_execution_success():
    from taipanstack.utils.subprocess import _filter_environment
...
def test_utils_subprocess_additional_run_safe_command_timeout_execution_success():
    import pytest
...
def test_utils_subprocess_additional_execute_command_capture_false_execution_success():
...
def test_utils_subprocess_additional_get_allowed_keys_none_execution_success():
    from taipanstack.utils.subprocess import _get_allowed_keys

    assert _get_allowed_keys(None) == {"PATH"}


def test_utils_subprocess_additional_extract_timeout_stdout_not_str_execution_success():
    import subprocess
