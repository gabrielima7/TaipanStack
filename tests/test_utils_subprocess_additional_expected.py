...
def test_utils_subprocess_additional_utils_subprocess_raise_on_error_expected():
    import subprocess
...
def test_utils_subprocess_additional_utils_subprocess_validate_timeout_type_error_invalid_types() -> (
    None
):
...
def test_utils_subprocess_additional_utils_subprocess_validate_timeout_none_with_none() -> None:
