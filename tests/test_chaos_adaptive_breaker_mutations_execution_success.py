...
def test_chaos_adaptive_breaker_mutations_adaptive_breaker_target_error_rate_mutation_execution_success():
...
def test_chaos_adaptive_breaker_mutations_adaptive_breaker_target_error_rate_nan_execution_success():
...
def test_chaos_adaptive_breaker_mutations_adaptive_breaker_last_opened_at_mutation_execution_success():
...
def test_chaos_adaptive_breaker_mutations_adaptive_breaker_last_opened_at_nan_execution_success():
...
def test_chaos_adaptive_breaker_mutations_adaptive_breaker_clock_jump_backward_execution_success():
...
def test_chaos_adaptive_breaker_mutations_adaptive_breaker_time_corruption_nan_execution_success(
    monkeypatch,
):
...
def test_chaos_adaptive_breaker_mutations_adaptive_breaker_min_throughput_invalid_execution_success():
...
def test_chaos_adaptive_breaker_mutations_adaptive_breaker_calculate_error_rate_zero_execution_success():
