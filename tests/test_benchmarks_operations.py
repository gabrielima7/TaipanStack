...
def test_benchmarks_bench_sanitize_string_simple(
...
def test_benchmarks_bench_sanitize_string_xss(
    benchmark: BenchmarkFixture,
) -> None:
...
def test_benchmarks_bench_sanitize_string_unicode(
    benchmark: BenchmarkFixture,
) -> None:
...
def test_benchmarks_bench_sanitize_filename_complex(
    benchmark: BenchmarkFixture,
) -> None:
...
def test_benchmarks_bench_sanitize_filename_long(
    benchmark: BenchmarkFixture,
) -> None:
...
def test_benchmarks_bench_sanitize_path_nested(
    benchmark: BenchmarkFixture,
) -> None:
...
def test_benchmarks_bench_sanitize_path_traversal(
    benchmark: BenchmarkFixture,
) -> None:
...
def test_benchmarks_bench_sanitize_env_value_standard(
    benchmark: BenchmarkFixture,
) -> None:
...
def test_benchmarks_bench_sanitize_env_value_large(
    benchmark: BenchmarkFixture,
) -> None:
...
def test_benchmarks_bench_sanitize_sql_identifier(
    benchmark: BenchmarkFixture,
) -> None:
...
def test_benchmarks_bench_sanitize_sql_identifier_dirty(
    benchmark: BenchmarkFixture,
) -> None:
...
def test_benchmarks_bench_safe_decorator_ok(
    benchmark: BenchmarkFixture,
) -> None:
...
def test_benchmarks_bench_safe_decorator_err(
    benchmark: BenchmarkFixture,
) -> None:
...
def test_benchmarks_bench_collect_results_100(
    benchmark: BenchmarkFixture,
) -> None:
...
def test_benchmarks_bench_unwrap_or(benchmark: BenchmarkFixture) -> None:
...
def test_benchmarks_bench_guard_ssrf_public(
    benchmark: BenchmarkFixture,
) -> None:
...
def test_benchmarks_bench_guard_ssrf_private(
    benchmark: BenchmarkFixture,
) -> None:
