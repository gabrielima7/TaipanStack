...
def test_chaos_retry_type_mutation_chaos_retry_should_retry_type_error_for_issubclass_expected() -> (
    None
):
    """
...
@pytest.mark.asyncio
async def test_chaos_retry_type_mutation_chaos_retry_decorator_type_error_for_isinstance_expected() -> (
    None
):
    """
