...
def test_chaos_retry_result_retry_result_monad_chaos():
    attempts = 0
...
def test_chaos_retry_result_retry_result_monad_chaos_coverage():
    attempts = 0
...
def test_chaos_retry_result_retry_result_monad_chaos_sync_not_on():
    @retry(max_attempts=3, on=(ValueError,))
    def failing_func():
