...
class TestValidateInputs:
    ...
    def test_security_decorators_valid_inputs_pass_execution_success(self) -> None:
    ...
    def test_security_decorators_invalid_input_raises_validation_error_execution_success(
        self,
    ) -> None:
    ...
    def test_security_decorators_validation_error_has_param_name_execution_success(
        self,
    ) -> None:
    ...
    def test_security_decorators_multiple_validators_execution_success(self) -> None:
...
class TestGuardExceptions:
    ...
    def test_security_decorators_no_exception_passes_through_execution_success(
        self,
    ) -> None:
    ...
    def test_security_decorators_caught_exception_returns_default_execution_success(
        self,
    ) -> None:
    ...
    def test_security_decorators_uncaught_exception_propagates_execution_success(
        self,
    ) -> None:
    ...
    def test_security_decorators_reraise_as_security_error_execution_success(
        self,
    ) -> None:
    ...
    def test_security_decorators_reraise_as_custom_exception_execution_success(
        self,
    ) -> None:
...
class TestTimeout:
    ...
    def test_security_decorators_fast_function_succeeds_execution_success(self) -> None:
    ...
    def test_security_decorators_slow_function_times_out_execution_success(
        self,
    ) -> None:
    ...
    def test_security_decorators_timeout_error_has_details_execution_success(
        self,
    ) -> None:
    ...
    def test_security_decorators_timeout_negative_value_execution_success(self) -> None:
    ...
    def test_security_decorators_timeout_nan_value_execution_success(self) -> None:
    ...
    def test_security_decorators_timeout_inf_value_execution_success(self) -> None:
    ...
    def test_security_decorators_timeout_with_exception_in_thread_execution_success(
        self,
    ) -> None:
    ...
    def test_security_decorators_timeout_with_success_in_thread_execution_success(
        self,
    ) -> None:
        @timeout(1.0, use_signal=False)
...
class TestDeprecated:
    ...
    def test_security_decorators_emits_deprecation_warning_execution_success(
        self,
    ) -> None:
    ...
    def test_security_decorators_includes_removal_version_execution_success(
        self,
    ) -> None:
...
class TestRequireType:
    ...
    def test_security_decorators_correct_types_pass_execution_success(self) -> None:
    ...
    def test_security_decorators_wrong_type_raises_type_error_execution_success(
        self,
    ) -> None:
    ...
    def test_security_decorators_multiple_type_checks_execution_success(self) -> None:
...
class TestWindowsSignalCoverage:
    def test_security_decorators_windows_signal_coverage_execution_success(
        self,
    ) -> None:
