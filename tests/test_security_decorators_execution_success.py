...
class TestGuardExceptions:
    ...
    def test_security_decorators_no_exception_passes_through(
        self,
    ) -> None:
    ...
    def test_security_decorators_reraise_as_security_error(
        self,
    ) -> None:
...
class TestRequireType:
    ...
    def test_security_decorators_wrong_type_raises_type_error(
        self,
    ) -> None:
