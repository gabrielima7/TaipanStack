...
class TestValidateProjectName:
    ...
    def test_security_validators_valid_project_name_expected(self) -> None:
    ...
    def test_security_validators_empty_name_rejected_expected(self) -> None:
        """Test empty names are rejected."""
        with pytest.raises(ValueError, match="cannot be empty"):
            validate_project_name("")

    def test_security_validators_name_must_start_with_letter_expected(self) -> None:
        """Test names must start with a letter."""
        with pytest.raises(ValueError, match="must start with a letter"):
            validate_project_name("123project")

    def test_security_validators_reserved_names_rejected_expected(self) -> None:
        """Test reserved names are rejected."""
        with pytest.raises(ValueError, match="is reserved"):
            validate_project_name("test")

    def test_security_validators_max_length_enforced_expected(self) -> None:
...
class TestValidatePythonVersion:
    ...
    def test_security_validators_valid_versions_expected(self) -> None:
    ...
    def test_security_validators_invalid_format_rejected_expected(self) -> None:
    ...
    def test_security_validators_unsupported_version_rejected_expected(self) -> None:
    ...
    def test_security_validators_massive_version_string_fuzzing_expected(self) -> None:
    ...
    def test_security_validators_validate_python_version_fuzzing_hypothesis_expected(
...
class TestValidateEmail:
    ...
    def test_security_validators_valid_emails_expected(self) -> None:
    ...
    def test_security_validators_empty_email_rejected_expected(self) -> None:
...
class TestValidateUrl:
    ...
    def test_security_validators_valid_urls_expected(self) -> None:
    ...
    def test_security_validators_empty_url_rejected_expected(self) -> None:
        """Test empty URLs are rejected."""
        with pytest.raises(ValueError, match="cannot be empty"):
            validate_url("")

    def test_security_validators_missing_scheme_rejected_expected(self) -> None:
        """Test URLs without scheme are rejected."""
        with pytest.raises(ValueError, match="must have a scheme"):
            validate_url("example.com")

    def test_security_validators_invalid_scheme_rejected_expected(self) -> None:
        """Test invalid schemes are rejected."""
        with pytest.raises(ValueError, match="not allowed"):
            validate_url("ftp://example.com")

    def test_security_validators_invalid_format_parsing_error_expected(self) -> None:
    ...
    def test_security_validators_out_of_range_port_parsing_error_expected(self) -> None:
