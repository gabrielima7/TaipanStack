...
import math
import time
from taipanstack.resilience.retry import retry, RetryError, calculate_delay, RetryConfig
...
def test_retry_chaos_inf_delay():
    ...
    """
    config = RetryConfig(initial_delay=float('inf'), max_delay=float('inf'), jitter=False)
