...
class TestSafeCommandResult:
    ...
    def test_utils_subprocess_success_true_when_returncode_zero(
        self,
    ) -> None:
...
class TestDefaultAllowedCommands:
    ...
    def test_utils_subprocess_contains_essential_commands(
        self,
    ) -> None:
...
class TestRunSafeCommand:
    ...
    def test_utils_subprocess_working_directory(
        self, tmp_path: Path
    ) -> None:
...
def test_utils_subprocess_execute_command_timeout_with_bytes_stdout() -> (
    None
):
...
def test_utils_subprocess_execute_command_timeout_without_stdout() -> (
    None
):
...
def test_utils_subprocess_execute_command_timeout_with_str_stdout() -> (
    None
):
