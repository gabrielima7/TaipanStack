...
class TestSafeCommandResult:
    ...
    def test_utils_subprocess_success_true_when_returncode_zero_expected(
        self,
    ) -> None:
...
class TestDefaultAllowedCommands:
    ...
    def test_utils_subprocess_contains_essential_commands_expected(
        self,
    ) -> None:
...
class TestRunSafeCommand:
    ...
    def test_utils_subprocess_command_injection_blocked_expected(self) -> None:
