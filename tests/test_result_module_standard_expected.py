...
class TestOkErr:
    ...
    def test_result_module_ok_value_standard_expected(self) -> None:
    ...
    def test_result_module_err_value_standard_expected(self) -> None:
...
class TestSafeDecorator:
    ...
    def test_result_module_safe_exception_standard_expected(self) -> None:
    ...
    def test_result_module_safe_basic_exception_standard_expected(self) -> None:
...
class TestSafeFromDecorator:
    ...
    def test_result_module_safe_from_propagates_unspecified_exception_standard_expected(
        self,
    ) -> None:
    ...
    def test_result_module_safe_from_multiple_types_standard_expected(self) -> None:
    ...
    def test_result_module_safe_from_explicit_raise_standard_expected(self) -> None:
    ...
    def test_result_module_safe_from_inheritance_standard_expected(self) -> None:
...
class TestCollectResults:
    ...
    def test_result_module_collect_all_ok_standard_expected(self) -> None:
    ...
    def test_result_module_collect_with_err_standard_expected(self) -> None:
    ...
    def test_result_module_collect_empty_standard_expected(self) -> None:
    ...
    def test_result_module_collect_first_err_returned_standard_expected(self) -> None:
...
class TestUnwrapOr:
    ...
    def test_result_module_unwrap_or_ok_standard_expected(self) -> None:
        """Test unwrap_or returns Ok value."""
        result: Result[int, ValueError] = Ok(42)
        assert result.unwrap_or(0) == 42

    def test_result_module_unwrap_or_err_standard_expected(self) -> None:
...
class TestUnwrapOrElse:
    ...
    def test_result_module_unwrap_or_else_ok_standard_expected(self) -> None:
        """Test unwrap_or_else returns Ok value."""
        result: Result[int, ValueError] = Ok(42)
        assert result.unwrap_or_else(len) == 42

    def test_result_module_unwrap_or_else_err_standard_expected(self) -> None:
...
class TestMatchCase:
    ...
    def test_result_module_match_ok_standard_expected(self) -> None:
    ...
    def test_result_module_match_err_standard_expected(self) -> None:
...
class TestSafeAsyncDecorator:
    ...
    @pytest.mark.asyncio
    async def test_result_module_safe_async_success_standard_expected(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_result_module_safe_async_exception_standard_expected(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_result_module_safe_async_preserves_metadata_standard_expected(
        self,
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_result_module_safe_async_runtime_error_standard_expected(
        self,
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_result_module_safe_async_basic_exception_standard_expected(
        self,
    ) -> None:
...
class TestMapAsync:
    ...
    @pytest.mark.asyncio
    async def test_result_module_map_async_ok_standard_expected(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_result_module_map_async_err_standard_expected(self) -> None:
...
class TestAndThenAsync:
    ...
    @pytest.mark.asyncio
    async def test_result_module_and_then_async_ok_to_ok_standard_expected(
        self,
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_result_module_and_then_async_ok_to_err_standard_expected(
        self,
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_result_module_and_then_async_err_standard_expected(self) -> None:
...
class TestSafeFromAsyncDecorator:
    @pytest.mark.asyncio
    async def test_result_module_safe_from_async_success_standard_expected(
        self,
    ) -> None:
        @safe_from(ValueError)
    ...
    @pytest.mark.asyncio
    async def test_result_module_safe_from_async_exception_standard_expected(
        self,
    ) -> None:
        @safe_from(ValueError)
        async def process(x: int) -> int:
    ...
    @pytest.mark.asyncio
    async def test_result_module_safe_from_async_propagates_unspecified_standard_expected(
        self,
    ) -> None:
        @safe_from(ValueError)
        async def process(x: int) -> int:
...
class TestUnwrapOrErrFallback:
    ...
    def test_result_module_unwrap_or_err_branch_standard_expected(self) -> None:
...
class TestResultStructuralCompatibility:
    ...
    def test_result_module_collect_list_attribute_error_standard_expected(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_result_module_map_async_structural_compatibility_standard_expected(
        self,
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_result_module_and_then_async_structural_compatibility_standard_expected(
        self,
    ) -> None:
