...
class TestHealthPinger:
    ...
    @pytest.mark.asyncio
    async def test_watchdog_health_health_change_callback_expected(
        self,
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_watchdog_health_opens_breaker_on_failure_expected(
        self,
    ) -> None:
...
@pytest.mark.asyncio
async def test_watchdog_health_health_pinger_check_all_err_branch_expected_expected() -> (
    None
):
...
@pytest.mark.asyncio
async def test_watchdog_health_health_pinger_run_err_branch_expected_expected() -> None:
    from taipanstack.resilience.watchdogs.health_pinger import (
        HealthPinger,
        HealthTarget,
    )
