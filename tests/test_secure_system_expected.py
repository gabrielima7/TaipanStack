...
def test_secure_system_create_user_success_expected_expected(
...
def test_secure_system_create_user_failure_expected_expected(
    caplog: pytest.LogCaptureFixture,
) -> None:
...
def test_secure_system_create_user_unhandled_err_expected(
    caplog: pytest.LogCaptureFixture,
) -> None:
...
def test_secure_system_concurrent_chaos_expected_expected() -> None:
