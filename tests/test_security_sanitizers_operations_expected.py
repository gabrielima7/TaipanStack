...
class TestSanitizeString:
    ...
    def test_security_sanitizers_empty_string_expected(self) -> None:
        """Test empty string returns empty."""
        assert sanitize_string("") == ""

    def test_security_sanitizers_normal_string_unchanged_expected(self) -> None:
        """Test normal string passes through."""
        assert sanitize_string("Hello World") == "Hello World"

    def test_security_sanitizers_strips_whitespace_expected(self) -> None:
    ...
    def test_security_sanitizers_no_strip_whitespace_expected(self) -> None:
        """Test whitespace preserved when disabled."""
        result = sanitize_string("  hello  ", strip_whitespace=False)
        assert result == "  hello  "

    def test_security_sanitizers_removes_null_bytes_expected(self) -> None:
        """Test null bytes are removed."""
        assert sanitize_string("hel\x00lo") == "hello"

    def test_security_sanitizers_removes_html_tags_expected(self) -> None:
        """Test HTML tags are removed by default."""
        result = sanitize_string("<script>alert('xss')</script>")
        assert "<script>" not in result
        assert "alert" in result  # Text content preserved

    def test_security_sanitizers_allows_html_when_enabled_expected(self) -> None:
        """Test HTML tags preserved when allowed."""
        result = sanitize_string("<b>bold</b>", allow_html=True)
        assert "<b>" in result

    def test_security_sanitizers_removes_control_characters_expected(self) -> None:
        """Test control characters are removed."""
        result = sanitize_string("hello\x01\x02world")
        assert result == "helloworld"

    def test_security_sanitizers_preserves_newlines_expected(self) -> None:
        """Test newlines are preserved."""
        result = sanitize_string("line1\nline2")
        assert "\n" in result

    def test_security_sanitizers_removes_unicode_when_disabled_expected(self) -> None:
        """Test unicode removed when not allowed."""
        result = sanitize_string("héllo wörld", allow_unicode=False)
        assert "é" not in result
        assert "ö" not in result

    def test_security_sanitizers_truncates_to_max_length_expected(self) -> None:
        """Test string is truncated."""
        result = sanitize_string("hello world", max_length=5)
        assert result == "hello"
        assert len(result) == 5

    def test_security_sanitizers_escapes_html_entities_expected(self) -> None:
...
class TestSanitizeFilename:
    ...
    def test_security_sanitizers_empty_filename_expected(self) -> None:
        """Test empty filename returns 'unnamed'."""
        assert sanitize_filename("") == "unnamed"

    def test_security_sanitizers_normal_filename_expected(self) -> None:
        """Test normal filename passes through."""
        assert sanitize_filename("test.txt") == "test.txt"

    def test_security_sanitizers_removes_path_characters_expected(self) -> None:
        """Test path characters are removed."""
        result = sanitize_filename("../etc/passwd.txt")
        assert "/" not in result
        assert ".." not in result

    def test_security_sanitizers_removes_invalid_windows_chars_expected(self) -> None:
    ...
    def test_security_sanitizers_max_length_with_extension_expected(self) -> None:
        """Test max length preserves extension."""
        result = sanitize_filename("verylongfilename.txt", max_length=10)
        assert len(result) <= 10
        assert result.endswith(".txt")

    def test_security_sanitizers_max_length_with_long_extension_expected(self) -> None:
    ...
    def test_security_sanitizers_custom_replacement_expected(self) -> None:
        """Test custom replacement character."""
        result = sanitize_filename("bad:name.txt", replacement="-")
        assert ":" not in result
        assert "-" in result

    def test_security_sanitizers_collapses_multiple_replacements_expected(self) -> None:
...
class TestSanitizePath:
    ...
    def test_security_sanitizers_sanitize_path_empty_expected(self) -> None:
    ...
    def test_security_sanitizers_simple_path_expected(self) -> None:
        """Test simple path passes through."""
        result = sanitize_path("test/file.txt")
        assert "test" in str(result)
        assert "file.txt" in str(result)

    def test_security_sanitizers_removes_traversal_expected(self) -> None:
    ...
    def test_security_sanitizers_max_depth_enforced_expected(self) -> None:
        """Test max depth is enforced."""
        deep_path = "/".join(["dir"] * 20)
        with pytest.raises(ValueError, match="depth"):
            sanitize_path(deep_path, max_depth=5)

    def test_security_sanitizers_with_base_dir_expected(self, tmp_path: Path) -> None:
    ...
    def test_security_sanitizers_removes_parent_traversal_expected(self) -> None:
    ...
    def test_security_sanitizers_handles_empty_parts_expected(self) -> None:
    ...
    def test_security_sanitizers_handles_invalid_character_parts_expected(self) -> None:
    ...
    def test_security_sanitizers_resolve_with_base_dir_error_expected(
...
class TestSanitizeEnvValue:
    ...
    def test_security_sanitizers_type_error_expected(self) -> None:
    ...
    def test_security_sanitizers_empty_value_expected(self) -> None:
        """Test empty value returns empty."""
        assert sanitize_env_value("") == ""

    def test_security_sanitizers_normal_value_expected(self) -> None:
    ...
    def test_security_sanitizers_removes_newlines_by_default_expected(self) -> None:
        """Test newlines are replaced by default."""
        result = sanitize_env_value("line1\nline2")
        assert "\n" not in result

    def test_security_sanitizers_allows_multiline_expected(self) -> None:
    ...
    def test_security_sanitizers_sanitize_env_value_fast_path_expected(self) -> None:
    ...
    def test_security_sanitizers_sanitize_env_value_slow_path_expected(self) -> None:
...
class TestSanitizeSqlIdentifier:
    ...
    def test_security_sanitizers_empty_identifier_raises_expected(self) -> None:
        """Test empty identifier raises ValueError."""
        with pytest.raises(ValueError, match="cannot be empty"):
            sanitize_sql_identifier("")

    def test_security_sanitizers_normal_identifier_expected(self) -> None:
        """Test normal identifier passes through."""
        assert sanitize_sql_identifier("users") == "users"

    def test_security_sanitizers_removes_special_characters_expected(self) -> None:
...
def test_security_sanitizers_sanitize_filename_value_error_expected():
    import pytest
...
def test_security_sanitizers_sanitize_filename_no_replacement_expected():
...
def test_security_sanitizers_sanitizers_re_error_coverage_no_slash_expected() -> None:
