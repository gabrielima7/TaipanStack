...
class TestAdaptiveRetry:
    ...
    def test_fallback_delay_without_data(self) -> None:
    ...
    def test_learned_delay_from_successes(self) -> None:
    ...
    def test_failure_does_not_affect_delay(self) -> None:
    ...
    def test_per_attempt_isolation(self) -> None:
    ...
    def test_max_delay_exponential_fallback(self) -> None:
