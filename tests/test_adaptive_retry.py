...
class TestAdaptiveRetry:
    ...
    def test_fallback_delay_without_data_expected(self) -> None:
    ...
    def test_learned_delay_from_successes_expected(self) -> None:
    ...
    def test_failure_does_not_affect_delay_expected(self) -> None:
    ...
    def test_delay_clamped_to_bounds_expected(self) -> None:
    ...
    def test_to_retry_config_expected(self) -> None:
    ...
    def test_per_attempt_isolation_expected(self) -> None:
    ...
    def test_max_delay_exponential_fallback_expected(self) -> None:
