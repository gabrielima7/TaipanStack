...
class TestVersionRecommendations:
    ...
    def test_version_config_recommendations_creation_standard_expected(self) -> None:
    ...
    def test_version_config_recommendations_to_dict_standard_expected(self) -> None:
...
class TestGetVersionRecommendations:
    ...
    def test_version_config_recommendations_for_311_standard_expected(self) -> None:
    ...
    def test_version_config_recommendations_for_312_standard_expected(self) -> None:
    ...
    def test_version_config_recommendations_for_313_standard_expected(self) -> None:
    ...
    def test_version_config_recommendations_for_313_with_features_standard_expected(
        self,
    ) -> None:
    ...
    def test_version_config_recommendations_for_313_without_experimental_standard_expected(
        self,
    ) -> None:
    ...
    def test_version_config_recommendations_for_314_standard_expected(self) -> None:
    ...
    def test_version_config_recommendations_for_314_with_features_standard_expected(
        self,
    ) -> None:
    ...
    def test_version_config_recommendations_always_returns_valid_data_standard_expected(
        self,
    ) -> None:
