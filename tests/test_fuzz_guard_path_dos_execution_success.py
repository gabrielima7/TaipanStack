...
def test_fuzz_guard_path_traversal_exceeds_max_path_length_execution_success(path):
...
def test_fuzz_guard_path_traversal_base_dir_exceeds_max_path_length_execution_success(
    base_dir,
):
    with pytest.raises(SecurityError):
