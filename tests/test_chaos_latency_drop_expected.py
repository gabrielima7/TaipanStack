...
@pytest.mark.asyncio
async def test_chaos_extreme_latency_expected():
...
@pytest.mark.asyncio
async def test_chaos_intermittent_connection_drops_expected():
    attempts = 0
...
def test_chaos_resource_exhaustion_circuit_breaker_expected():
