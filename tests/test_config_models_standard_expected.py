...
class TestStackConfig:
    ...
    def test_config_models_invalid_project_name_rejected_expected(
        self,
    ) -> None:
    ...
    def test_config_models_invalid_python_version_rejected_expected(
        self,
    ) -> None:
    ...
    def test_config_models_direct_validate_project_dir_call_expected(
        self,
    ) -> None:
    ...
    def test_config_models_invalid_python_version_too_old_expected(
        self,
    ) -> None:
