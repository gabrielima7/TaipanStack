...
def test_utils_resilience_fallback_sync_standard_fallback() -> None:
...
def test_utils_resilience_fallback_sync_unreachable_unreachable_logic() -> None:
...
@pytest.mark.asyncio
async def test_utils_resilience_fallback_async_unreachable_unreachable_logic() -> None:
...
@pytest.mark.asyncio
async def test_utils_resilience_fallback_async_async_fallback() -> None:
    """Test async fallback."""
...
def test_utils_resilience_timeout_sync_standard_timeout() -> None:
...
@pytest.mark.asyncio
async def test_utils_resilience_timeout_async_async_timeout() -> None:
    """Test async timeout."""
