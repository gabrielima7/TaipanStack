...
class TestFilesystemTraversalExtended:
    ...
    def test_filesystem_traversal_extended_ensure_dir_traversal_patterns_traversal_patterns(
    ...
    def test_filesystem_traversal_extended_ensure_dir_absolute_path_not_blocked_by_default_is_provided(
        self, tmp_path: Path
    ):
    ...
    @pytest.mark.parametrize("pattern", ["%2e%2e", "%252e%252e"])
    def test_filesystem_traversal_extended_safe_read_encoded_traversal_traversal_patterns(
        self, tmp_path: Path, pattern: str
    ):
    ...
    def test_filesystem_traversal_extended_safe_write_encoded_traversal_traversal_patterns(
        self, tmp_path: Path
    ):
    ...
    def test_filesystem_traversal_extended_ensure_dir_with_explicit_base_dir_encoded_encoded_traversal(
        self, tmp_path: Path
    ):
    ...
    def test_filesystem_traversal_extended_tilde_in_middle_not_blocked_not_blocked(
        self, tmp_path: Path
    ):
