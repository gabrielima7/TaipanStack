...
class TestSafeCommandResult:
    ...
    def test_utils_subprocess_success_true_when_returncode_zero_returncode_0(
        self,
    ) -> None:
    ...
    def test_utils_subprocess_success_false_when_returncode_nonzero_nonzero_returncode(
        self,
    ) -> None:
    ...
    def test_utils_subprocess_raise_on_error_success_on_success(self) -> None:
    ...
    def test_utils_subprocess_raise_on_error_failure_on_failure(self) -> None:
    ...
    def test_utils_subprocess_duration_seconds_default_default_value(self) -> None:
...
class TestDefaultAllowedCommands:
    ...
    def test_utils_subprocess_contains_essential_commands_the_whitelist(
        self,
    ) -> None:
    ...
    def test_utils_subprocess_is_frozenset_its_immutable(self) -> None:
...
class TestRunSafeCommand:
    ...
    def test_utils_subprocess_run_echo_command_echo_command(self) -> None:
    ...
    def test_utils_subprocess_dry_run_mode_execute_command(self) -> None:
    ...
    def test_utils_subprocess_command_not_in_whitelist_are_rejected(self) -> None:
    ...
    def test_utils_subprocess_empty_command_rejected_raises_securityerror(self) -> None:
        """Test that empty command raises SecurityError."""
        with pytest.raises(SecurityError, match="Empty command"):
            run_safe_command([])

    def test_utils_subprocess_command_injection_blocked_are_blocked(self) -> None:
    ...
    def test_utils_subprocess_command_not_found_raises_securityerror(self) -> None:
    ...
    def test_utils_subprocess_timeout_handling_is_handled(self) -> None:
    ...
    def test_utils_subprocess_working_directory_is_respected(self, tmp_path: Path) -> None:
    ...
    def test_utils_subprocess_invalid_working_directory_raises_error(self) -> None:
    ...
    def test_utils_subprocess_custom_allowed_commands_commands_list(self) -> None:
    ...
    def test_utils_subprocess_duration_is_tracked_is_tracked(self) -> None:
        """Test that command duration is tracked."""
        result = run_safe_command(["echo", "test"])
        assert result.duration_seconds >= 0

    def test_utils_subprocess_timeout_negative_value_negative_seconds(self) -> None:
    ...
    def test_utils_subprocess_timeout_nan_value_nan_seconds(self) -> None:
    ...
    def test_utils_subprocess_timeout_inf_value_infinity_seconds(self) -> None:
...
def test_utils_subprocess_execute_command_timeout_with_bytes_stdout_is_bytes() -> None:
...
def test_utils_subprocess_execute_command_timeout_without_stdout_is_none() -> None:
...
def test_utils_subprocess_execute_command_timeout_with_str_stdout_is_str() -> None:
