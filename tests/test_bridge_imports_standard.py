...
class TestRequireDependency:
    ...
    def test_bridge_imports_existing_module_standard_expected(self) -> None:
        """Returns Ok for installed modules."""
        result = require_dependency("json")
        assert isinstance(result, Ok)
        assert isinstance(result.ok_value, types.ModuleType)

    def test_bridge_imports_missing_module_default_hint_standard_expected(self) -> None:
    ...
    def test_bridge_imports_missing_module_with_extra_standard_expected(self) -> None:
...
class TestGetAttrOrErr:
    ...
    def test_bridge_imports_existing_attr_standard_expected(self) -> None:
    ...
    def test_bridge_imports_missing_attr_standard_expected(self) -> None:
