...
class TestTaipanMiddleware:
    ...
    @pytest.mark.asyncio
    async def test_passthrough_http_expected(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_passthrough_non_http_expected(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_security_headers_injected_expected(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_unhandled_exception_returns_500_expected(self) -> None:
...
class TestSendJsonResponse:
    ...
    @pytest.mark.asyncio
    async def test_sends_json_expected(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_extra_headers_expected(self) -> None:
