...
class TestBulkhead:
    ...
    @pytest.mark.asyncio
    async def test_bulkhead_execute_success_execution_success(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bulkhead_execute_failure_execution_success(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bulkhead_concurrency_limit_execution_success(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bulkhead_queue_overflow_execution_success(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bulkhead_timeout_ok_execution_success(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bulkhead_permits_tracking_execution_success(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bulkhead_with_arguments_execution_success(self) -> None:
    ...
    def test_bulkhead_full_error_execution_success(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bulkhead_cancellation_release_execution_success(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bulkhead_queued_cancellation_execution_success(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bulkhead_timeout_release_on_race_execution_success(self) -> None:
