...
def test_fuzz_python_version_fuzz_version_massive_strings_dos_standard_expected(
    version: str,
) -> None:
...
def test_fuzz_python_version_fuzz_version_unprintable_chars_standard_expected(
    chars: str,
) -> None:
...
def test_fuzz_python_version_version_unicode_digits_standard_expected() -> None:
