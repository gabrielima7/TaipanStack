...
def test_chaos_fallback_mutation_chaos_fallback_exceptions_tuple_mutation_is_mutated() -> None:
...
@pytest.mark.asyncio
async def test_chaos_fallback_mutation_chaos_fallback_exceptions_tuple_mutation_async_in_async() -> (
    None
):
...
def test_chaos_fallback_mutation_chaos_fallback_exceptions_tuple_mutation_sync_result_returns_ok() -> (
    None
):
...
@pytest.mark.asyncio
async def test_chaos_fallback_mutation_chaos_fallback_exceptions_tuple_mutation_async_result_returns_ok() -> (
    None
):
