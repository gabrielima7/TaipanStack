...
class TestEncodeJWT:
    ...
    def test_security_jwt_encode_success_execution_success(self) -> None:
    ...
    def test_security_jwt_encode_rejects_none_algorithm_execution_success(self) -> None:
...
class TestDecodeJWT:
    ...
    def test_security_jwt_decode_success_execution_success(self) -> None:
    ...
    def test_security_jwt_decode_rejects_none_algorithm_execution_success(self) -> None:
    ...
    def test_security_jwt_decode_requires_exp_execution_success(self) -> None:
    ...
    def test_security_jwt_decode_requires_aud_execution_success(self) -> None:
    ...
    def test_security_jwt_decode_invalid_signature_execution_success(self) -> None:
    ...
    def test_security_jwt_decode_expired_token_execution_success(self) -> None:
    ...
    def test_security_jwt_decode_wrong_audience_execution_success(self) -> None:
