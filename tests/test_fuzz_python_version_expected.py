...
def test_fuzz_python_version_fuzz_version_massive_strings_dos_are_active(
    version: str,
) -> None:
...
def test_fuzz_python_version_fuzz_version_null_bytes_null_bytes(
    version: str,
) -> None:
...
def test_fuzz_python_version_fuzz_version_unprintable_chars_unprintable_unicode(
    chars: str,
) -> None:
...
def test_fuzz_python_version_version_unicode_digits_arabic_numerals() -> None:
