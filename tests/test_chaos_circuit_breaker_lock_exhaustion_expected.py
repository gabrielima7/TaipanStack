...
def test_chaos_circuit_breaker_lock_acquire_exception_sync_expected():
...
@pytest.mark.asyncio
async def test_chaos_circuit_breaker_decorator_lock_acquire_exception_async_expected():
...
def test_chaos_circuit_breaker_decorator_lock_acquire_exception_sync_expected():
    @circuit_breaker(failure_threshold=2)
    def my_func():
        return Ok("success")
