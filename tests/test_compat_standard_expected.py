...
class TestVersionTier:
    ...
    def test_compat_standard_compat_version_tier_values_expected_values(self) -> None:
    ...
    def test_compat_standard_compat_version_tier_is_str_are_strings(self) -> None:
...
class TestExperimentalFeatures:
    ...
    def test_compat_standard_compat_experimental_disabled_by_default_by_default(self) -> None:
        """Test experimental features disabled by default."""
        with patch.dict(os.environ, {}, clear=True):
            assert not is_experimental_enabled(force_refresh=True)

    def test_compat_standard_compat_experimental_enabled_with_1_value_1(self) -> None:
    ...
    def test_compat_standard_compat_experimental_enabled_with_true_value_true(self) -> None:
        """Test experimental enabled with value 'true'."""
        with patch.dict(os.environ, {"STACK_ENABLE_EXPERIMENTAL": "true"}):
            assert is_experimental_enabled(force_refresh=True)

    def test_compat_standard_compat_experimental_enabled_with_yes_value_yes(self) -> None:
        """Test experimental enabled with value 'yes'."""
        with patch.dict(os.environ, {"STACK_ENABLE_EXPERIMENTAL": "yes"}):
            assert is_experimental_enabled(force_refresh=True)

    def test_compat_standard_compat_experimental_enabled_with_on_value_on(self) -> None:
        """Test experimental enabled with value 'on'."""
        with patch.dict(os.environ, {"STACK_ENABLE_EXPERIMENTAL": "on"}):
            assert is_experimental_enabled(force_refresh=True)

    def test_compat_standard_compat_experimental_disabled_with_0_value_0(self) -> None:
        """Test experimental disabled with value '0'."""
        with patch.dict(os.environ, {"STACK_ENABLE_EXPERIMENTAL": "0"}):
            assert not is_experimental_enabled(force_refresh=True)

    def test_compat_standard_compat_experimental_case_insensitive_is_caseinsensitive(self) -> None:
...
class TestOptimizationLevel:
    ...
    def test_compat_standard_compat_default_optimization_level_is_1(self) -> None:
        """Test default optimization level is 1."""
        with patch.dict(os.environ, {}, clear=True):
            assert get_optimization_level(force_refresh=True) == 1

    def test_compat_standard_compat_optimization_level_0_to_0(self) -> None:
    ...
    def test_compat_standard_compat_optimization_level_2_to_2(self) -> None:
    ...
    def test_compat_standard_compat_optimization_level_clamped_low_minimum_0(self) -> None:
        """Test optimization level is clamped to minimum 0."""
        with patch.dict(os.environ, {"STACK_OPTIMIZATION_LEVEL": "-5"}):
            assert get_optimization_level(force_refresh=True) == 0

    def test_compat_standard_compat_optimization_level_clamped_high_maximum_2(self) -> None:
        """Test optimization level is clamped to maximum 2."""
        with patch.dict(os.environ, {"STACK_OPTIMIZATION_LEVEL": "99"}):
            assert get_optimization_level(force_refresh=True) == 2

    def test_compat_standard_compat_optimization_level_invalid_to_1(self) -> None:
        """Test invalid optimization level defaults to 1."""
        with patch.dict(os.environ, {"STACK_OPTIMIZATION_LEVEL": "invalid"}):
            assert get_optimization_level(force_refresh=True) == 1

    def test_compat_standard_compat_optimization_level_exceeds_int_limit_limit_cve202010735(
        self,
    ) -> None:
...
class TestPythonFeatures:
    ...
    def test_compat_standard_compat_get_features_returns_features_pythonfeatures_instance(self) -> None:
        """Test get_features returns PythonFeatures instance."""
        features = get_features()
        assert isinstance(features, PythonFeatures)

    def test_compat_standard_compat_features_version_correct_version(self) -> None:
    ...
    def test_compat_standard_compat_features_tier_stable_python_311(self) -> None:
    ...
    def test_compat_standard_compat_features_tier_enhanced_python_312(self) -> None:
    ...
    def test_compat_standard_compat_features_tier_modern_python_313(self) -> None:
    ...
    def test_compat_standard_compat_features_tier_cutting_edge_python_314(self) -> None:
    ...
    def test_compat_standard_compat_features_language_311_python_311(self) -> None:
    ...
    def test_compat_standard_compat_features_language_312_python_312(self) -> None:
    ...
    def test_compat_standard_compat_features_language_313_python_313(self) -> None:
        """Test language features for Python 3.13."""
        features = get_features()
        if PY313:
            assert features.has_deprecated_decorator

    def test_compat_standard_compat_features_language_314_python_314(self) -> None:
        """Test language features for Python 3.14."""
        features = get_features()
        if PY314:
            assert features.has_deferred_annotations

    def test_compat_standard_compat_features_experimental_disabled_is_off(self) -> None:
    ...
    def test_compat_standard_compat_features_to_dict_to_dictionary(self) -> None:
    ...
    def test_compat_standard_compat_features_cached_first_call(self) -> None:
        """Test features are cached after first call."""
        features1 = get_features()
        features2 = get_features()
        assert features1 is features2

    def test_compat_standard_compat_features_force_refresh_bypasses_cache(self) -> None:
...
class TestGetPythonInfo:
    ...
    def test_compat_standard_compat_python_info_structure_expected_structure(self) -> None:
    ...
    def test_compat_standard_compat_python_info_values_valid_values(self) -> None:
    ...
    def test_compat_standard_compat_experimental_enabled_cached_is_cached(self) -> None:
    ...
    def test_compat_standard_compat_optimization_level_cached_is_cached(self) -> None:
