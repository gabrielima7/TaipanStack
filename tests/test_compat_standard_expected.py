...
class TestVersionTier:
    ...
    def test_compat_standard_compat_version_tier_values(self) -> None:
    ...
    def test_compat_standard_compat_version_tier_is_str(self) -> None:
...
class TestExperimentalFeatures:
    ...
    def test_compat_standard_compat_experimental_disabled_by_default(self) -> None:
        """Test experimental features disabled by default."""
        with patch.dict(os.environ, {}, clear=True):
            assert not is_experimental_enabled(force_refresh=True)

    def test_compat_standard_compat_experimental_enabled_with_1(self) -> None:
...
class TestOptimizationLevel:
    ...
    def test_compat_standard_compat_default_optimization_level(self) -> None:
        """Test default optimization level is 1."""
        with patch.dict(os.environ, {}, clear=True):
            assert get_optimization_level(force_refresh=True) == 1

    def test_compat_standard_compat_optimization_level_0(self) -> None:
    ...
    def test_compat_standard_compat_optimization_level_2(self) -> None:
...
class TestPythonFeatures:
    ...
    def test_compat_standard_compat_get_features_returns_features(self) -> None:
        """Test get_features returns PythonFeatures instance."""
        features = get_features()
        assert isinstance(features, PythonFeatures)

    def test_compat_standard_compat_features_version(self) -> None:
    ...
    def test_compat_standard_compat_features_tier_stable(self) -> None:
    ...
    def test_compat_standard_compat_features_tier_enhanced(self) -> None:
    ...
    def test_compat_standard_compat_features_tier_modern(self) -> None:
    ...
    def test_compat_standard_compat_features_tier_cutting_edge(self) -> None:
    ...
    def test_compat_standard_compat_features_language_311(self) -> None:
    ...
    def test_compat_standard_compat_features_language_312(self) -> None:
    ...
    def test_compat_standard_compat_features_language_313(self) -> None:
        """Test language features for Python 3.13."""
        features = get_features()
        if PY313:
            assert features.has_deprecated_decorator

    def test_compat_standard_compat_features_language_314(self) -> None:
        """Test language features for Python 3.14."""
        features = get_features()
        if PY314:
            assert features.has_deferred_annotations

    def test_compat_standard_compat_features_experimental_disabled(self) -> None:
    ...
    def test_compat_standard_compat_features_to_dict(self) -> None:
    ...
    def test_compat_standard_compat_features_cached(self) -> None:
        """Test features are cached after first call."""
        features1 = get_features()
        features2 = get_features()
        assert features1 is features2

    def test_compat_standard_compat_features_force_refresh(self) -> None:
...
class TestGetPythonInfo:
    ...
    def test_compat_standard_compat_python_info_structure(self) -> None:
    ...
    def test_compat_standard_compat_python_info_values(self) -> None:
    ...
    def test_compat_standard_compat_experimental_enabled_cached(self) -> None:
    ...
    def test_compat_standard_compat_optimization_level_cached(self) -> None:
