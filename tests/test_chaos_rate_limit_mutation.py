...
def test_chaos_rate_limit_lock_mutation():
...
def test_chaos_rate_limit_state_mutation():
...
def test_chaos_rate_limit_sync_decorator_exception():
...
def test_chaos_rate_limit_time_mutation():
...
def test_chaos_rate_limit_capacity_mutation():
...
def test_chaos_rate_limit_time_window_mutation():
...
def test_chaos_rate_limit_tokens_mutation():
...
def test_chaos_rate_limit_consume_negative_tokens():
    """Chaos test: Negative tokens consumption."""
    limiter = RateLimiter(max_calls=10, time_window=1.0)
    assert limiter.consume(tokens=-5.0) is True


def test_chaos_rate_limit_current_time_exception():
...
def test_chaos_rate_limit_apply_new_tokens_mutation():
...
def test_chaos_rate_limit_try_consume_mutation():
...
def test_chaos_rate_limit_apply_new_tokens_success():
...
def test_chaos_rate_limit_apply_new_tokens_cap():
...
def test_chaos_rate_limit_add_tokens_invalid_new_tokens():
...
def test_chaos_rate_limit_try_consume_success():
...
def test_chaos_rate_limit_sync_wrapper_limit_exceeded():
...
def test_chaos_rate_limit_sync_wrapper_success():
...
def test_chaos_rate_limit_init_nan():
