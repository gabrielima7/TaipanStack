...
def test_chaos_fallback_type_mutation_chaos_fallback_chaos_type_mutation_sync_original_error():
...
@pytest.mark.asyncio
async def test_chaos_fallback_type_mutation_chaos_fallback_chaos_type_mutation_async_in_async():
