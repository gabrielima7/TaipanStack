...
def test_chaos_fallback_type_mutation_chaos_fallback_chaos_type_mutation_sync_expected():
...
@pytest.mark.asyncio
async def test_chaos_fallback_type_mutation_chaos_fallback_chaos_type_mutation_async_expected():
