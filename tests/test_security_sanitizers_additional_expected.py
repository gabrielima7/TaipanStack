...
def test_is_valid_length_and_not_dot_expected():
...
def test_has_safe_characters_expected():
...
def test_resolve_sanitized_path_error_expected():
...
def test_resolve_sanitized_path_runtime_error_expected():
    import unittest.mock
    from pathlib import Path
