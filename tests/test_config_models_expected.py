...
class TestSecurityConfig:
    ...
    def test_config_models_default_values_security_configuration(self) -> None:
    ...
    def test_config_models_paranoid_level_security_level(self) -> None:
        """Test paranoid security level."""
        config = SecurityConfig(level="paranoid")
        assert config.level == "paranoid"

    def test_config_models_frozen_config_is_immutable(self) -> None:
        """Test that config is immutable."""
        config = SecurityConfig()
        with pytest.raises(ValidationError):
            config.level = "standard"  # type: ignore[misc]

    def test_config_models_extra_fields_forbidden_not_allowed(self) -> None:
...
class TestDependencyConfig:
    ...
    def test_config_models_default_values_dependency_configuration(self) -> None:
    ...
    def test_config_models_custom_dependencies_custom_dependencies(self) -> None:
...
class TestLoggingConfig:
    ...
    def test_config_models_default_values_logging_configuration(self) -> None:
    ...
    def test_config_models_valid_levels_log_levels(self) -> None:
        """Test all valid log levels."""
        for level in ["DEBUG", "INFO", "WARNING", "ERROR", "CRITICAL"]:
            config = LoggingConfig(level=level)  # type: ignore[arg-type]
            assert config.level == level

    def test_config_models_invalid_level_rejected_is_rejected(self) -> None:
...
class TestStackConfig:
    ...
    def test_config_models_default_values_stack_configuration(self) -> None:
    ...
    def test_config_models_valid_project_name_project_names(self) -> None:
        """Test valid project names."""
        config = StackConfig(project_name="my_awesome_project")
        assert config.project_name == "my_awesome_project"

    def test_config_models_invalid_project_name_rejected_are_rejected(
        self,
    ) -> None:
    ...
    def test_config_models_valid_python_version_python_versions(self) -> None:
        """Test valid Python versions."""
        config = StackConfig(python_version="3.11")
        assert config.python_version == "3.11"

    def test_config_models_invalid_python_version_rejected_are_rejected(
        self,
    ) -> None:
    ...
    def test_config_models_valid_project_dir_is_resolved(self, tmp_path: Path) -> None:
    ...
    def test_config_models_path_traversal_rejected_is_rejected(self, tmp_path: Path) -> None:
        """Test path traversal in project_dir is rejected."""
        with pytest.raises(ValidationError, match="Path traversal"):
            StackConfig(project_dir=Path("../../../etc"))

    def test_config_models_absolute_path_accepted_and_resolved(self, tmp_path: Path) -> None:
    ...
    def test_config_models_path_with_dots_not_traversal_accepted_are_accepted(
        self, tmp_path: Path
    ) -> None:
    ...
    def test_config_models_non_existent_path_accepted_handles_it(self, tmp_path: Path) -> None:
    ...
    def test_config_models_direct_validate_project_dir_call_validateprojectdir_classmethod(
        self,
    ) -> None:
    ...
    def test_config_models_validate_project_dir_traversal_direct_call_with_traversal(
        self,
    ) -> None:
    ...
    def test_config_models_path_with_double_dots_in_name_rejected_currently_rejected(
        self,
    ) -> None:
    ...
    def test_config_models_paranoid_requires_all_tools_security_tools(self) -> None:
    ...
    def test_config_models_to_target_version_version_conversion(self) -> None:
        """Test target version conversion."""
        config = StackConfig(python_version="3.12")
        assert config.to_target_version() == "py312"

    def test_config_models_nested_configs_configuration_objects(self) -> None:
    ...
    def test_config_models_invalid_python_version_too_old_is_rejected(
        self,
    ) -> None:
