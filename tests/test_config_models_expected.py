...
class TestStackConfig:
    ...
    def test_config_models_invalid_project_name_rejected(
        self,
    ) -> None:
    ...
    def test_config_models_invalid_python_version_rejected(
        self,
    ) -> None:
    ...
    def test_config_models_direct_validate_project_dir_call(
        self,
    ) -> None:
    ...
    def test_config_models_invalid_python_version_too_old(
        self,
    ) -> None:
