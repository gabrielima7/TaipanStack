...
class TestSafeCommandResult:
    ...
    def test_utils_subprocess_success_true_when_returncode_zero(self) -> None:
    ...
    def test_utils_subprocess_success_false_when_returncode_nonzero(
        self,
    ) -> None:
    ...
    def test_utils_subprocess_duration_seconds_default(self) -> None:
...
class TestDefaultAllowedCommands:
    ...
    def test_utils_subprocess_contains_essential_commands(self) -> None:
    ...
    def test_utils_subprocess_is_frozenset(self) -> None:
...
class TestRunSafeCommand:
    ...
    def test_utils_subprocess_run_echo_command(self) -> None:
    ...
    def test_utils_subprocess_dry_run_mode(self) -> None:
    ...
    def test_utils_subprocess_command_not_in_whitelist(self) -> None:
    ...
    def test_utils_subprocess_empty_command_rejected(self) -> None:
        """Test that empty command raises SecurityError."""
        with pytest.raises(SecurityError, match="Empty command"):
            run_safe_command([])

    def test_utils_subprocess_command_injection_blocked(self) -> None:
    ...
    def test_utils_subprocess_command_not_found(self) -> None:
    ...
    def test_utils_subprocess_timeout_handling(self) -> None:
    ...
    def test_utils_subprocess_working_directory(self, tmp_path: Path) -> None:
    ...
    def test_utils_subprocess_invalid_working_directory(self) -> None:
    ...
    def test_utils_subprocess_custom_allowed_commands(self) -> None:
    ...
    def test_utils_subprocess_duration_is_tracked(self) -> None:
        """Test that command duration is tracked."""
        result = run_safe_command(["echo", "test"])
        assert result.duration_seconds >= 0

    def test_utils_subprocess_timeout_negative_value(self) -> None:
    ...
    def test_utils_subprocess_timeout_nan_value(self) -> None:
    ...
    def test_utils_subprocess_timeout_inf_value(self) -> None:
...
def test_utils_subprocess_standard_utils_subprocess_execute_command_timeout_with_bytes_stdout() -> (
    None
):
...
def test_utils_subprocess_standard_utils_subprocess_execute_command_timeout_without_stdout() -> (
    None
):
...
def test_utils_subprocess_standard_utils_subprocess_execute_command_timeout_with_str_stdout() -> (
    None
):
