...
class TestSanitizeStringProperties:
    ...
    def test_property_sanitizers_never_contains_null_bytes_null_bytes(self, text: str) -> None:
    ...
    def test_property_sanitizers_no_control_characters_except_whitespace_tab_cr(
        self, text: str
    ) -> None:
    ...
    def test_property_sanitizers_respects_max_length_exceed_maxlength(
    ...
    def test_property_sanitizers_returns_string_type_a_string(self, text: str) -> None:
    ...
    def test_property_sanitizers_html_tags_removed_by_default_when_allowhtmlfalse(self, text: str) -> None:
...
class TestSanitizeFilenameProperties:
    ...
    def test_property_sanitizers_never_empty_completely_empty(self, text: str) -> None:
    ...
    def test_property_sanitizers_no_path_separators_separator_characters(self, text: str) -> None:
    ...
    def test_property_sanitizers_no_null_bytes_null_bytes(self, text: str) -> None:
    ...
    def test_property_sanitizers_respects_max_length_nonempty_filenames(
        self, text: str, max_len: int
    ) -> None:
    ...
    def test_property_sanitizers_no_windows_reserved_chars_windowsreserved_characters(self, text: str) -> None:
    ...
    def test_property_sanitizers_mutmut_boundaries_and_limits_surviving_mutants(
        self,
    ) -> None:
...
class TestSanitizePathProperties:
    ...
    def test_property_sanitizers_no_traversal_in_output_traversal_components(self, text: str) -> None:
    ...
    def test_property_sanitizers_depth_enforcement_raise_valueerror(
