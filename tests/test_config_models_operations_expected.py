...
class TestSecurityConfig:
    ...
    def test_config_models_extra_fields_forbidden_expected(self) -> None:
...
class TestLoggingConfig:
    ...
    def test_config_models_invalid_level_rejected_expected(self) -> None:
...
class TestStackConfig:
    ...
    def test_config_models_valid_project_name_expected(self) -> None:
        """Test valid project names."""
        config = StackConfig(project_name="my_awesome_project")
        assert config.project_name == "my_awesome_project"

    def test_config_models_invalid_project_name_rejected_expected(self) -> None:
    ...
    def test_config_models_valid_python_version_expected(self) -> None:
        """Test valid Python versions."""
        config = StackConfig(python_version="3.11")
        assert config.python_version == "3.11"

    def test_config_models_invalid_python_version_rejected_expected(self) -> None:
    ...
    def test_config_models_direct_validate_project_dir_call_expected(self) -> None:
    ...
    def test_config_models_paranoid_requires_all_tools_expected(self) -> None:
    ...
    def test_config_models_to_target_version_expected(self) -> None:
...
def test_config_models_invalid_python_version_too_old_expected() -> None:
