...
def test_chaos_adaptive_breaker_mutations_adaptive_breaker_target_error_rate_mutation_standard_expected():
...
def test_chaos_adaptive_breaker_mutations_adaptive_breaker_target_error_rate_nan_standard_expected():
...
def test_chaos_adaptive_breaker_mutations_adaptive_breaker_last_opened_at_mutation_standard_expected():
...
def test_chaos_adaptive_breaker_mutations_adaptive_breaker_last_opened_at_nan_standard_expected():
...
def test_chaos_adaptive_breaker_mutations_adaptive_breaker_clock_jump_backward_standard_expected():
...
def test_chaos_adaptive_breaker_mutations_adaptive_breaker_time_corruption_nan_standard_expected(
    monkeypatch,
):
...
def test_chaos_adaptive_breaker_mutations_adaptive_breaker_min_throughput_invalid_standard_expected():
...
def test_chaos_adaptive_breaker_mutations_adaptive_breaker_calculate_error_rate_zero_standard_expected():
