...
class TestAdaptiveRetry:
    ...
    def test_adaptive_retry_fallback_delay_without_data_execution_success(self) -> None:
    ...
    def test_adaptive_retry_learned_delay_from_successes_execution_success(
        self,
    ) -> None:
    ...
    def test_adaptive_retry_failure_does_not_affect_delay_execution_success(
        self,
    ) -> None:
    ...
    def test_adaptive_retry_delay_clamped_to_bounds_execution_success(self) -> None:
    ...
    def test_adaptive_retry_to_retry_config_execution_success(self) -> None:
    ...
    def test_adaptive_retry_metrics_snapshot_execution_success(self) -> None:
    ...
    def test_adaptive_retry_empty_metrics_execution_success(self) -> None:
    ...
    def test_adaptive_retry_per_attempt_isolation_execution_success(self) -> None:
    ...
    def test_adaptive_retry_max_delay_exponential_fallback_execution_success(
        self,
    ) -> None:
