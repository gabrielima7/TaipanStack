...
class TestGuardCommandInjection:
    ...
    def test_security_guards_command_not_in_whitelist_blocked(
        self,
    ) -> None:
...
class TestGuardFileExtension:
    ...
    def test_security_guards_dangerous_extension_blocked(
        self,
    ) -> None:
...
def test_security_guards_ssrf_url_invalid_characters() -> None:
...
def test_security_guards_ssrf_url_valid_characters() -> None:
...
def test_security_guards_ssrf_url_invalid_characters_branch() -> None:
