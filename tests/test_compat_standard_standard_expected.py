...
class TestVersionTier:
    ...
    def test_compat_standard_compat_version_tier_values_expected(self) -> None:
    ...
    def test_compat_standard_compat_version_tier_is_str_expected(self) -> None:
...
class TestExperimentalFeatures:
    ...
    def test_compat_standard_compat_experimental_enabled_with_1_expected(self) -> None:
    ...
    def test_compat_standard_compat_experimental_enabled_with_on_expected(self) -> None:
        """Test experimental enabled with value 'on'."""
        with patch.dict(os.environ, {"STACK_ENABLE_EXPERIMENTAL": "on"}):
            assert is_experimental_enabled(force_refresh=True)

    def test_compat_standard_compat_experimental_disabled_with_0_expected(self) -> None:
...
class TestOptimizationLevel:
    ...
    def test_compat_standard_compat_default_optimization_level_expected(self) -> None:
        """Test default optimization level is 1."""
        with patch.dict(os.environ, {}, clear=True):
            assert get_optimization_level(force_refresh=True) == 1

    def test_compat_standard_compat_optimization_level_0_expected(self) -> None:
    ...
    def test_compat_standard_compat_optimization_level_2_expected(self) -> None:
    ...
    def test_compat_standard_compat_optimization_level_invalid_expected(self) -> None:
        """Test invalid optimization level defaults to 1."""
        with patch.dict(os.environ, {"STACK_OPTIMIZATION_LEVEL": "invalid"}):
            assert get_optimization_level(force_refresh=True) == 1

    def test_compat_standard_compat_optimization_level_exceeds_int_limit_expected(
        self,
    ) -> None:
...
class TestPythonFeatures:
    ...
    def test_compat_standard_compat_features_version_expected(self) -> None:
    ...
    def test_compat_standard_compat_features_tier_stable_expected(self) -> None:
    ...
    def test_compat_standard_compat_features_tier_enhanced_expected(self) -> None:
    ...
    def test_compat_standard_compat_features_tier_modern_expected(self) -> None:
    ...
    def test_compat_standard_compat_features_tier_cutting_edge_expected(self) -> None:
    ...
    def test_compat_standard_compat_features_language_311_expected(self) -> None:
    ...
    def test_compat_standard_compat_features_language_312_expected(self) -> None:
    ...
    def test_compat_standard_compat_features_language_313_expected(self) -> None:
        """Test language features for Python 3.13."""
        features = get_features()
        if PY313:
            assert features.has_deprecated_decorator

    def test_compat_standard_compat_features_language_314_expected(self) -> None:
    ...
    def test_compat_standard_compat_features_to_dict_expected(self) -> None:
    ...
    def test_compat_standard_compat_features_cached_expected(self) -> None:
        """Test features are cached after first call."""
        features1 = get_features()
        features2 = get_features()
        assert features1 is features2

    def test_compat_standard_compat_features_force_refresh_expected(self) -> None:
...
class TestGetPythonInfo:
    ...
    def test_compat_standard_compat_python_info_structure_expected(self) -> None:
    ...
    def test_compat_standard_compat_python_info_values_expected(self) -> None:
    ...
    def test_compat_standard_compat_experimental_enabled_cached_expected(self) -> None:
    ...
    def test_compat_standard_compat_optimization_level_cached_expected(self) -> None:
