...
class TestSubprocessCheckCommand:
    ...
    def test_very_last_run_safe_command_check_true_fails_expected(self) -> None:
...
class TestCompatPy313FeatureDetection:
    ...
    def test_very_last_check_free_threading_attribute_error_expected(self) -> None:
...
def test_very_last_guard_path_traversal_is_symlink_oserror_expected(monkeypatch):
    from pathlib import Path
