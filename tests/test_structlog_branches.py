...
class TestLoggingWithMockedStructlog:
    ...
    def test_stack_logger_with_structured_true_expected(self) -> None:
    ...
    def test_stack_logger_bind_with_structured_expected(self) -> None:
    ...
    def test_stack_logger_unbind_with_structured_expected(self) -> None:
