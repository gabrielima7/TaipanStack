...
def test_chaos_adaptive_breaker_mutations_adaptive_breaker_target_error_rate_mutation_a_string():
...
def test_chaos_adaptive_breaker_mutations_adaptive_breaker_target_error_rate_nan_to_nan():
...
def test_chaos_adaptive_breaker_mutations_adaptive_breaker_last_opened_at_mutation_a_string():
...
def test_chaos_adaptive_breaker_mutations_adaptive_breaker_last_opened_at_nan_to_nan():
...
def test_chaos_adaptive_breaker_mutations_adaptive_breaker_clock_jump_backward_is_negative():
...
def test_chaos_adaptive_breaker_mutations_adaptive_breaker_time_corruption_nan_returns_nan(
    monkeypatch,
):
...
def test_chaos_adaptive_breaker_mutations_adaptive_breaker_min_throughput_invalid_raises_valueerror():
...
def test_chaos_adaptive_breaker_mutations_adaptive_breaker_calculate_error_rate_zero_or_less():
