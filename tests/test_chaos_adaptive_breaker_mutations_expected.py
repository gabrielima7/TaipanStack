...
def test_chaos_adaptive_breaker_mutations_adaptive_breaker_target_error_rate_mutation_expected():
...
def test_chaos_adaptive_breaker_mutations_adaptive_breaker_target_error_rate_nan_expected():
...
def test_chaos_adaptive_breaker_mutations_adaptive_breaker_calculate_error_rate_zero_expected():
