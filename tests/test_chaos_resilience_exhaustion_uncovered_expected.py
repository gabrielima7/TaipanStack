...
@pytest.mark.asyncio
async def test_chaos_resilience_exhaustion_uncovered_timeout_wait_for_keyboard_interrupt():
    @timeout(1.0)
    async def my_func():
        return Ok("success")
...
@pytest.mark.asyncio
async def test_chaos_resilience_exhaustion_uncovered_retry_async_sleep_keyboard_interrupt():
