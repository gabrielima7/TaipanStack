...
def test_fuzz_version_massive_strings_dos(version: str) -> None:
...
def test_fuzz_version_null_bytes(version: str) -> None:
...
def test_fuzz_version_unprintable_chars(chars: str) -> None:
...
def test_version_unicode_digits() -> None:
