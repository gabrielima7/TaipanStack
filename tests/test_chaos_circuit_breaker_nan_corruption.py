...
def test_chaos_circuit_breaker_nan_corruption_circuit_breaker_corrupt_failure_count_to_nan_closed_standard():
    # Setup
...
def test_chaos_circuit_breaker_nan_corruption_circuit_breaker_corrupt_failure_count_to_string_closed_standard():
    # Setup
    breaker = CircuitBreaker(failure_threshold=5)
    breaker._state.state = CircuitState.CLOSED
...
def test_chaos_circuit_breaker_nan_corruption_circuit_breaker_corrupt_failure_count_to_nan_update_standard():
    # Setup
    breaker = CircuitBreaker(failure_threshold=5)
    breaker._state.state = CircuitState.CLOSED
    breaker._state.failure_count = float("nan")  # simulate memory corruption
...
def test_chaos_circuit_breaker_nan_corruption_circuit_breaker_corrupt_failure_count_to_string_update_standard():
    # Setup
    breaker = CircuitBreaker(failure_threshold=5)
    breaker._state.state = CircuitState.CLOSED
    breaker._state.failure_count = "corrupted"  # simulate memory corruption
...
def test_chaos_circuit_breaker_nan_corruption_circuit_breaker_corrupt_half_open_attempts_to_nan_standard():
    # Setup
...
def test_chaos_circuit_breaker_nan_corruption_circuit_breaker_corrupt_half_open_attempts_to_string_standard():
    # Setup
    breaker = CircuitBreaker(success_threshold=2)
    breaker._state.state = CircuitState.HALF_OPEN
