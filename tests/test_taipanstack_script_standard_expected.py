...
def test_taipanstack_script_dry_run_does_not_create_files_standard_expected(tmp_path):
    """
...
def test_taipanstack_script_safe_write_creates_backup_standard_expected(tmp_path):
    """
...
def test_taipanstack_script_idempotency_for_pyproject_toml_standard_expected(tmp_path):
    """
...
def test_taipanstack_script_git_initialization_standard_expected(tmp_path):
    """
...
def test_taipanstack_script_project_structure_creation_standard_expected(tmp_path):
    """
...
def test_taipanstack_script_setup_pre_commit_standard_expected():
    """
...
def test_taipanstack_script_setup_pre_commit_dry_run_standard_expected():
    """
