...
@pytest.mark.asyncio
async def test_chaos_watchdogs_base_watcher_stop_cancelled_error_handles_asynciocancellederror() -> None:
...
@pytest.mark.asyncio
async def test_chaos_watchdogs_base_watcher_loop_exception_handling_the_loop() -> None:
...
@pytest.mark.asyncio
async def test_chaos_watchdogs_health_pinger_skips_open_breaker_already_open() -> None:
