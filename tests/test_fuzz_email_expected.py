...
def test_fuzz_email_massive_strings_dos_are_active(email: str) -> None:
...
def test_fuzz_email_null_bytes_null_bytes(email: str) -> None:
...
def test_fuzz_email_unprintable_chars_unprintable_unicode(chars: str) -> None:
