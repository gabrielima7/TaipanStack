...
def test_chaos_resilience_circuit_circuit_breaker_on_state_change_chaos_standard_expected():
...
def test_chaos_resilience_circuit_circuit_breaker_on_state_change_chaos_without_structlog_standard_expected(
    monkeypatch,
):
...
def test_chaos_resilience_circuit_circuit_breaker_chaos_config_mutations_standard_expected():
...
def test_chaos_resilience_circuit_structlog_warning_without_callback_standard_expected(
...
def test_chaos_resilience_circuit_structlog_fallback_noop_when_unavailable_standard_expected(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
