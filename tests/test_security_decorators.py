...
class TestValidateInputs:
    ...
    def test_valid_inputs_pass_expected(self) -> None:
    ...
    def test_validation_error_has_param_name_expected(self) -> None:
...
class TestGuardExceptions:
    ...
    def test_no_exception_passes_through_expected(self) -> None:
...
class TestTimeout:
    ...
    def test_fast_function_succeeds_expected(self) -> None:
    ...
    def test_timeout_error_has_details_expected(self) -> None:
    ...
    def test_timeout_with_exception_in_thread_expected(self) -> None:
    ...
    def test_timeout_with_success_in_thread_expected(self) -> None:
...
class TestDeprecated:
    ...
    def test_emits_deprecation_warning_expected(self) -> None:
    ...
    def test_includes_removal_version_expected(self) -> None:
...
class TestRequireType:
    ...
    def test_correct_types_pass_expected(self) -> None:
    ...
    def test_multiple_type_checks_expected(self) -> None:
