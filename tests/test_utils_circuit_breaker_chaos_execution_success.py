...
def test_utils_circuit_breaker_chaos_half_open_thundering_herd_chaos_execution_success():
...
def test_utils_circuit_breaker_chaos_half_open_exhaustion_with_system_exit_execution_success():
...
@pytest.mark.asyncio
async def test_utils_circuit_breaker_chaos_async_half_open_exhaustion_with_cancelled_error_expected_execution_success():
