...
def test_utils_resilience_fallback_sync_standard_expected() -> None:
...
def test_utils_resilience_fallback_sync_unreachable_standard_expected() -> None:
...
@pytest.mark.asyncio
async def test_utils_resilience_fallback_async_unreachable_expected_standard_expected() -> None:
...
def test_utils_resilience_timeout_sync_standard_expected() -> None:
