...
class TestOptimizationProfile:
    ...
    def test_optimizations_profile_creation_execution_success(self) -> None:
    ...
    def test_optimizations_profile_immutable_execution_success(self) -> None:
...
class TestOptimizationResult:
    ...
    def test_optimizations_result_creation_execution_success(self) -> None:
    ...
    def test_optimizations_result_to_dict_execution_success(self) -> None:
...
class TestGetOptimizationProfile:
    ...
    def test_optimizations_profile_for_311_execution_success(self) -> None:
    ...
    def test_optimizations_profile_for_312_execution_success(self) -> None:
    ...
    def test_optimizations_profile_for_313_execution_success(self) -> None:
    ...
    def test_optimizations_profile_for_314_execution_success(self) -> None:
    ...
    def test_optimizations_profile_opt_level_none_execution_success(self) -> None:
    ...
    def test_optimizations_profile_opt_level_aggressive_without_experimental_execution_success(
        self,
    ) -> None:
    ...
    def test_optimizations_profile_opt_level_aggressive_with_experimental_execution_success(
        self,
    ) -> None:
...
class TestApplyOptimizations:
    ...
    def test_optimizations_apply_default_optimizations_execution_success(self) -> None:
        """Test applying default optimizations."""
        result = apply_optimizations()
        assert isinstance(result, OptimizationResult)
        assert result.success

    def test_optimizations_apply_with_custom_profile_execution_success(self) -> None:
    ...
    def test_optimizations_apply_without_gc_execution_success(self) -> None:
    ...
    def test_optimizations_apply_with_freeze_execution_success(self) -> None:
        """Test applying with gc.freeze."""
        # Only works on Python 3.12+
        result = apply_optimizations(freeze_after=True)
        assert result.success

    def test_optimizations_apply_experimental_enabled_execution_success(self) -> None:
    ...
    def test_optimizations_apply_experimental_disabled_execution_success(self) -> None:
    ...
    def test_optimizations_apply_perf_hints_enabled_execution_success(self) -> None:
    ...
    def test_optimizations_apply_perf_hints_disabled_execution_success(self) -> None:
...
class TestUtilityFunctions:
    ...
    def test_optimizations_get_recommended_thread_pool_size_execution_success(
        self,
    ) -> None:
    ...
    def test_optimizations_thread_pool_size_respects_multiplier_execution_success(
        self,
    ) -> None:
    ...
    def test_optimizations_thread_pool_size_respects_max_execution_success(
        self,
    ) -> None:
    ...
    def test_optimizations_thread_pool_size_with_none_cpu_count_execution_success(
        self,
    ) -> None:
    ...
    def test_optimizations_optimization_profile_cached_execution_success(self) -> None:
