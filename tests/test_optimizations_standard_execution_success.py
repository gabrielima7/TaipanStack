...
class TestUtilityFunctions:
    ...
    def test_optimizations_get_recommended_thread_pool_size(
        self,
    ) -> None:
    ...
    def test_optimizations_thread_pool_size_respects_multiplier(
        self,
    ) -> None:
    ...
    def test_optimizations_thread_pool_size_respects_max(
        self,
    ) -> None:
    ...
    def test_optimizations_thread_pool_size_with_none_cpu_count(
        self,
    ) -> None:
