...
def test_chaos_rate_limit_lock_acquire_exception_expected():
...
@pytest.mark.asyncio
async def test_chaos_rate_limit_decorator_lock_acquire_exception_async_expected():
    @rate_limit(10, 1.0)
    async def my_func():
        return "success"
...
def test_chaos_rate_limit_decorator_lock_acquire_exception_sync_expected():
    @rate_limit(10, 1.0)
    def my_func():
        return "success"
