...
class TestUtilityFunctions:
    ...
    def test_optimizations_get_recommended_thread_pool_size_expected(
        self,
    ) -> None:
    ...
    def test_optimizations_thread_pool_size_respects_multiplier_expected(
        self,
    ) -> None:
    ...
    def test_optimizations_thread_pool_size_respects_max_expected(
        self,
    ) -> None:
    ...
    def test_optimizations_thread_pool_size_with_none_cpu_count_expected(
        self,
    ) -> None:
