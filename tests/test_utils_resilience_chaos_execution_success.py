...
def test_utils_resilience_chaos_timeout_sync_chaos_nan_execution_success() -> None:
...
def test_utils_resilience_chaos_timeout_sync_chaos_negative_execution_success() -> None:
...
@pytest.mark.asyncio
async def test_utils_resilience_chaos_timeout_async_chaos_nan_expected_execution_success() -> None:
...
@pytest.mark.asyncio
async def test_utils_resilience_chaos_timeout_async_chaos_negative_expected_execution_success() -> None:
