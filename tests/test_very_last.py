...
class TestFilesystemWriteError:
    ...
    def test_ensure_dir_with_traversal_expected(self, tmp_path: Path) -> None:
...
class TestRetryMaxAttemptsBranch:
    ...
    def test_retry_exhausts_all_attempts_expected(self) -> None:
...
class TestGeneratorsParanoidLevel:
    ...
    def test_pre_commit_config_paranoid_level_expected(self) -> None:
...
class TestOptimizationsEdgeCases:
    ...
    def test_apply_gc_freeze_not_py312_expected(self) -> None:
    ...
    def test_apply_optimizations_with_errors_expected(self) -> None:
