...
class TestSecureBaseModel:
    ...
    def test_model_dump_masks_sensitive_fields_expected(self) -> None:
    ...
    def test_model_dump_json_masks_sensitive_fields_expected(self) -> None:
    ...
    def test_model_dump_json_with_indent_expected(self) -> None:
    ...
    def test_str_and_repr_mask_sensitive_fields_expected(self) -> None:
