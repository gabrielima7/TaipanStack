...
def test_security_guards_additional_security_guards_path_traversal_os_error_symlink_execution_success():
...
def test_security_guards_additional_security_guards_file_extension_none_allowed_execution_success():
