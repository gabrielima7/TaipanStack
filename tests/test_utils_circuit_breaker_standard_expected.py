...
class TestCircuitBreakerState:
    ...
    def test_utils_circuit_breaker_states_exist_standard_expected(self) -> None:
        """Test that all states are defined."""
        assert CircuitState.CLOSED.value == "closed"
        assert CircuitState.OPEN.value == "open"
        assert CircuitState.HALF_OPEN.value == "half_open"

    def test_utils_circuit_breaker_circuit_breaker_no_structlog_standard_expected(self) -> None:
    ...
    def test_utils_circuit_breaker_circuit_breaker_unreachable_state_standard_expected(
        self,
    ) -> None:
...
class TestCircuitBreaker:
    ...
    def test_utils_circuit_breaker_starts_closed_standard_expected(self) -> None:
        """Test that circuit starts in closed state."""
        breaker = CircuitBreaker()
        assert breaker.state == CircuitState.CLOSED

    def test_utils_circuit_breaker_success_keeps_closed_standard_expected(self) -> None:
    ...
    def test_utils_circuit_breaker_failures_open_circuit_standard_expected(self) -> None:
    ...
    def test_utils_circuit_breaker_open_circuit_blocks_calls_standard_expected(self) -> None:
    ...
    def test_utils_circuit_breaker_timeout_moves_to_half_open_standard_expected(self) -> None:
    ...
    def test_utils_circuit_breaker_half_open_thundering_herd_chaos_standard_expected(
        self,
    ) -> None:
    ...
    def test_utils_circuit_breaker_success_in_half_open_closes_standard_expected(self) -> None:
    ...
    def test_utils_circuit_breaker_reset_closes_circuit_standard_expected(self) -> None:
    ...
    def test_utils_circuit_breaker_excluded_exceptions_dont_trip_standard_expected(self) -> None:
...
class TestCircuitBreakerDecorator:
    ...
    def test_utils_circuit_breaker_decorator_creates_breaker_standard_expected(self) -> None:
    ...
    def test_utils_circuit_breaker_decorator_with_name_standard_expected(self) -> None:
    ...
    async def test_utils_circuit_breaker_decorator_async_success(self) -> None:
    ...
    async def test_utils_circuit_breaker_decorator_async_failure_opens_circuit(
        self,
    ) -> None:
...
class TestCircuitBreakerError:
    ...
    def test_utils_circuit_breaker_has_state_standard_expected(self) -> None:
        """Test that error has state attribute."""
        error = CircuitBreakerError("test", CircuitState.OPEN)
        assert error.state == CircuitState.OPEN

    def test_utils_circuit_breaker_message_standard_expected(self) -> None:
        """Test error message."""
