...
class TestSafeRequest:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_ssrf_ok_path_calls_request_expected(
        self,
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_circuit_breaker_open_returns_err_expected(
        self,
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_retry_on_connection_error_expected(
        self,
    ) -> None:
...
class TestSafeHttpClient:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_get_post_put_delete_patch_expected(
        self,
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_client_ssrf_ok_path_calls_request_expected(
        self,
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_client_retry_on_exception_expected(
        self,
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_client_breaker_integration_expected(
        self,
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_aexit_without_client_is_noop_expected(
        self,
    ) -> None:
