...
class TestSafeRequest:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_timeout_default_passed_to_httpxasyncclient(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_timeout_custom_passed_to_httpxasyncclient(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_no_httpx_returns_err_not_installed(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_ssrf_blocks_private_ip_private_ips(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_ssrf_disabled_is_disabled(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_ssrf_ok_path_calls_request_returns_ok(
        self,
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_circuit_breaker_open_returns_err_is_open(
        self,
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_retry_on_server_error_status_codes(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_retry_on_connection_error_connection_errors(
        self,
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_all_retries_fail_are_exhausted(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_zero_attempts_returns_runtime_error_error_wrapper(
        self,
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_circuit_breaker_records_failure_on_request_exception_the_request(
        self,
    ) -> None:
...
class TestSafeHttpClient:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_client_timeout_default_of_100(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_no_httpx_raises_without_httpx(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_lifecycle_ok_closes_properly(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_request_without_context_returns_err_returns_err(
        self,
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_get_post_put_delete_patch_to_request(
        self,
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_ssrf_blocks_in_client_the_client(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_client_ssrf_ok_path_calls_request_returns_ok(
        self,
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_client_retry_on_status_status_codes(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_client_retry_on_exception_connection_exceptions(
        self,
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_client_breaker_integration_breaker_state(
        self,
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_client_all_retries_fail_retries_exhausted(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_client_zero_attempts_returns_runtime_error_are_disabled(
        self,
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_aexit_without_client_is_noop_a_noop(
        self,
    ) -> None:
...
def test_bridge_http_http_bridge_import_error_coverage_fallback_branches() -> None:
