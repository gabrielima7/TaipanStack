...
class TestCircuitBreakerState:
    ...
    def test_utils_circuit_breaker_states_exist_execution_success(self) -> None:
        """Test that all states are defined."""
        assert CircuitState.CLOSED.value == "closed"
        assert CircuitState.OPEN.value == "open"
        assert CircuitState.HALF_OPEN.value == "half_open"

    def test_utils_circuit_breaker_circuit_breaker_no_structlog_execution_success(
        self,
    ) -> None:
    ...
    def test_utils_circuit_breaker_circuit_breaker_unreachable_state_execution_success(
        self,
    ) -> None:
...
class TestCircuitBreaker:
    ...
    def test_utils_circuit_breaker_starts_closed_execution_success(self) -> None:
        """Test that circuit starts in closed state."""
        breaker = CircuitBreaker()
        assert breaker.state == CircuitState.CLOSED

    def test_utils_circuit_breaker_success_keeps_closed_execution_success(self) -> None:
    ...
    def test_utils_circuit_breaker_failures_open_circuit_execution_success(
        self,
    ) -> None:
    ...
    def test_utils_circuit_breaker_open_circuit_blocks_calls_execution_success(
        self,
    ) -> None:
    ...
    def test_utils_circuit_breaker_timeout_moves_to_half_open_execution_success(
        self,
    ) -> None:
    ...
    def test_utils_circuit_breaker_half_open_thundering_herd_chaos_execution_success(
        self,
    ) -> None:
    ...
    def test_utils_circuit_breaker_success_in_half_open_closes_execution_success(
        self,
    ) -> None:
    ...
    def test_utils_circuit_breaker_reset_closes_circuit_execution_success(self) -> None:
    ...
    def test_utils_circuit_breaker_excluded_exceptions_dont_trip_execution_success(
        self,
    ) -> None:
...
class TestCircuitBreakerDecorator:
    ...
    def test_utils_circuit_breaker_decorator_creates_breaker_execution_success(
        self,
    ) -> None:
    ...
    def test_utils_circuit_breaker_decorator_with_name_execution_success(self) -> None:
    ...
    async def test_utils_circuit_breaker_decorator_async_success_execution_success(
        self,
    ) -> None:
    ...
    async def test_utils_circuit_breaker_decorator_async_failure_opens_circuit_execution_success(
        self,
    ) -> None:
...
class TestCircuitBreakerError:
    ...
    def test_utils_circuit_breaker_has_state_execution_success(self) -> None:
        """Test that error has state attribute."""
        error = CircuitBreakerError("test", CircuitState.OPEN)
        assert error.state == CircuitState.OPEN

    def test_utils_circuit_breaker_message_execution_success(self) -> None:
        """Test error message."""
