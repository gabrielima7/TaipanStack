...
def test_chaos_adaptive_breaker_min_throughput_mutation_expected():
...
def test_chaos_adaptive_breaker_min_throughput_nan_mutation_expected():
    breaker = AdaptiveCircuitBreaker(min_throughput=5)
...
def test_chaos_adaptive_breaker_min_throughput_type_error_mutation_expected():
    breaker = AdaptiveCircuitBreaker(min_throughput=5)
