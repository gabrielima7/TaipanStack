...
def test_security_guards_additional_security_guards_path_traversal_os_error_symlink_standard_expected():
...
def test_security_guards_additional_security_guards_file_extension_none_allowed_standard_expected():
