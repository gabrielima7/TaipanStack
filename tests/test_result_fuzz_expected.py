...
@given(st.text())
def test_result_fuzz_result_ok_fuzz_expected(value: str) -> None:
    res = Ok(value)
...
@given(st.text())
def test_result_fuzz_result_err_fuzz_expected(value: str) -> None:
...
def test_result_fuzz_result_collect_results_all_ok_fuzz_expected(
    values: list[str],
) -> None:
...
def test_result_fuzz_result_collect_results_with_err_fuzz_expected(
