...
class TestSafeRead:
    ...
    def test_utils_filesystem_read_no_max_size_standard_expected(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_read_existing_file_standard_expected(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_read_with_base_dir_standard_expected(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_read_nonexistent_file_standard_expected(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_read_directory_fails_standard_expected(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_read_file_too_large_standard_expected(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_read_with_custom_encoding_standard_expected(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_path_traversal_blocked_standard_expected(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_path_traversal_without_base_dir_blocked_standard_expected(
        self,
    ) -> None:
...
class TestSafeWrite:
    ...
    def test_utils_filesystem_write_new_file_standard_expected(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_write_existing_file_with_base_dir_standard_expected(
        self, tmp_path: Path
    ) -> None:
    ...
    def test_utils_filesystem_write_no_create_parents_standard_expected(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_write_empty_content_standard_expected(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_write_creates_parent_dirs_standard_expected(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_write_creates_backup_standard_expected(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_write_no_backup_standard_expected(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_atomic_write_standard_expected(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_non_atomic_write_standard_expected(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_safe_write_cleanup_propagates_oserror_standard_expected(
        self, tmp_path: Path
    ) -> None:
    ...
    def test_utils_filesystem_safe_write_cleanup_succeeds_standard_expected(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_write_invalid_filename_blocked_standard_expected(
        self, tmp_path: Path
    ) -> None:
...
class TestEnsureDir:
    ...
    def test_utils_filesystem_create_new_directory_standard_expected(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_existing_directory_ok_standard_expected(self, tmp_path: Path) -> None:
        """Test that existing directory is OK."""
        result = ensure_dir(tmp_path)
        assert result.exists()

    def test_utils_filesystem_create_nested_directories_standard_expected(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_file_exists_error_when_path_is_file_standard_expected(
        self, tmp_path: Path
    ) -> None:
    ...
    def test_utils_filesystem_root_directory_already_exists_standard_expected(self) -> None:
    ...
    def test_utils_filesystem_missing_intermediate_directory_created_standard_expected(
        self, tmp_path: Path
    ) -> None:
    ...
    def test_utils_filesystem_root_parent_loop_break_standard_expected(
