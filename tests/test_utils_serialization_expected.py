...
class TestDefaultEncoder:
    ...
    def test_utils_serialization_encode_ok_with_dict_a_dict(self) -> None:
    ...
    def test_utils_serialization_encode_ok_with_scalar_or_list(self) -> None:
    ...
    def test_utils_serialization_encode_err_encoding_err(self) -> None:
        """Test encoding Err."""
    ...
    def test_utils_serialization_encode_unsupported_type_unsupported_type(
        self,
    ) -> None:
    ...
    def test_utils_serialization_default_encoder_direct_type_error_unsupported_types(
        self,
    ) -> None:
    ...
    def test_utils_serialization_encode_ok_with_status_override_status_key(
        self,
    ) -> None:
