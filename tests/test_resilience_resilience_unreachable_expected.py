...
def test_resilience_resilience_unreachable_resilience_fallback_unreachable_sync_fallback_wrapper():
...
@pytest.mark.asyncio
async def test_resilience_resilience_unreachable_resilience_fallback_unreachable_async_fallback_wrapper():
