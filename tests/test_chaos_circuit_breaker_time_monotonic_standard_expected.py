...
def test_circuit_breaker_time_monotonic_exception_update_metrics_standard_expected():
    # Setup
...
def test_circuit_breaker_time_monotonic_exception_handle_open_standard_expected():
    # Setup
