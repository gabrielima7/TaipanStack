...
class TestConfigWatcher:
    ...
    def test_watchdog_config_validate_and_apply_invalid_without_error_callback_expected(
        self, tmp_path: Path
    ) -> None:
...
@pytest.mark.asyncio
async def test_config_watcher_change_detection_error_coverage_expected() -> None:
