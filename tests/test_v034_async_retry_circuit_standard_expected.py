...
class TestRetryAsyncSupport:
    ...
    async def test_v034_async_retry_circuit_async_raises_retry_error_after_max_attempts_standard_expected(
        self,
    ) -> None:
    ...
    async def test_v034_async_retry_circuit_async_does_not_catch_unspecified_exception_standard_expected(
        self,
    ) -> None:
    ...
    async def test_v034_async_retry_circuit_async_uses_asyncio_sleep_not_time_sleep_standard_expected(
        self,
    ) -> None:
    ...
    async def test_v034_async_retry_circuit_async_on_retry_callback_is_called_standard_expected(
        self,
    ) -> None:
    ...
    async def test_v034_async_retry_circuit_async_structlog_warning_called_without_callback_standard_expected(
        self,
    ) -> None:
    ...
    async def test_v034_async_retry_circuit_async_log_retries_false_skips_logging_standard_expected(
        self,
    ) -> None:
    ...
    async def test_v034_async_retry_circuit_async_reraise_false_still_raises_retry_error_standard_expected(
        self,
    ) -> None:
...
class TestCircuitBreakerAsyncSupport:
    ...
    async def test_v034_async_retry_circuit_async_open_circuit_raises_circuit_breaker_error_standard_expected(
        self,
    ) -> None:
    ...
    async def test_v034_async_retry_circuit_async_half_open_success_closes_circuit_standard_expected(
        self,
    ) -> None:
    ...
    async def test_v034_async_retry_circuit_async_half_open_failure_reopens_circuit_standard_expected(
        self,
    ) -> None:
    ...
    async def test_v034_async_retry_circuit_circuit_breaker_decorator_async_standard_expected(
        self,
    ) -> None:
    ...
    async def test_v034_async_retry_circuit_async_excluded_exceptions_dont_trip_standard_expected(
        self,
    ) -> None:
    ...
    async def test_v034_async_retry_circuit_async_on_state_change_callback_called_standard_expected(
        self,
    ) -> None:
    ...
    async def test_v034_async_retry_circuit_async_structlog_called_on_state_change_no_callback_standard_expected(
        self,
    ) -> None:
