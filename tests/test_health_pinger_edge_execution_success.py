...
def test_health_pinger_force_open_cap_execution_success():
    b = CircuitBreaker()
...
def test_health_pinger_force_open_normal_execution_success():
...
def test_health_pinger_force_open_triggers_callback_execution_success():
    called = []
