...
class TestGuardPathTraversal:
    ...
    def test_security_guards_url_encoded_traversal_blocked_standard_expected(
        self, tmp_path: Path
    ) -> None:
    ...
    def test_security_guards_symlinks_allowed_when_enabled_standard_expected(
        self, tmp_path: Path
    ) -> None:
...
class TestGuardCommandInjection:
    ...
    def test_security_guards_safe_command_passes(self) -> None:
        """Test that safe commands pass validation."""
        cmd = ["python", "-m", "pytest", "-v"]
        result = guard_command_injection(cmd)
        assert result == cmd

    def test_security_guards_empty_command_blocked_standard_expected(self) -> None:
        """Test that empty commands are blocked."""
        with pytest.raises(SecurityError) as exc_info:
            guard_command_injection([])
        assert "Empty command" in str(exc_info.value)

    def test_security_guards_semicolon_blocked_standard_expected(self) -> None:
        """Test that semicolons are blocked."""
        with pytest.raises(SecurityError):
            guard_command_injection(["echo", "hello; rm -rf /"])

    def test_security_guards_pipe_blocked_standard_expected(self) -> None:
        """Test that pipe characters are blocked."""
        with pytest.raises(SecurityError):
            guard_command_injection(["cat", "file | rm -rf /"])

    def test_security_guards_backtick_blocked_standard_expected(self) -> None:
        """Test that backticks are blocked."""
        with pytest.raises(SecurityError):
            guard_command_injection(["echo", "`whoami`"])

    def test_security_guards_dollar_expansion_blocked_standard_expected(self) -> None:
        """Test that dollar expansion is blocked."""
        with pytest.raises(SecurityError):
            guard_command_injection(["echo", "$(whoami)"])

    def test_security_guards_allowed_commands_whitelist_standard_expected(self) -> None:
    ...
    def test_security_guards_empty_allowed_commands_whitelist_blocks_all_standard_expected(
        self,
    ) -> None:
...
class TestGuardFileExtension:
    ...
    def test_security_guards_safe_extension_passes(self) -> None:
    ...
    def test_security_guards_custom_denied_extensions_standard_expected(self) -> None:
        """Test custom denied extensions."""
        with pytest.raises(SecurityError):
            guard_file_extension("config.yaml", denied_extensions=["yaml", "yml"])

    def test_security_guards_extension_with_dot_standard_expected(self) -> None:
        """Test that extensions with dots are handled."""
        result = guard_file_extension("file.txt", allowed_extensions=[".txt"])
        assert result == Path("file.txt")

    def test_security_guards_normalize_ext_in_denied_standard_expected(self) -> None:
    ...
    def test_security_guards_normalize_ext_in_allowed_standard_expected(self) -> None:
    ...
    def test_security_guards_extension_not_in_allowed_list_blocked_standard_expected(
        self,
    ) -> None:
...
class TestGuardEnvVariable:
    ...
    def test_security_guards_safe_env_variable_standard_expected(
    ...
    def test_security_guards_blocked_default_sensitive_standard_expected(self) -> None:
    ...
    def test_security_guards_blocked_password_pattern_standard_expected(self) -> None:
    ...
    def test_security_guards_sensitive_env_set_denied_without_allowed_names_standard_expected(
        self, monkeypatch: pytest.MonkeyPatch
    ) -> None:
    ...
    def test_security_guards_blocked_token_pattern_standard_expected(self) -> None:
    ...
    def test_security_guards_missing_env_variable_standard_expected(
        self, monkeypatch: pytest.MonkeyPatch
    ) -> None:
    ...
    def test_security_guards_custom_denied_names_standard_expected(
        self, monkeypatch: pytest.MonkeyPatch
    ) -> None:
    ...
    def test_security_guards_allowed_names_not_matching_sensitive_name_standard_expected(
        self, monkeypatch: pytest.MonkeyPatch
    ) -> None:
    ...
    def test_security_guards_allowed_names_override_standard_expected(
        self, monkeypatch: pytest.MonkeyPatch
    ) -> None:
...
def test_security_guards_guard_ssrf_ok_and_other_branches_standard_expected() -> None:
...
def test_security_guards_guard_ssrf_internal_err_branches_standard_expected() -> None:
...
def test_security_guards_env_variable_name_must_be_string_standard_expected() -> None:
...
def test_security_guards_path_traversal_invalid_base_dir_type_standard_expected():
...
def test_security_guards_path_traversal_invalid_path_type_standard_expected():
    from taipanstack.security.guards import guard_path_traversal
...
def test_security_guards_path_traversal_null_bytes_in_path_standard_expected():
...
def test_security_guards_path_traversal_null_bytes_in_base_dir_standard_expected():
    from taipanstack.security.guards import SecurityError, guard_path_traversal
...
def test_security_guards_path_traversal_resolve_error_standard_expected(
...
def test_security_guards_path_traversal_symlink_error_standard_expected(
    monkeypatch: pytest.MonkeyPatch, tmp_path: Path
):
    from taipanstack.security.guards import SecurityError, guard_path_traversal
...
def test_security_guards_command_injection_invalid_command_elements_standard_expected():
...
def test_security_guards_file_extension_max_length_exceeded_standard_expected():
...
def test_security_guards_file_extension_null_bytes_standard_expected():
    from taipanstack.security.guards import SecurityError, guard_file_extension
...
def test_security_guards_ssrf_not_string_type_standard_expected():
    from taipanstack.core.result import Err
...
def test_security_guards_ssrf_empty_url_standard_expected():
    from taipanstack.core.result import Err
    from taipanstack.security.guards import SecurityError, guard_ssrf
...
def test_security_guards_ssrf_max_length_exceeded_standard_expected():
    from taipanstack.core.result import Err
    from taipanstack.security.guards import SecurityError, guard_ssrf
...
def test_security_guards_ssrf_missing_hostname_standard_expected():
    from taipanstack.core.result import Err
    from taipanstack.security.guards import SecurityError, guard_ssrf
...
def test_security_guards_ssrf_unresolvable_hostname_standard_expected(monkeypatch):
    import socket
...
def test_security_guards_file_extension_normalization_standard_expected():
...
def test_security_guards_ssrf_malformed_url_standard_expected():
    from taipanstack.core.result import Err
    from taipanstack.security.guards import SecurityError, guard_ssrf
...
def test_security_guards_ssrf_ip_multicast_standard_expected():
    from taipanstack.core.result import Err
    from taipanstack.security.guards import SecurityError, guard_ssrf
...
def test_security_guards_ssrf_ip_unspecified_standard_expected():
    from taipanstack.core.result import Err
    from taipanstack.security.guards import SecurityError, guard_ssrf
...
def test_security_guards_env_variable_empty_standard_expected():
    import pytest
...
def test_security_guards_env_variable_whitespace_standard_expected():
    import pytest
...
def test_security_guards_env_variable_null_bytes_standard_expected():
    import pytest
...
def test_security_guards_ssrf_ip_resolve_error_standard_expected(monkeypatch):
    import socket
...
def test_security_guards_file_extension_no_allowed_standard_expected():
    from taipanstack.security.guards import guard_file_extension
...
def test_security_guards_env_variable_allowed_names_standard_expected():
    import pytest
...
def test_security_guards_file_extension_denied_default_standard_expected():
    import pytest
...
def test_security_guards_env_variable_allowed_names_empty_list_standard_expected():
    import pytest
...
def test_security_guards_ssrf_ip_is_safe_attribute_error_standard_expected(monkeypatch):
    import ipaddress
...
def test_security_guards_file_extension_cleaning_empty_clean_name_standard_expected():
    from taipanstack.security.guards import SecurityError, guard_file_extension
...
def test_security_guards_ssrf_ip_is_safe_value_error_standard_expected():
    from taipanstack.security.guards import _is_ip_safe
