...
def test_taipanstack_script_standard_taipanstack_script_git_initialization(tmp_path):
    """
...
def test_taipanstack_script_standard_taipanstack_script_setup_pre_commit():
    """
...
def test_taipanstack_script_standard_taipanstack_script_setup_pre_commit_dry_run():
    """
