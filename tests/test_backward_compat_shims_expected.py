...
class TestBackwardCompatShims:
    ...
    def test_backward_compat_shims_circuit_breaker_shim_exports_all_symbols(
        self,
    ) -> None:
    ...
    def test_backward_compat_shims_circuit_breaker_shim_matches_canonical_resilience_module(
        self,
    ) -> None:
    ...
    def test_backward_compat_shims_retry_shim_exports_retry_symbols(self) -> None:
    ...
    def test_backward_compat_shims_retry_shim_matches_canonical_canonical_module(
        self,
    ) -> None:
    ...
    def test_backward_compat_shims_resilience_shim_exports_decorator_symbols(
        self,
    ) -> None:
    ...
    def test_backward_compat_shims_resilience_shim_matches_canonical_canonical_module(
        self,
    ) -> None:
