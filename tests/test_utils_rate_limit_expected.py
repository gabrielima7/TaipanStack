...
class TestRateLimiter:
    ...
    def test_utils_rate_limit_chaos_consume_adds_tokens_corrupted_new_tokens_expected(
        self,
    ) -> None:
        limiter = RateLimiter(10, 1.0)
        limiter.tokens = 0
    ...
    def test_utils_rate_limit_chaos_consume_adds_tokens_corrupted_tokens_sum_expected(
        self,
    ) -> None:
        limiter = RateLimiter(10, 1.0)
    ...
    def test_utils_rate_limit_chaos_consume_zero_or_negative_tokens_expected(
        self,
    ) -> None:
        limiter = RateLimiter(10, 1.0)
    ...
    def test_utils_rate_limit_invalid_initialization_to_ratelimiter(self) -> None:
    ...
    def test_utils_rate_limit_consume_success_tokens_successfully(self) -> None:
    ...
    def test_utils_rate_limit_consume_refill_refill_logic(
...
class TestRateLimitDecorator:
    ...
    def test_utils_rate_limit_sync_rate_limit_sync_function(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_utils_rate_limit_async_rate_limit_async_function(self) -> None:
    ...
    def test_utils_rate_limit_unreachable_tokens_expected(self) -> None:
        limiter = RateLimiter(10, 1.0)
    ...
    def test_utils_rate_limit_unreachable_new_tokens_expected(self) -> None:
        limiter = RateLimiter(10, 1.0)
    ...
    def test_utils_rate_limit_tokens_corrupted_nan_expected(self) -> None:
        limiter = RateLimiter(10, 1.0)
        limiter.tokens = float("nan")
        assert limiter._try_consume(1.0) is False
        assert limiter.tokens == limiter.capacity
    ...
    @pytest.mark.asyncio
    async def test_utils_rate_limit_decorator_async_exception_expected(self) -> None:
        from unittest.mock import patch
    ...
    def test_utils_rate_limit_validate_and_add_tokens_none_expected(self) -> None:
        limiter = RateLimiter(10, 1.0)
    ...
    def test_utils_rate_limit_process_consumption_returns_false_if_validate_and_add_tokens_returns_false_expected(
        self,
    ) -> None:
        from unittest.mock import patch
