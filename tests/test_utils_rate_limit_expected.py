...
class TestRateLimiter:
    def test_utils_rate_limit_chaos_inf_time_window_return_expected(self) -> None:
        with pytest.raises(ValueError):
            RateLimiter(10, float("inf"))

    def test_utils_rate_limit_chaos_negative_time_window_return_expected(self) -> None:
        with pytest.raises(ValueError):
            RateLimiter(10, -1.0)
