...
class TestSecurityHeadersConfig:
    ...
    def test_bridge_web_default_headers_security_headers(self) -> None:
    ...
    def test_bridge_web_custom_values_in_output(self) -> None:
...
class TestTaipanMiddleware:
    ...
    @pytest.mark.asyncio
    async def test_bridge_web_passthrough_http_the_app(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_web_passthrough_non_http_through_unchanged(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_web_rate_limit_returns_429_is_exceeded(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_web_security_headers_injected_to_responses(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_web_security_headers_on_429_429_responses(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_web_unhandled_exception_returns_500_json_response(
        self,
    ) -> None:
...
class TestSendJsonResponse:
    ...
    @pytest.mark.asyncio
    async def test_bridge_web_sends_json_json_response(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_web_extra_headers_are_included(self) -> None:
...
def test_bridge_web_send_json_response_err_expected() -> None:
    import asyncio
...
@pytest.mark.asyncio
async def test_bridge_web_headers_tuple_edge_case_expected() -> None:
    from typing import Any
    from unittest.mock import AsyncMock
