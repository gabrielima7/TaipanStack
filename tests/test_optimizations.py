...
class TestGetOptimizationProfile:
    ...
    def test_profile_for_311_expected(self) -> None:
    ...
    def test_profile_for_312_expected(self) -> None:
    ...
    def test_profile_for_313_expected(self) -> None:
    ...
    def test_profile_for_314_expected(self) -> None:
    ...
    def test_profile_opt_level_none_expected(self) -> None:
        """Test profile with OPT_LEVEL_NONE uses minimal settings."""
        with patch.dict(os.environ, {"STACK_OPTIMIZATION_LEVEL": "0"}):
            profile = get_optimization_profile(force_refresh=True)
            assert profile.gc_threshold_0 == 700

    def test_profile_opt_level_aggressive_without_experimental_expected(self) -> None:
...
class TestApplyOptimizations:
    ...
    def test_apply_default_optimizations_expected(self) -> None:
    ...
    def test_apply_without_gc_expected(self) -> None:
    ...
    def test_apply_with_freeze_expected(self) -> None:
        """Test applying with gc.freeze."""
        result = apply_optimizations(freeze_after=True)
        assert result.success

    def test_apply_experimental_enabled_expected(self) -> None:
    ...
    def test_apply_experimental_disabled_expected(self) -> None:
    ...
    def test_apply_perf_hints_enabled_expected(self) -> None:
    ...
    def test_apply_perf_hints_disabled_expected(self) -> None:
...
class TestUtilityFunctions:
    ...
    def test_get_recommended_thread_pool_size_expected(self) -> None:
    ...
    def test_thread_pool_size_respects_multiplier_expected(self) -> None:
    ...
    def test_thread_pool_size_respects_max_expected(self) -> None:
    ...
    def test_thread_pool_size_with_none_cpu_count_expected(self) -> None:
