...
class TestLoggingWithMockedStructlog:
    ...
    def test_structlog_branches_stack_logger_with_structured_true_expected(
        self,
    ) -> None:
    ...
    def test_structlog_branches_stack_logger_bind_with_structured_expected(
        self,
    ) -> None:
    ...
    def test_structlog_branches_stack_logger_unbind_with_structured_expected(
        self,
    ) -> None:
...
class TestSetupLoggingStructlog:
    ...
    def test_structlog_branches_setup_logging_with_structlog_expected(
        self,
    ) -> None:
...
class TestSubprocessTimeoutBranches:
    ...
    def test_structlog_branches_run_safe_command_with_failure_expected(
        self,
    ) -> None:
...
class TestGuardsRemainingBranches:
    ...
    def test_structlog_branches_guard_path_traversal_symlink_expected(
        self, tmp_path: Path
    ) -> None:
...
class TestFilesystemRemainingBranches:
    ...
    def test_structlog_branches_safe_write_atomic_with_existing_expected(
        self, tmp_path: Path
    ) -> None:
...
class TestValidatorsRemainingBranches:
    ...
    def test_structlog_branches_validate_project_name_starts_with_digit_expected(
        self,
    ) -> None:
    ...
    def test_structlog_branches_validate_project_name_max_length_expected(
        self,
    ) -> None:
