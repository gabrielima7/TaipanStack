...
class TestMaskSensitiveDataProcessor:
    ...
    def test_password_key_is_redacted_expected(self) -> None:
    ...
    def test_secret_key_is_redacted_expected(self) -> None:
    ...
    def test_token_key_is_redacted_expected(self) -> None:
    ...
    def test_authorization_key_is_redacted_expected(self) -> None:
    ...
    def test_api_key_is_redacted_expected(self) -> None:
    ...
    def test_case_insensitive_matching_password_expected(self) -> None:
    ...
    def test_case_insensitive_matching_token_expected(self) -> None:
    ...
    def test_case_insensitive_matching_secret_expected(self) -> None:
    ...
    def test_partial_key_match_is_redacted_expected(self) -> None:
    ...
    def test_empty_event_dict_is_returned_unchanged_expected(self) -> None:
        """An empty event dict passes through without error."""
        event_dict: dict[str, object] = {}
        result = mask_sensitive_data_processor(None, "info", event_dict)
        assert result == {}

    def test_returns_same_dict_object_expected(self) -> None:
    ...
    def test_logger_and_method_args_ignored_expected(self) -> None:
...
class TestSensitiveKeyPatternsConstant:
    ...
    def test_contains_expected_patterns_expected(self) -> None:
    ...
    def test_patterns_are_lowercase_expected(self) -> None:
...
class TestMaskSensitiveDataProcessorStructlogIntegration:
    ...
    def test_structlog_pipeline_masks_password_expected(self) -> None:
    ...
    def test_structlog_pipeline_masks_authorization_header_expected(self) -> None:
    ...
    def test_structlog_pipeline_preserves_non_sensitive_fields_expected(self) -> None:
    ...
    def test_structlog_pipeline_masks_api_key_expected(self) -> None:
    ...
    def test_structlog_pipeline_masks_token_expected(self) -> None:
