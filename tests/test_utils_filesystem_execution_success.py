...
class TestSafeRead:
    ...
    def test_utils_filesystem_read_no_max_size_execution_success(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_read_existing_file_execution_success(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_read_with_base_dir_execution_success(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_read_nonexistent_file_execution_success(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_read_directory_fails_execution_success(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_read_file_too_large_execution_success(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_read_with_custom_encoding_execution_success(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_path_traversal_blocked_execution_success(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_path_traversal_without_base_dir_blocked_execution_success(
        self,
    ) -> None:
...
class TestSafeWrite:
    ...
    def test_utils_filesystem_write_new_file_execution_success(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_write_existing_file_with_base_dir_execution_success(
        self, tmp_path: Path
    ) -> None:
    ...
    def test_utils_filesystem_write_no_create_parents_execution_success(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_write_empty_content_execution_success(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_write_creates_parent_dirs_execution_success(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_write_creates_backup_execution_success(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_write_no_backup_execution_success(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_atomic_write_execution_success(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_non_atomic_write_execution_success(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_safe_write_cleanup_propagates_oserror_execution_success(
        self, tmp_path: Path
    ) -> None:
    ...
    def test_utils_filesystem_safe_write_cleanup_succeeds_execution_success(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_write_invalid_filename_blocked_execution_success(
        self, tmp_path: Path
    ) -> None:
...
class TestEnsureDir:
    ...
    def test_utils_filesystem_create_new_directory_execution_success(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_existing_directory_ok_execution_success(self, tmp_path: Path) -> None:
        """Test that existing directory is OK."""
        result = ensure_dir(tmp_path)
        assert result.exists()

    def test_utils_filesystem_create_nested_directories_execution_success(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_file_exists_error_when_path_is_file_execution_success(
        self, tmp_path: Path
    ) -> None:
    ...
    def test_utils_filesystem_root_directory_already_exists_execution_success(
        self,
    ) -> None:
    ...
    def test_utils_filesystem_missing_intermediate_directory_created_execution_success(
        self, tmp_path: Path
    ) -> None:
    ...
    def test_utils_filesystem_root_parent_loop_break_execution_success(
