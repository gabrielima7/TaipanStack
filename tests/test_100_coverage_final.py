...
class TestConfigGeneratorsBranches:
    ...
    def test_generate_pre_commit_without_bandit_expected(self) -> None:
        ...
        config = StackConfig(project_name="testproj", security=SecurityConfig(enable_bandit=False, enable_safety=False, enable_semgrep=False, enable_detect_secrets=False))
    ...
    def test_generate_pre_commit_with_safety_only_expected(self) -> None:
        ...
        from taipanstack.config.generators import generate_pre_commit_config
        from taipanstack.config.models import SecurityConfig, StackConfig
        config = StackConfig(project_name="testproj", security=SecurityConfig(enable_bandit=False, enable_safety=True, enable_semgrep=False, enable_detect_secrets=False))
        result = generate_pre_commit_config(config)
    ...
    def test_generate_pre_commit_with_semgrep_only_expected(self) -> None:
        ...
        from taipanstack.config.generators import generate_pre_commit_config
        from taipanstack.config.models import SecurityConfig, StackConfig
        config = StackConfig(project_name="testproj", security=SecurityConfig(enable_bandit=False, enable_safety=False, enable_semgrep=True, enable_detect_secrets=False))
        result = generate_pre_commit_config(config)
    ...
    def test_generate_pre_commit_with_detect_secrets_only_expected(self) -> None:
        ...
        from taipanstack.config.generators import generate_pre_commit_config
        from taipanstack.config.models import SecurityConfig, StackConfig
        config = StackConfig(project_name="testproj", security=SecurityConfig(enable_bandit=False, enable_safety=False, enable_semgrep=False, enable_detect_secrets=True))
        result = generate_pre_commit_config(config)
...
class TestSanitizersUncovered:
    ...
    def test_sanitize_path_with_base_dir_not_absolute_expected(self, tmp_path: Path) -> None:
