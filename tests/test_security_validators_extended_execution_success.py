...
class TestValidateProjectNameEdgeCases:
    ...
    def test_security_validators_extended_name_too_long_execution_success(self) -> None:
        """Test that names exceeding max_length are rejected."""
        long_name = "a" * 101
        with pytest.raises(ValueError, match="exceeds maximum"):
            validate_project_name(long_name, max_length=100)

    def test_security_validators_extended_name_starts_with_number_execution_success(
        self,
    ) -> None:
    ...
    def test_security_validators_extended_name_starts_with_hyphen_execution_success(
        self,
    ) -> None:
    ...
    def test_security_validators_extended_hyphen_not_allowed_execution_success(
        self,
    ) -> None:
    ...
    def test_security_validators_extended_underscore_not_allowed_execution_success(
        self,
    ) -> None:
    ...
    def test_security_validators_extended_empty_name_execution_success(self) -> None:
...
class TestValidatePythonVersionEdgeCases:
    ...
    def test_security_validators_extended_unsupported_major_version_execution_success(
        self,
    ) -> None:
    ...
    def test_security_validators_extended_unsupported_minor_version_execution_success(
        self,
    ) -> None:
    ...
    def test_security_validators_extended_version_number_conversion_error_execution_success(
        self,
    ) -> None:
    ...
    def test_security_validators_extended_non_numeric_version_mock_execution_success(
        self,
    ) -> None:
...
class TestValidateEmailEdgeCases:
    ...
    def test_security_validators_extended_local_part_too_long_execution_success(
        self,
    ) -> None:
    ...
    def test_security_validators_extended_domain_too_long_execution_success(
        self,
    ) -> None:
...
class TestValidateUrlEdgeCases:
    ...
    def test_security_validators_extended_invalid_scheme_execution_success(
        self,
    ) -> None:
    ...
    def test_security_validators_extended_missing_domain_execution_success(
        self,
    ) -> None:
    ...
    def test_security_validators_extended_localhost_allowed_execution_success(
        self,
    ) -> None:
