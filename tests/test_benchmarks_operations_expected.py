...
def test_benchmarks_bench_safe_decorator_ok_expected(benchmark: BenchmarkFixture) -> None:
    """Benchmark @safe decorator on successful call."""
    benchmark(_divide, 10, 2)


def test_benchmarks_bench_safe_decorator_err_expected(benchmark: BenchmarkFixture) -> None:
