...
def test_utils_subprocess_additional_utils_subprocess_raise_on_error_standard_expected():
    import subprocess
...
def test_utils_subprocess_additional_allowed_keys_custom_standard_expected():
    from taipanstack.utils.subprocess import _get_allowed_keys

    assert _get_allowed_keys(["TEST_VAR"]) == {"TEST_VAR"}


def test_utils_subprocess_additional_filter_environment_empty_standard_expected():
    from taipanstack.utils.subprocess import _filter_environment

    assert _filter_environment(None, []) == {}


def test_utils_subprocess_additional_run_safe_command_check_true_standard_expected():
    import subprocess
...
def test_utils_subprocess_additional_filter_environment_empty_allowed_standard_expected():
    from taipanstack.utils.subprocess import _filter_environment

    assert _filter_environment({"PATH": "/bin"}, []) == {}


def test_utils_subprocess_additional_filter_environment_none_allowed_standard_expected():
    from taipanstack.utils.subprocess import _filter_environment
...
def test_utils_subprocess_additional_execute_command_capture_false_standard_expected():
...
def test_utils_subprocess_additional_get_allowed_keys_none_standard_expected():
    from taipanstack.utils.subprocess import _get_allowed_keys

    assert _get_allowed_keys(None) == {"PATH"}


def test_utils_subprocess_additional_extract_timeout_stdout_not_str_standard_expected():
    import subprocess
