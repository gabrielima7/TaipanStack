...
class TestSafeCommandResult:
    ...
    def test_utils_subprocess_success_true_when_returncode_zero_execution_success(
        self,
    ) -> None:
    ...
    def test_utils_subprocess_success_false_when_returncode_nonzero_execution_success(
        self,
    ) -> None:
    ...
    def test_utils_subprocess_raise_on_error_success_execution_success(self) -> None:
    ...
    def test_utils_subprocess_raise_on_error_failure_execution_success(self) -> None:
    ...
    def test_utils_subprocess_duration_seconds_default_execution_success(self) -> None:
...
class TestDefaultAllowedCommands:
    ...
    def test_utils_subprocess_contains_essential_commands_execution_success(
        self,
    ) -> None:
    ...
    def test_utils_subprocess_is_frozenset_execution_success(self) -> None:
...
class TestRunSafeCommand:
    ...
    def test_utils_subprocess_run_echo_command_execution_success(self) -> None:
    ...
    def test_utils_subprocess_dry_run_mode_execution_success(self) -> None:
    ...
    def test_utils_subprocess_command_not_in_whitelist_execution_success(self) -> None:
    ...
    def test_utils_subprocess_empty_command_rejected_execution_success(self) -> None:
        """Test that empty command raises SecurityError."""
        with pytest.raises(SecurityError, match="Empty command"):
            run_safe_command([])

    def test_utils_subprocess_command_injection_blocked_execution_success(self) -> None:
    ...
    def test_utils_subprocess_command_not_found_execution_success(self) -> None:
    ...
    def test_utils_subprocess_timeout_handling_execution_success(self) -> None:
    ...
    def test_utils_subprocess_working_directory_execution_success(self, tmp_path: Path) -> None:
    ...
    def test_utils_subprocess_invalid_working_directory_execution_success(self) -> None:
    ...
    def test_utils_subprocess_custom_allowed_commands_execution_success(self) -> None:
    ...
    def test_utils_subprocess_duration_is_tracked_execution_success(self) -> None:
        """Test that command duration is tracked."""
        result = run_safe_command(["echo", "test"])
        assert result.duration_seconds >= 0

    def test_utils_subprocess_timeout_negative_value_execution_success(self) -> None:
    ...
    def test_utils_subprocess_timeout_nan_value_execution_success(self) -> None:
    ...
    def test_utils_subprocess_timeout_inf_value_execution_success(self) -> None:
...
def test_utils_subprocess_execute_command_timeout_with_bytes_stdout_execution_success() -> None:
...
def test_utils_subprocess_execute_command_timeout_without_stdout_execution_success() -> None:
...
def test_utils_subprocess_execute_command_timeout_with_str_stdout_execution_success() -> None:
