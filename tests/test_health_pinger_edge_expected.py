...
def test_health_pinger_edge_health_pinger_force_open_cap_expected():
    b = CircuitBreaker()
...
def test_health_pinger_edge_health_pinger_force_open_normal_expected():
...
def test_health_pinger_edge_health_pinger_force_open_triggers_callback_expected():
    called = []
