...
def test_fuzz_models_recursion_fuzz_mask_data_recursion_standard_expected(data):
    try:
        _mask_data(data)
...
def test_fuzz_models_recursion_deep_recursion_dict_standard_expected():
    data = {}
    current = data
    for _ in range(2000):
        current["nested"] = {}
...
def test_fuzz_models_recursion_deep_recursion_list_standard_expected():
    data = []
    current = data
    for _ in range(2000):
        new_list = []
