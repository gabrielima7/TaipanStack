...
def test_chaos_resilience_thread_exhaustion_timeout_thread_exhaustion_execution_success():
    @timeout(1.0)
    def my_func():
        return Ok("done")
...
if __name__ == "__main__":
    test_chaos_resilience_thread_exhaustion_timeout_thread_exhaustion_execution_success()
