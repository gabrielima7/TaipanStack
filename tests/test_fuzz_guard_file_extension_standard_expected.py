...
@given(st.text())
def test_fuzz_guard_file_extension_null_bytes_standard_expected(filename: str) -> None:
...
def test_fuzz_guard_file_extension_empty_after_strip_standard_expected() -> None:
...
def test_fuzz_guard_file_extension_empty_name_standard_expected() -> None:
...
def test_fuzz_guard_file_extension_massive_strings_dos_property_standard_expected(
    ext: str,
) -> None:
...
def test_fuzz_guard_file_extension_massive_strings_dos_standard_expected() -> None:
