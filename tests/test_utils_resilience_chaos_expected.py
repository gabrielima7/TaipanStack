...
def test_utils_resilience_chaos_timeout_sync_chaos_nan_safe_degradation() -> None:
...
def test_utils_resilience_chaos_timeout_sync_chaos_negative_system_crash() -> None:
...
@pytest.mark.asyncio
async def test_utils_resilience_chaos_timeout_async_chaos_nan_async_code() -> None:
...
@pytest.mark.asyncio
async def test_utils_resilience_chaos_timeout_async_chaos_negative_on_async() -> None:
