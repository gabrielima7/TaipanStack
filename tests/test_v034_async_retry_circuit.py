...
class TestRetryAsyncSupport:
    ...
    async def test_v034_async_retry_circuit_async_success_no_retry(
        self,
    ) -> None:
    ...
    async def test_v034_async_retry_circuit_async_retries_then_succeeds(
        self,
    ) -> None:
...
class TestCircuitBreakerAsyncSupport:
    ...
    async def test_v034_async_retry_circuit_async_success_keeps_closed(
        self,
    ) -> None:
