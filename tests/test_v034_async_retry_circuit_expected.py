...
class TestRetryAsyncSupport:
    ...
    async def test_v034_async_retry_circuit_async_success_no_retry_only_once(
        self,
    ) -> None:
    ...
    async def test_v034_async_retry_circuit_async_retries_then_succeeds_eventually_succeeds(
        self,
    ) -> None:
    ...
    async def test_v034_async_retry_circuit_async_raises_retry_error_after_max_attempts_are_exhausted(
        self,
    ) -> None:
    ...
    async def test_v034_async_retry_circuit_async_does_not_catch_unspecified_exception_async_functions(
        self,
    ) -> None:
    ...
    async def test_v034_async_retry_circuit_async_uses_asyncio_sleep_not_time_sleep_nonblocking_waits(
        self,
    ) -> None:
    ...
    async def test_v034_async_retry_circuit_async_on_retry_callback_is_called_async_attempt(
        self,
    ) -> None:
    ...
    async def test_v034_async_retry_circuit_async_structlog_warning_called_without_callback_async_retries(
        self,
    ) -> None:
    ...
    async def test_v034_async_retry_circuit_async_log_retries_false_skips_logging_async_functions(
        self,
    ) -> None:
    ...
    async def test_v034_async_retry_circuit_async_reraise_false_still_raises_retry_error_raises_retryerror(
        self,
    ) -> None:
...
class TestCircuitBreakerAsyncSupport:
    ...
    async def test_v034_async_retry_circuit_async_success_keeps_closed_closed_state(
        self,
    ) -> None:
    ...
    async def test_v034_async_retry_circuit_async_failures_open_circuit_the_threshold(
        self,
    ) -> None:
    ...
    async def test_v034_async_retry_circuit_async_open_circuit_raises_circuit_breaker_error_for_async(
        self,
    ) -> None:
    ...
    async def test_v034_async_retry_circuit_async_half_open_success_closes_circuit_to_closed(
        self,
    ) -> None:
    ...
    async def test_v034_async_retry_circuit_async_half_open_failure_reopens_circuit_to_open(
        self,
    ) -> None:
    ...
    async def test_v034_async_retry_circuit_circuit_breaker_decorator_async_async_functions(
        self,
    ) -> None:
    ...
    async def test_v034_async_retry_circuit_async_excluded_exceptions_dont_trip_async_functions(
        self,
    ) -> None:
    ...
    async def test_v034_async_retry_circuit_async_on_state_change_callback_called_state_transitions(
        self,
    ) -> None:
    ...
    async def test_v034_async_retry_circuit_async_structlog_called_on_state_change_no_callback_async_transitions(
        self,
    ) -> None:
