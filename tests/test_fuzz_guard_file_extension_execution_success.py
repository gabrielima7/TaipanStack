...
@given(st.text())
def test_fuzz_guard_file_extension_null_bytes_execution_success(filename: str) -> None:
...
def test_fuzz_guard_file_extension_whitespace_and_dots_execution_success(
    padding: str,
) -> None:
...
def test_fuzz_guard_file_extension_empty_after_strip_execution_success() -> None:
...
def test_fuzz_guard_file_extension_empty_name_execution_success() -> None:
...
def test_fuzz_guard_file_extension_massive_strings_dos_property_execution_success(
    ext: str,
) -> None:
...
def test_fuzz_guard_file_extension_massive_strings_dos_execution_success() -> None:
