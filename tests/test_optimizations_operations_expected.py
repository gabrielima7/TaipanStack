...
class TestOptimizationProfile:
    ...
    def test_optimizations_profile_immutable_expected(self) -> None:
...
class TestOptimizationResult:
    ...
    def test_optimizations_result_to_dict_expected(self) -> None:
...
class TestGetOptimizationProfile:
    ...
    def test_optimizations_profile_for_311_expected(self) -> None:
    ...
    def test_optimizations_profile_for_312_expected(self) -> None:
    ...
    def test_optimizations_profile_for_313_expected(self) -> None:
    ...
    def test_optimizations_profile_for_314_expected(self) -> None:
    ...
    def test_optimizations_profile_opt_level_none_expected(self) -> None:
...
class TestApplyOptimizations:
    ...
    def test_optimizations_apply_default_optimizations_expected(self) -> None:
        """Test applying default optimizations."""
        result = apply_optimizations()
        assert isinstance(result, OptimizationResult)
        assert result.success

    def test_optimizations_apply_with_custom_profile_expected(self) -> None:
    ...
    def test_optimizations_apply_without_gc_expected(self) -> None:
    ...
    def test_optimizations_apply_with_freeze_expected(self) -> None:
        """Test applying with gc.freeze."""
        # Only works on Python 3.12+
        result = apply_optimizations(freeze_after=True)
        assert result.success

    def test_optimizations_apply_experimental_enabled_expected(self) -> None:
    ...
    def test_optimizations_apply_experimental_disabled_expected(self) -> None:
    ...
    def test_optimizations_apply_perf_hints_enabled_expected(self) -> None:
    ...
    def test_optimizations_apply_perf_hints_disabled_expected(self) -> None:
...
class TestUtilityFunctions:
    ...
    def test_optimizations_get_recommended_thread_pool_size_expected(self) -> None:
    ...
    def test_optimizations_thread_pool_size_respects_multiplier_expected(self) -> None:
    ...
    def test_optimizations_thread_pool_size_respects_max_expected(self) -> None:
    ...
    def test_optimizations_thread_pool_size_with_none_cpu_count_expected(self) -> None:
    ...
    def test_optimizations_optimization_profile_cached_expected(self) -> None:
