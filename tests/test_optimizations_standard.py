...
class TestOptimizationProfile:
    ...
    def test_optimizations_standard_optimizations_profile_creation(self) -> None:
    ...
    def test_optimizations_standard_optimizations_profile_immutable(self) -> None:
...
class TestOptimizationResult:
    ...
    def test_optimizations_standard_optimizations_result_creation(self) -> None:
    ...
    def test_optimizations_standard_optimizations_result_to_dict(self) -> None:
...
class TestGetOptimizationProfile:
    ...
    def test_optimizations_standard_optimizations_profile_for_311(self) -> None:
    ...
    def test_optimizations_standard_optimizations_profile_for_312(self) -> None:
    ...
    def test_optimizations_standard_optimizations_profile_for_313(self) -> None:
    ...
    def test_optimizations_standard_optimizations_profile_for_314(self) -> None:
    ...
    def test_optimizations_standard_optimizations_profile_opt_level_none(self) -> None:
    ...
    def test_optimizations_standard_optimizations_profile_opt_level_aggressive_without_experimental(
        self,
    ) -> None:
    ...
    def test_optimizations_standard_optimizations_profile_opt_level_aggressive_with_experimental(
        self,
    ) -> None:
...
class TestApplyOptimizations:
    ...
    def test_optimizations_standard_optimizations_apply_without_gc(self) -> None:
    ...
    def test_optimizations_standard_optimizations_apply_with_freeze(self) -> None:
...
class TestUtilityFunctions:
    ...
    def test_optimizations_standard_optimizations_get_recommended_thread_pool_size(
        self,
    ) -> None:
    ...
    def test_optimizations_standard_optimizations_thread_pool_size_respects_multiplier(
        self,
    ) -> None:
    ...
    def test_optimizations_standard_optimizations_thread_pool_size_respects_max(
        self,
    ) -> None:
    ...
    def test_optimizations_standard_optimizations_thread_pool_size_with_none_cpu_count(
        self,
    ) -> None:
