...
@pytest.mark.asyncio
async def test_chaos_http_bridge_safe_client_exception_extreme_standard_expected() -> None:
...
def test_chaos_http_bridge_fuzz_http_bridge_malformed_inputs_standard_expected(
    url: str, method: str
) -> None:
