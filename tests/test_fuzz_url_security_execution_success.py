...
def test_fuzz_url_security_fuzz_url_massive_strings_dos_execution_success(
    url: str,
) -> None:
...
def test_fuzz_url_security_fuzz_url_null_bytes_execution_success(url: str) -> None:
...
def test_fuzz_url_security_fuzz_url_unprintable_chars_execution_success(
    chars: str,
) -> None:
...
def test_fuzz_url_security_url_port_integer_conversion_dos_execution_success() -> None:
...
def test_fuzz_url_security_url_tld_ipv6_handling_execution_success() -> None:
...
def test_fuzz_url_security_url_credentials_bypassing_tld_check_execution_success() -> None:
