...
class TestSanitizeString:
    ...
    def test_security_sanitizers_allows_html_when_enabled(self) -> None:
    ...
    def test_security_sanitizers_removes_unicode_when_disabled(self) -> None:
...
class TestSanitizePath:
    ...
    def test_security_sanitizers_resolve_with_base_dir_success(
        self, tmp_path: Path
    ) -> None:
    ...
    def test_security_sanitizers_resolve_with_base_dir_error(
...
class TestSanitizerFallthrough:
    ...
    def test_security_sanitizers_sanitize_path_fallthroughs_expected(self) -> None:
