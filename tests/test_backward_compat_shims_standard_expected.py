...
class TestBackwardCompatShims:
    ...
    def test_backward_compat_shims_circuit_breaker_shim_matches_canonical_standard_expected(
        self,
    ) -> None:
    ...
    def test_backward_compat_shims_retry_shim_exports_standard_expected(self) -> None:
    ...
    def test_backward_compat_shims_resilience_shim_matches_canonical_standard_expected(
        self,
    ) -> None:
