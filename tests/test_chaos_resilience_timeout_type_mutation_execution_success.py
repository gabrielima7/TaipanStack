...
def test_chaos_resilience_timeout_type_mutation_execution_success() -> None:
...
@pytest.mark.asyncio
async def test_chaos_resilience_timeout_type_mutation_async_execution_success() -> None:
    """Simulate a severe production failure where timeout 'seconds' is corrupted to a string."""
