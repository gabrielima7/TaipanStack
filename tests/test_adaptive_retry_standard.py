...
class TestAdaptiveRetry:
    ...
    def test_adaptive_retry_fallback_delay_without_data_standard_expected(self) -> None:
    ...
    def test_adaptive_retry_delay_clamped_to_bounds_standard_expected(self) -> None:
    ...
    def test_adaptive_retry_to_retry_config_standard_expected(self) -> None:
    ...
    def test_adaptive_retry_metrics_snapshot_standard_expected(self) -> None:
    ...
    def test_adaptive_retry_empty_metrics_standard_expected(self) -> None:
    ...
    def test_adaptive_retry_per_attempt_isolation_standard_expected(self) -> None:
