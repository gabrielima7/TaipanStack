...
class TestResourceWatcher:
    ...
    @pytest.mark.asyncio
    async def test_watchdog_resource_start_without_psutil_returns_err(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_watchdog_resource_start_stop_lifecycle(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_watchdog_resource_double_start_returns_err(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_watchdog_resource_threshold_breach_callback(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_watchdog_resource_no_breach_below_threshold(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_watchdog_resource_run_handles_check_error(self) -> None:
...
class TestBaseWatcher:
    ...
    @pytest.mark.asyncio
    async def test_watchdog_resource_stop_timeout_cancels_task(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_watchdog_resource_run_err_branch_logged(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_watchdog_resource_threshold_breach_without_callback(self) -> None:
...
@pytest.mark.asyncio
async def test_watchdog_resource_standard_watchdog_resource_resource_watcher_run_err_branch() -> None:
...
def test_watchdog_resource_standard_watchdog_resource_resource_watcher_import_error_coverage() -> None:
...
def test_watchdog_resource_standard_watchdog_resource_resource_watcher_import_success_coverage() -> None:
