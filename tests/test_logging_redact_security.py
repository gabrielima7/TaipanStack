...
def test_utils_logging_redact_circular_reference_redacted():
    d = {"name": "test"}
    d["self"] = d
    redacted = _redact(d)
...
def test_utils_logging_redact_list_redacted():
...
def test_utils_logging_redact_tuple_redacted():
...
def test_utils_logging_redact_no_regex_unmodified(monkeypatch):
