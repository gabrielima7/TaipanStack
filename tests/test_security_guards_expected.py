...
class TestGuardPathTraversal:
    ...
    def test_security_guards_safe_path_passes_pass_validation(self, tmp_path: Path) -> None:
    ...
    def test_security_guards_relative_path_within_base_dir_pass(self, tmp_path: Path) -> None:
    ...
    def test_security_guards_path_traversal_blocked_are_blocked(self, tmp_path: Path) -> None:
    ...
    def test_security_guards_double_dot_blocked_are_blocked(self, tmp_path: Path) -> None:
        """Test that .. patterns are blocked."""
        with pytest.raises(SecurityError):
            guard_path_traversal("foo/../../../etc/passwd", tmp_path)

    def test_security_guards_url_encoded_traversal_blocked_is_blocked(
        self, tmp_path: Path
    ) -> None:
    ...
    def test_security_guards_path_escapes_base_dir_are_blocked(self, tmp_path: Path) -> None:
    ...
    def test_security_guards_symlinks_blocked_by_default_by_default(self, tmp_path: Path) -> None:
    ...
    def test_security_guards_symlinks_allowed_when_enabled_when_allowsymlinkstrue(
        self, tmp_path: Path
    ) -> None:
    ...
    def test_security_guards_path_escapes_base_dir_msg_path_escape(self, tmp_path: Path) -> None:
...
class TestGuardCommandInjection:
    ...
    def test_security_guards_safe_command_passes_pass_validation(self) -> None:
        """Test that safe commands pass validation."""
        cmd = ["python", "-m", "pytest", "-v"]
        result = guard_command_injection(cmd)
        assert result == cmd

    def test_security_guards_empty_command_blocked_are_blocked(self) -> None:
        """Test that empty commands are blocked."""
        with pytest.raises(SecurityError) as exc_info:
            guard_command_injection([])
        assert "Empty command" in str(exc_info.value)

    def test_security_guards_semicolon_blocked_are_blocked(self) -> None:
        """Test that semicolons are blocked."""
        with pytest.raises(SecurityError):
            guard_command_injection(["echo", "hello; rm -rf /"])

    def test_security_guards_pipe_blocked_are_blocked(self) -> None:
        """Test that pipe characters are blocked."""
        with pytest.raises(SecurityError):
            guard_command_injection(["cat", "file | rm -rf /"])

    def test_security_guards_backtick_blocked_are_blocked(self) -> None:
        """Test that backticks are blocked."""
        with pytest.raises(SecurityError):
            guard_command_injection(["echo", "`whoami`"])

    def test_security_guards_dollar_expansion_blocked_is_blocked(self) -> None:
        """Test that dollar expansion is blocked."""
        with pytest.raises(SecurityError):
            guard_command_injection(["echo", "$(whoami)"])

    def test_security_guards_allowed_commands_whitelist_whitelist_functionality(self) -> None:
        """Test command whitelist functionality."""
        cmd = ["python", "-c", "print('hello')"]
        result = guard_command_injection(cmd, allowed_commands=["python"])
        assert result == cmd

    def test_security_guards_command_not_in_whitelist_blocked_are_blocked(
        self,
    ) -> None:
    ...
    def test_security_guards_empty_allowed_commands_whitelist_blocks_all_all_commands(
        self,
    ) -> None:
...
class TestGuardFileExtension:
    ...
    def test_security_guards_safe_extension_passes_extensions_pass(self) -> None:
    ...
    def test_security_guards_dangerous_extension_blocked_are_blocked(
        self,
    ) -> None:
    ...
    def test_security_guards_custom_denied_extensions_denied_extensions(self) -> None:
        """Test custom denied extensions."""
        with pytest.raises(SecurityError):
            guard_file_extension("config.yaml", denied_extensions=["yaml", "yml"])

    def test_security_guards_extension_with_dot_are_handled(self) -> None:
        """Test that extensions with dots are handled."""
        result = guard_file_extension("file.txt", allowed_extensions=[".txt"])
        assert result == Path("file.txt")

    def test_security_guards_normalize_ext_in_denied_normalized_correctly(self) -> None:
    ...
    def test_security_guards_normalize_ext_in_allowed_normalized_correctly(self) -> None:
    ...
    def test_security_guards_extension_not_in_allowed_list_blocked_are_blocked(
        self,
    ) -> None:
...
class TestGuardEnvVariable:
    ...
    def test_security_guards_safe_env_variable_are_returned(
    ...
    def test_security_guards_blocked_default_sensitive_are_blocked(self) -> None:
    ...
    def test_security_guards_blocked_password_pattern_is_blocked(self) -> None:
    ...
    def test_security_guards_sensitive_env_set_denied_without_allowed_names_is_omitted(
        self, monkeypatch: pytest.MonkeyPatch
    ) -> None:
    ...
    def test_security_guards_blocked_token_pattern_is_blocked(self) -> None:
    ...
    def test_security_guards_missing_env_variable_raise_error(
        self, monkeypatch: pytest.MonkeyPatch
    ) -> None:
    ...
    def test_security_guards_custom_denied_names_denied_names(
        self, monkeypatch: pytest.MonkeyPatch
    ) -> None:
    ...
    def test_security_guards_allowed_names_not_matching_sensitive_name_include_it(
        self, monkeypatch: pytest.MonkeyPatch
    ) -> None:
    ...
    def test_security_guards_allowed_names_override_pattern_blocking(
        self, monkeypatch: pytest.MonkeyPatch
    ) -> None:
...
def test_security_guards_command_injection_rejects_non_string_argument_type_be_strings() -> None:
...
def test_security_guards_env_variable_name_must_be_string_type_validation() -> None:
...
def test_security_guards_path_traversal_invalid_base_dir_type_expected():
...
def test_security_guards_path_traversal_invalid_path_type_expected():
    from taipanstack.security.guards import guard_path_traversal
...
def test_security_guards_path_traversal_null_bytes_in_path_expected():
...
def test_security_guards_path_traversal_null_bytes_in_base_dir_expected():
    from taipanstack.security.guards import SecurityError, guard_path_traversal
...
def test_security_guards_path_traversal_resolve_error_expected(
...
def test_security_guards_path_traversal_symlink_error_expected(
    monkeypatch: pytest.MonkeyPatch, tmp_path: Path
):
    from taipanstack.security.guards import SecurityError, guard_path_traversal
...
def test_security_guards_command_injection_invalid_command_elements_expected():
...
def test_security_guards_file_extension_max_length_exceeded_expected():
...
def test_security_guards_file_extension_null_bytes_expected():
    from taipanstack.security.guards import SecurityError, guard_file_extension
...
def test_security_guards_ssrf_not_string_type_expected():
    from taipanstack.core.result import Err
...
def test_security_guards_ssrf_empty_url_expected():
    from taipanstack.core.result import Err
    from taipanstack.security.guards import SecurityError, guard_ssrf
...
def test_security_guards_ssrf_max_length_exceeded_expected():
    from taipanstack.core.result import Err
    from taipanstack.security.guards import SecurityError, guard_ssrf
...
def test_security_guards_ssrf_missing_hostname_expected():
    from taipanstack.core.result import Err
    from taipanstack.security.guards import SecurityError, guard_ssrf
...
def test_security_guards_ssrf_unresolvable_hostname_expected(monkeypatch):
    import socket
...
def test_security_guards_file_extension_cleaning_dot_expected():
...
def test_security_guards_file_extension_normalization_expected():
...
def test_security_guards_ssrf_ip_multicast_expected():
    from taipanstack.core.result import Err
    from taipanstack.security.guards import SecurityError, guard_ssrf
...
def test_security_guards_ssrf_ip_unspecified_expected():
    from taipanstack.core.result import Err
    from taipanstack.security.guards import SecurityError, guard_ssrf
...
def test_security_guards_env_variable_empty_expected():
    import pytest
...
def test_security_guards_env_variable_whitespace_expected():
    import pytest
...
def test_security_guards_env_variable_null_bytes_expected():
    import pytest
...
def test_security_guards_file_extension_cleaning_z_category_expected():
    from taipanstack.security.guards import guard_file_extension
...
def test_security_guards_file_extension_cleaning_c_category_expected():
    from taipanstack.security.guards import guard_file_extension
...
def test_security_guards_file_extension_cleaning_ad_expected():
    from taipanstack.security.guards import guard_file_extension
...
def test_security_guards_ssrf_ip_resolve_error_expected(monkeypatch):
    import socket
...
def test_security_guards_file_extension_cleaning_non_matching_char_expected():
    from taipanstack.security.guards import guard_file_extension
...
def test_security_guards_file_extension_no_allowed_expected():
    from taipanstack.security.guards import guard_file_extension
...
def test_security_guards_env_variable_allowed_names_expected():
    import pytest
...
def test_security_guards_file_extension_denied_default_expected():
    import pytest
...
def test_security_guards_env_variable_allowed_names_empty_list_expected():
    import pytest
...
def test_security_guards_ssrf_ip_is_safe_attribute_error_expected(monkeypatch):
    import ipaddress
...
def test_security_guards_file_extension_cleaning_empty_clean_name_expected():
    from taipanstack.security.guards import SecurityError, guard_file_extension
...
def test_security_guards_ssrf_ip_is_safe_value_error_expected():
    from taipanstack.security.guards import _is_ip_safe
...
def test_security_guards_ssrf_url_invalid_characters_invalid_characters() -> None:
...
def test_security_guards_ssrf_url_valid_characters_valid_characters() -> None:
...
def test_security_guards_ssrf_url_invalid_characters_branch_the_branch() -> None:
