...
class TestGuardCommandInjection:
    ...
    def test_security_guards_empty_command_blocked_expected(self) -> None:
    ...
    def test_security_guards_dollar_expansion_blocked_expected(self) -> None:
    ...
    def test_security_guards_command_not_in_whitelist_blocked_expected(
        self,
    ) -> None:
...
class TestGuardFileExtension:
    ...
    def test_security_guards_dangerous_extension_blocked_expected(
        self,
    ) -> None:
...
class TestGuardEnvVariable:
    ...
    def test_security_guards_sensitive_env_set_denied_without_allowed_names_expected(
        self, monkeypatch: pytest.MonkeyPatch
    ) -> None:
    ...
    def test_security_guards_allowed_names_not_matching_sensitive_name_expected(
        self, monkeypatch: pytest.MonkeyPatch
    ) -> None:
...
def test_security_guards_env_variable_name_must_be_string_expected() -> None:
...
def test_security_guards_ssrf_url_invalid_characters_expected() -> None:
...
def test_security_guards_ssrf_url_valid_characters_expected() -> None:
...
def test_security_guards_ssrf_url_invalid_characters_branch_expected() -> None:
