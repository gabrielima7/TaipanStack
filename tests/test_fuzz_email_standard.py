...
def test_fuzz_email_standard_fuzz_email_massive_strings_dos(email: str) -> None:
...
def test_fuzz_email_standard_fuzz_email_null_bytes(email: str) -> None:
...
def test_fuzz_email_standard_fuzz_email_unprintable_chars(chars: str) -> None:
