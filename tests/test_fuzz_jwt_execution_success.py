...
class TestFuzzJWT:
    ...
    def test_fuzz_jwt_fuzz_encode_jwt_malformed_payload_execution_success(
    ...
    @settings(max_examples=500, suppress_health_check=[HealthCheck.too_slow])
    def test_fuzz_jwt_fuzz_decode_jwt_malformed_token_execution_success(
    ...
    @settings(max_examples=500, suppress_health_check=[HealthCheck.too_slow])
    def test_fuzz_jwt_fuzz_encode_jwt_malformed_secret_execution_success(
        self, payload, secret, algorithm
    ) -> None:
    ...
    @settings(max_examples=500, suppress_health_check=[HealthCheck.too_slow])
    def test_fuzz_jwt_fuzz_encode_jwt_malformed_algorithm_execution_success(
