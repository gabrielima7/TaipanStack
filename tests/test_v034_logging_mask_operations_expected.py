...
class TestMaskSensitiveDataProcessor:
    ...
    def test_v034_logging_mask_token_key_is_redacted_expected(self) -> None:
    ...
    def test_v034_logging_mask_authorization_key_is_redacted_expected(self) -> None:
    ...
    def test_v034_logging_mask_case_insensitive_matching_token_expected(self) -> None:
    ...
    def test_v034_logging_mask_case_insensitive_matching_secret_expected(self) -> None:
    ...
    def test_v034_logging_mask_partial_key_match_is_redacted_expected(self) -> None:
    ...
    def test_v034_logging_mask_non_sensitive_keys_are_untouched_expected(self) -> None:
    ...
    def test_v034_logging_mask_returns_same_dict_object_expected(self) -> None:
    ...
    def test_v034_logging_mask_logger_and_method_args_ignored_expected(self) -> None:
...
class TestSensitiveKeyPatternsConstant:
    ...
    def test_v034_logging_mask_contains_expected_patterns_expected(self) -> None:
...
class TestMaskSensitiveDataProcessorStructlogIntegration:
    ...
    def test_v034_logging_mask_structlog_pipeline_masks_password_expected(self) -> None:
    ...
    def test_v034_logging_mask_structlog_pipeline_masks_api_key_expected(self) -> None:
    ...
    def test_v034_logging_mask_structlog_pipeline_masks_token_expected(self) -> None:
