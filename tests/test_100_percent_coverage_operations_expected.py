...
class TestValidatorsMissingBranches:
    ...
    def test_100_percent_coverage_validate_project_name_with_hyphen_false_expected(
        self,
    ) -> None:
    ...
    def test_100_percent_coverage_validate_project_name_with_underscore_false_expected(
        self,
    ) -> None:
...
class TestSanitizersMissingBranches:
    ...
    def test_100_percent_coverage_sanitize_filename_preserve_extension_false_expected(
        self,
    ) -> None:
    ...
    def test_100_percent_coverage_sanitize_path_resolve_true_expected(
        self, tmp_path: Path
    ) -> None:
