...
def test_chaos_rl_nan_rate_limiter_chaos_time_corruption_standard_expected(
...
def test_chaos_rl_nan_rate_limiter_chaos_time_corruption_has_tokens_standard_expected(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    limiter = RateLimiter(max_calls=5, time_window=10.0)
...
def test_chaos_rl_nan_rate_limiter_chaos_consume_zero_tokens_standard_expected() -> None:
    limiter = RateLimiter(max_calls=5, time_window=10.0)
