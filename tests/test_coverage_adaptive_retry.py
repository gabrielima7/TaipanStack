...
def test_coverage_adaptive_retry_adaptive_retry_calculate_delay_metrics_expected():
    ar = AdaptiveRetry()
...
def test_coverage_adaptive_retry_adaptive_retry_to_retry_config_expected():
