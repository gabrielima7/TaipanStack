...
class TestSafeRequest:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_timeout_default_passed(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_timeout_custom_passed(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_no_httpx_returns_err(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_ssrf_blocks_private_ip(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_ssrf_ok_path_calls_request(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_circuit_breaker_open_returns_err(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_retry_on_server_error(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_retry_on_connection_error(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_all_retries_fail(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_zero_attempts_returns_runtime_error(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_circuit_breaker_records_failure_on_request_exception(
        self,
    ) -> None:
...
class TestSafeHttpClient:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_client_timeout_default(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_no_httpx_raises(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_request_without_context_returns_err(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_get_post_put_delete_patch(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_ssrf_blocks_in_client(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_client_ssrf_ok_path_calls_request(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_client_retry_on_status(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_client_retry_on_exception(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_client_breaker_integration(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_client_all_retries_fail(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_client_zero_attempts_returns_runtime_error(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bridge_http_aexit_without_client_is_noop(self) -> None:
...
def test_bridge_http_http_bridge_import_error_coverage_standard_expected() -> None:
...
def test_bridge_http_import_error_coverage_standard_expected():
    import importlib
    import sys
...
def test_bridge_http_success_coverage_standard_expected():
    import importlib
    import sys
