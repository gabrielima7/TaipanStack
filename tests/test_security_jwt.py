...
class TestEncodeJWT:
    ...
    def test_security_jwt_encode_success_expected(self) -> None:
    ...
    def test_encode_rejects_none_algorithm_expected(self) -> None:
...
class TestDecodeJWT:
    ...
    def test_security_jwt_decode_success_expected(self) -> None:
    ...
    def test_decode_requires_exp_expected(self) -> None:
    ...
    def test_decode_requires_aud_expected(self) -> None:
    ...
    def test_decode_invalid_signature_expected(self) -> None:
    ...
    def test_decode_expired_token_expected(self) -> None:
    ...
    def test_decode_wrong_audience_expected(self) -> None:
