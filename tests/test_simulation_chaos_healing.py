...
@pytest.mark.asyncio
async def test_simulation_chaos_healing_complex_microservice_simulation_chaos_standard() -> (
    None
):
...
@pytest.mark.asyncio
async def test_simulation_chaos_healing_complex_microservice_simulation_orchestrator_exception() -> (
    None
):
