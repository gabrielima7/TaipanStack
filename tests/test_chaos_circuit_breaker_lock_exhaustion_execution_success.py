...
def test_chaos_circuit_breaker_lock_acquire_exception_sync_execution_success():
...
@pytest.mark.asyncio
async def test_chaos_circuit_breaker_decorator_lock_acquire_exception_async_execution_success():
...
def test_chaos_circuit_breaker_decorator_lock_acquire_exception_sync_execution_success():
    @circuit_breaker(failure_threshold=2)
    def my_func():
        return Ok("success")
