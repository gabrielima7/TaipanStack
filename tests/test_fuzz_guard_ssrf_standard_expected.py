...
def test_fuzz_guard_ssrf_massive_strings_dos_returns_err_standard_expected(url: str) -> None:
...
def test_fuzz_guard_ssrf_malformed_returns_ok_or_err_standard_expected(s: str) -> None:
