...
def test_chaos_resilience_exhaustion_sync_timeout_thread_start_generic_exhaustion_expected():
    @timeout(1.0)
    def my_func():
        return Ok("success")
...
@pytest.mark.asyncio
async def test_chaos_resilience_exhaustion_async_timeout_wait_for_generic_exhaustion_expected():
    @timeout(1.0)
    async def my_func():
        return Ok("success")
...
@pytest.mark.asyncio
async def test_chaos_resilience_exhaustion_async_timeout_wait_for_cancelled_error_expected():
    @timeout(1.0)
    async def my_func():
        return Ok("success")
...
def test_chaos_resilience_exhaustion_sync_retry_sleep_generic_exhaustion_expected():
...
@pytest.mark.asyncio
async def test_chaos_resilience_exhaustion_async_retry_sleep_generic_exhaustion_expected():
    @retry(max_attempts=3, initial_delay=0.1)
    async def my_func():
        raise ValueError("initial fail")
...
@pytest.mark.asyncio
async def test_chaos_resilience_exhaustion_async_retry_sleep_cancelled_error_expected():
    @retry(max_attempts=3, initial_delay=0.1)
    async def my_func():
        raise ValueError("initial fail")
