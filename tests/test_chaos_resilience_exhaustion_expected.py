...
def test_chaos_resilience_timeout_thread_exhaustion_runtime_error_expected(
...
def test_chaos_resilience_timeout_thread_exhaustion_memory_error_expected(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    @timeout(1.0)
    def dummy_func() -> Result[str, Exception]:
...
def test_chaos_resilience_timeout_thread_exhaustion_os_error_expected(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    @timeout(1.0)
    def dummy_func() -> Result[str, Exception]:
...
@pytest.mark.asyncio
async def test_chaos_resilience_timeout_async_exhaustion_runtime_error_expected(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    @timeout(1.0)
...
@pytest.mark.asyncio
async def test_chaos_resilience_timeout_async_exhaustion_memory_error_expected(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    @timeout(1.0)
    async def dummy_func() -> Result[str, Exception]:
...
@pytest.mark.asyncio
async def test_chaos_resilience_timeout_async_exhaustion_os_error_expected(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    @timeout(1.0)
    async def dummy_func() -> Result[str, Exception]:
