...
class TestResourceWatcher:
    ...
    @pytest.mark.asyncio
    async def test_double_start_returns_err_expected(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_threshold_breach_callback_expected(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_no_breach_below_threshold_expected(self) -> None:
...
class TestBaseWatcher:
    ...
    @pytest.mark.asyncio
    async def test_stop_without_start_expected(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_stop_timeout_cancels_task_expected(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_threshold_breach_without_callback_expected(self) -> None:
