...
class TestFilesystemEdgeCases:
    ...
    def test_safe_read_with_traversal_no_base_dir_expected(self, tmp_path: Path) -> None:
    ...
    def test_safe_write_existing_file_guarded_expected(self, tmp_path: Path) -> None:
    ...
    def test_safe_write_with_traversal_no_base_dir_expected(self, tmp_path: Path) -> None:
    ...
    def test_safe_write_atomic_error_cleanup_expected(self, tmp_path: Path) -> None:
...
class TestLoggingEdgeCases:
    ...
    def test_stack_logger_bind_context_expected(self) -> None:
    ...
    def test_stack_logger_unbind_context_expected(self) -> None:
    ...
    def test_setup_logging_basic_expected(self) -> None:
        """Test setup_logging basic configuration."""
        from taipanstack.utils.logging import setup_logging
        setup_logging(level="DEBUG")

    def test_log_operation_decorator_expected(self) -> None:
...
class TestDecoratorsEdgeCases:
    ...
    def test_timeout_with_signal_expected(self) -> None:
...
class TestGuardsEdgeCases:
    ...
    def test_guard_command_injection_with_whitelist_expected(self) -> None:
...
class TestSanitizersEdgeCases:
    ...
    def test_sanitize_string_with_null_bytes_expected(self) -> None:
        """Test sanitizing string with null bytes."""
        from taipanstack.security.sanitizers import sanitize_string
        result = sanitize_string("hello\x00world")
        assert "\x00" not in result

    def test_sanitize_path_with_special_chars_expected(self) -> None:
...
class TestValidatorsEdgeCases:
    ...
    def test_validate_project_name_reserved_expected(self) -> None:
    ...
    def test_validate_url_with_ip_expected(self) -> None:
...
class TestRetryEdgeCases:
    ...
    def test_retrier_multiple_attempts_expected(self) -> None:
...
class TestSubprocessEdgeCases:
    ...
    def test_run_safe_command_with_env_expected(self) -> None:
        """Test run_safe_command with custom environment."""
        from taipanstack.utils.subprocess import run_safe_command
        result = run_safe_command(["echo", "test"], env={"CUSTOM_VAR": "value"})
...
class TestCircuitBreakerEdgeCases:
    ...
    def test_circuit_breaker_half_open_success(self) -> None:
        ...
        breaker = CircuitBreaker(failure_threshold=1, success_threshold=2, timeout=0.05)
        attempt = 0
