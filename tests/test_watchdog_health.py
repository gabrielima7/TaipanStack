...
class TestCheckAll:
    ...
    @pytest.mark.asyncio
    async def test_exploding_counted_as_unhealthy_expected(self) -> None:
...
class TestForceOpenBreaker:
    ...
    def test_opens_closed_breaker_expected(self) -> None:
...
class TestHealthPinger:
    ...
    @pytest.mark.asyncio
    async def test_health_change_callback_expected(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_does_not_close_breaker_on_recovery_expected(self) -> None:
