...
class TestRequireDependency:
    ...
    def test_bridge_imports_existing_module_execution_success(self) -> None:
        """Returns Ok for installed modules."""
        result = require_dependency("json")
        assert isinstance(result, Ok)
        assert isinstance(result.ok_value, types.ModuleType)

    def test_bridge_imports_missing_module_default_hint_execution_success(self) -> None:
    ...
    def test_bridge_imports_missing_module_with_extra_execution_success(self) -> None:
...
class TestGetAttrOrErr:
    ...
    def test_bridge_imports_existing_attr_execution_success(self) -> None:
    ...
    def test_bridge_imports_missing_attr_execution_success(self) -> None:
