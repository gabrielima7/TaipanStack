...
class TestValidateProjectNameEdgeCases:
    ...
    def test_security_validators_extended_name_too_long_standard_expected(self) -> None:
        """Test that names exceeding max_length are rejected."""
        long_name = "a" * 101
        with pytest.raises(ValueError, match="exceeds maximum"):
            validate_project_name(long_name, max_length=100)

    def test_security_validators_extended_name_starts_with_number_standard_expected(
        self,
    ) -> None:
    ...
    def test_security_validators_extended_name_starts_with_hyphen_standard_expected(
        self,
    ) -> None:
    ...
    def test_security_validators_extended_empty_name_standard_expected(self) -> None:
...
class TestValidatePythonVersionEdgeCases:
    ...
    def test_security_validators_extended_unsupported_major_version_standard_expected(
        self,
    ) -> None:
    ...
    def test_security_validators_extended_unsupported_minor_version_standard_expected(
        self,
    ) -> None:
    ...
    def test_security_validators_extended_version_number_conversion_error_standard_expected(
        self,
    ) -> None:
    ...
    def test_security_validators_extended_non_numeric_version_mock_standard_expected(
        self,
    ) -> None:
