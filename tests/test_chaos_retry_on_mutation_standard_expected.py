...
def test_chaos_retry_single_exception_type_not_tuple_standard_expected():
    call_count = 0
    ...
    assert test_func_standard_expected() == "success"
    assert call_count == 2


def test_chaos_retry_on_mutation_standard_expected():
...
def test_chaos_retry_async_on_mutation_standard_expected():
    corrupted_on = "NotAnException"
...
def test_chaos_retry_err_val_type_error_standard_expected() -> None:
    corrupted_on = "NotAnException"
...
def test_chaos_retry_async_err_val_type_error_standard_expected() -> None:
    corrupted_on = "NotAnException"
...
def test_chaos_retry_non_exception_class_in_tuple_standard_expected() -> None:
