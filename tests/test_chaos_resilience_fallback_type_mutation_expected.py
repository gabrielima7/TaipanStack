...
def test_chaos_resilience_fallback_type_mutation_chaos_resilience_fallback_type_mutation_a_string() -> (
    None
):
...
@pytest.mark.asyncio
async def test_chaos_resilience_fallback_type_mutation_async_a_string() -> None:
    """Simulate a severe production failure where fallback 'exceptions' is corrupted to a string."""
...
def test_chaos_resilience_fallback_type_mutation_success_is_invalid() -> None:
...
@pytest.mark.asyncio
async def test_chaos_resilience_fallback_type_mutation_async_success_is_invalid() -> None:
...
def test_chaos_resilience_fallback_type_mutation_not_isinstance_not_matching() -> None:
...
@pytest.mark.asyncio
async def test_chaos_resilience_fallback_type_mutation_async_not_isinstance_not_matching() -> None:
    """Coverage: valid type but not matching."""
