...
class TestConfigWatcher:
    ...
    def test_detect_changes_no_change(self, tmp_path: Path) -> None:
    ...
    def test_validate_and_apply_with_env_file(self, tmp_path: Path) -> None:
    ...
    def test_validate_and_apply_missing_file(self, tmp_path: Path) -> None:
    ...
    def test_validate_and_apply_invalid_without_error_callback(
        self, tmp_path: Path
    ) -> None:
    ...
    def test_validate_and_apply_valid_without_change_callback(
        self, tmp_path: Path
    ) -> None:
