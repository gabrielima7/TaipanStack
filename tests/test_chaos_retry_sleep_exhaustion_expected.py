...
def test_chaos_retry_sync_sleep_oserror_expected():
    attempts = 0
...
@pytest.mark.asyncio
async def test_chaos_retry_async_sleep_memoryerror_expected():
    attempts = 0
...
def test_chaos_retrier_sleep_exhaustion_expected():
