...
def test_fuzz_sanitizers_types_fuzz_sanitize_path_massive_strings_execution_success() -> None:
...
def test_fuzz_sanitizers_types_fuzz_sanitize_path_hypothesis_execution_success(
    path: str,
) -> None:
...
def test_fuzz_sanitizers_types_fuzz_sanitize_path_massive_path_object_execution_success() -> None:
