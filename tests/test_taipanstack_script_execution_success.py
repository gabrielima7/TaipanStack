...
def test_taipanstack_script_dry_run_does_not_create_files_execution_success(tmp_path):
    """
...
def test_taipanstack_script_safe_write_creates_backup_execution_success(tmp_path):
    """
...
def test_taipanstack_script_force_mode_overwrites_without_backup_execution_success(
    tmp_path,
):
    """
...
def test_taipanstack_script_idempotency_for_pyproject_toml_execution_success(tmp_path):
    """
...
def test_taipanstack_script_git_initialization_execution_success(tmp_path):
    """
...
def test_taipanstack_script_project_structure_creation_execution_success(tmp_path):
    """
...
def test_taipanstack_script_optional_dependencies_flag_execution_success(tmp_path, monkeypatch):
    """
...
def test_taipanstack_script_install_runtime_deps_flag_execution_success(tmp_path, monkeypatch):
    """
...
def test_taipanstack_script_python_version_detection_execution_success(tmp_path):
    """
...
def test_taipanstack_script_setup_pre_commit_execution_success():
    """
...
def test_taipanstack_script_setup_pre_commit_dry_run_execution_success():
    """
