...
class TestCheckTarget:
    ...
    @pytest.mark.asyncio
    async def test_healthy_target_expected(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_unhealthy_target_expected(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_exploding_target_expected(self) -> None:
...
class TestCheckAll:
    ...
    @pytest.mark.asyncio
    async def test_all_healthy_expected(self) -> None:
        """All targets healthy."""
        targets = [
    ...
    @pytest.mark.asyncio
    async def test_mixed_health_expected(self) -> None:
