...
@pytest.mark.asyncio
async def test_chaos_bulkhead_resource_exhaustion_bulkhead_semaphore_exhaustion_chaos_returns_err_expected() -> (
    None
):
...
@pytest.mark.asyncio
async def test_chaos_bulkhead_resource_exhaustion_bulkhead_semaphore_exhaustion_chaos_generic_exception_expected() -> (
    None
):
    bulkhead = Bulkhead("test_chaos", max_concurrent=2, max_queue=2)
...
@pytest.mark.asyncio
async def test_chaos_bulkhead_resource_exhaustion_bulkhead_semaphore_exhaustion_chaos_fallback_exception_expected() -> (
    None
):
    bulkhead = Bulkhead("test_chaos", max_concurrent=2, max_queue=2)
...
@pytest.mark.asyncio
async def test_chaos_bulkhead_resource_exhaustion_bulkhead_semaphore_acquire_generic_exception_expected() -> (
    None
):
    bulkhead = Bulkhead("test_chaos", max_concurrent=2, max_queue=2)
