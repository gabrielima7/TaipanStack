...
def test_chaos_rate_limit_deadlock_rate_limit_deadlock_chaos_returns_false_expected():
...
@pytest.mark.asyncio
async def test_rate_limit_deadlock_chaos_async_decorator_expected():
    @rate_limit(10, 1.0)
    async def my_func():
        return "success"
...
def test_chaos_rate_limit_deadlock_rate_limit_deadlock_chaos_sync_decorator_expected():
    @rate_limit(10, 1.0)
    def my_func():
        return "success"
