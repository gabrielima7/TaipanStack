...
def test_chaos_timeout_resource_exhaustion_thread_oserror_returns_err_expected():
    @timeout(1.0)
    def dummy_task():
        return Ok("success")
...
def test_chaos_timeout_resource_exhaustion_thread_memoryerror_returns_err_expected():
    @timeout(1.0)
    def dummy_task():
        return Ok("success")
