...
class TestRetryAsyncSupport:
    ...
    async def test_async_does_not_catch_unspecified_exception_expected(self) -> None:
    ...
    async def test_async_reraise_false_still_raises_retry_error_expected(self) -> None:
