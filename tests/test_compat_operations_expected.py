...
class TestVersionTier:
    ...
    def test_compat_version_tier_values_expected(self) -> None:
    ...
    def test_compat_version_tier_is_str_expected(self) -> None:
...
class TestExperimentalFeatures:
    ...
    def test_compat_experimental_disabled_by_default_expected(self) -> None:
        """Test experimental features disabled by default."""
        with patch.dict(os.environ, {}, clear=True):
            assert not is_experimental_enabled(force_refresh=True)

    def test_compat_experimental_enabled_with_1_expected(self) -> None:
...
class TestOptimizationLevel:
    ...
    def test_compat_default_optimization_level_expected(self) -> None:
        """Test default optimization level is 1."""
        with patch.dict(os.environ, {}, clear=True):
            assert get_optimization_level(force_refresh=True) == 1

    def test_compat_optimization_level_0_expected(self) -> None:
    ...
    def test_compat_optimization_level_2_expected(self) -> None:
...
class TestPythonFeatures:
    ...
    def test_compat_get_features_returns_features_expected(self) -> None:
    ...
    def test_compat_features_tier_stable_expected(self) -> None:
    ...
    def test_compat_features_tier_enhanced_expected(self) -> None:
    ...
    def test_compat_features_tier_modern_expected(self) -> None:
    ...
    def test_compat_features_tier_cutting_edge_expected(self) -> None:
    ...
    def test_compat_features_language_311_expected(self) -> None:
    ...
    def test_compat_features_language_312_expected(self) -> None:
    ...
    def test_compat_features_language_313_expected(self) -> None:
        """Test language features for Python 3.13."""
        features = get_features()
        if PY313:
            assert features.has_deprecated_decorator

    def test_compat_features_language_314_expected(self) -> None:
        """Test language features for Python 3.14."""
        features = get_features()
        if PY314:
            assert features.has_deferred_annotations

    def test_compat_features_experimental_disabled_expected(self) -> None:
    ...
    def test_compat_features_to_dict_expected(self) -> None:
...
class TestGetPythonInfo:
    ...
    def test_compat_python_info_structure_expected(self) -> None:
    ...
    def test_compat_python_info_values_expected(self) -> None:
    ...
    def test_compat_experimental_enabled_cached_expected(self) -> None:
    ...
    def test_compat_optimization_level_cached_expected(self) -> None:
