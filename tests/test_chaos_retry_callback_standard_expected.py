...
def test_chaos_retry_callback_retry_chaos_faulty_callback_standard_expected():
...
def test_chaos_retry_callback_retry_chaos_faulty_callback_without_structlog_standard_expected(
    monkeypatch,
):
    monkeypatch.setattr(
