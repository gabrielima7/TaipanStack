...
def test_chaos_concurrency_resource_exhaustion_sync_concurrency_memoryerror_chaos_returns_err_expected():
...
@pytest.mark.asyncio
async def test_chaos_concurrency_resource_exhaustion_async_concurrency_oserror_chaos_returns_err_expected():
    @limit_concurrency(max_tasks=1)
