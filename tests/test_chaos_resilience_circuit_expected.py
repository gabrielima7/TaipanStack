...
def test_chaos_resilience_circuit_circuit_breaker_on_state_change_chaos_callback_fails():
...
def test_chaos_resilience_circuit_circuit_breaker_on_state_change_chaos_without_structlog_is_missing(
    monkeypatch,
):
...
def test_chaos_resilience_circuit_circuit_breaker_chaos_config_mutations_fast_failure():
...
def test_chaos_resilience_circuit_structlog_warning_without_callback_is_set(
...
def test_chaos_resilience_circuit_structlog_fallback_noop_when_unavailable_is_unavailable(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
