...
def test_fuzz_sanitizers_types_fuzz_sanitize_path_massive_strings_standard_expected() -> (
    None
):
...
def test_fuzz_sanitizers_types_fuzz_sanitize_path_massive_path_object_standard_expected() -> (
    None
):
