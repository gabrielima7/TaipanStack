...
class TestSafeRead:
    ...
    def test_utils_filesystem_read_no_max_size_with_maxsizebytesnone(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_read_existing_file_existing_file(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_read_with_base_dir_directory_constraint(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_read_nonexistent_file_returns_err(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_read_directory_fails_returns_err(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_read_file_too_large_returns_err(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_read_with_custom_encoding_custom_encoding(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_path_traversal_blocked_is_blocked(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_path_traversal_without_base_dir_blocked_is_provided(
        self,
    ) -> None:
...
class TestSafeWrite:
    ...
    def test_utils_filesystem_write_new_file_new_file(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_write_existing_file_with_base_dir_with_basedir(
        self, tmp_path: Path
    ) -> None:
    ...
    def test_utils_filesystem_write_no_create_parents_with_createparentsfalse(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_write_empty_content_empty_string(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_write_creates_parent_dirs_are_created(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_write_creates_backup_existing_file(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_write_no_backup_without_backup(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_atomic_write_write_mode(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_non_atomic_write_write_mode(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_safe_write_cleanup_propagates_oserror_like_permissionerror(
        self, tmp_path: Path
    ) -> None:
    ...
    def test_utils_filesystem_safe_write_cleanup_succeeds_temp_file(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_write_invalid_filename_blocked_silently_mutating(
        self, tmp_path: Path
    ) -> None:
...
class TestEnsureDir:
    ...
    def test_utils_filesystem_create_new_directory_new_directory(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_existing_directory_ok_is_ok(self, tmp_path: Path) -> None:
        """Test that existing directory is OK."""
        result = ensure_dir(tmp_path)
        assert result.exists()

    def test_utils_filesystem_create_nested_directories_nested_directories(self, tmp_path: Path) -> None:
    ...
    def test_utils_filesystem_file_exists_error_when_path_is_file_a_file(
        self, tmp_path: Path
    ) -> None:
    ...
    def test_utils_filesystem_root_directory_already_exists_parent_check(
        self,
    ) -> None:
    ...
    def test_utils_filesystem_missing_intermediate_directory_created_intermediate_parent(
        self, tmp_path: Path
    ) -> None:
    ...
    def test_utils_filesystem_root_parent_loop_break_to_root(
