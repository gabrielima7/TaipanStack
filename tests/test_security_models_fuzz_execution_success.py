...
def test_security_models_fuzz_masking_execution_success(payload: object) -> None:
...
def test_security_models_max_depth_execution_success() -> None:
    class Container(SecureBaseModel):
        payload: object
...
def test_security_models_max_depth_collections_execution_success() -> None:
    class Container(SecureBaseModel):
        payload: object
