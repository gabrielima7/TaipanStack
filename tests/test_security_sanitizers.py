...
class TestSanitizeString:
    ...
    def test_normal_string_unchanged_expected(self) -> None:
...
class TestSanitizeFilename:
    ...
    def test_removes_path_characters_expected(self) -> None:
        """Test path characters are removed."""
        result = sanitize_filename("../etc/passwd.txt")
        assert "/" not in result
        assert ".." not in result

    def test_removes_invalid_windows_chars_expected(self) -> None:
    ...
    def test_max_length_with_extension_expected(self) -> None:
        """Test max length preserves extension."""
        result = sanitize_filename("verylongfilename.txt", max_length=10)
        assert len(result) <= 10
        assert result.endswith(".txt")

    def test_max_length_with_long_extension_expected(self) -> None:
    ...
    def test_collapses_multiple_replacements_expected(self) -> None:
...
class TestSanitizePath:
    ...
    def test_sanitize_path_absolute_with_parts_expected(self, tmp_path: Path) -> None:
    ...
    def test_sanitize_path_empty_expected(self) -> None:
    ...
    def test_max_depth_enforced_expected(self) -> None:
        """Test max depth is enforced."""
        deep_path = "/".join(["dir"] * 20)
        with pytest.raises(ValueError, match="depth"):
            sanitize_path(deep_path, max_depth=5)

    def test_with_base_dir_expected(self, tmp_path: Path) -> None:
    ...
    def test_removes_parent_traversal_expected(self) -> None:
    ...
    def test_removes_multiple_parent_traversals_expected(self) -> None:
    ...
    def test_handles_empty_parts_expected(self) -> None:
    ...
    def test_handles_invalid_character_parts_expected(self) -> None:
...
class TestSanitizeEnvValue:
    ...
    def test_removes_newlines_by_default_expected(self) -> None:
...
class TestSanitizeSqlIdentifier:
    ...
    def test_security_sanitizers_type_error_expected(self) -> None:
        ...
        with pytest.raises(TypeError, match="identifier must be str, got float"):
            sanitize_sql_identifier(3.14)

    def test_empty_identifier_raises_expected(self) -> None:
    ...
    def test_removes_special_characters_expected(self) -> None:
    ...
    def test_prefix_if_starts_with_number_expected(self) -> None:
    ...
    def test_truncates_long_identifier_expected(self) -> None:
        """Test long identifier is truncated."""
        long_name = "a" * 200
        result = sanitize_sql_identifier(long_name)
        assert len(result) <= 128

    def test_invalid_chars_only_raises_expected(self) -> None:
