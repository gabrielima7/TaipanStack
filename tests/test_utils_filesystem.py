...
class TestSafeRead:
    ...
    def test_read_no_max_size_expected(self, tmp_path: Path) -> None:
    ...
    def test_read_existing_file_expected(self, tmp_path: Path) -> None:
    ...
    def test_read_with_base_dir_expected(self, tmp_path: Path) -> None:
    ...
    def test_read_nonexistent_file_expected(self, tmp_path: Path) -> None:
    ...
    def test_read_file_too_large_expected(self, tmp_path: Path) -> None:
    ...
    def test_read_with_custom_encoding_expected(self, tmp_path: Path) -> None:
...
class TestSafeWrite:
    ...
    def test_write_new_file_expected(self, tmp_path: Path) -> None:
    ...
    def test_write_existing_file_with_base_dir_expected(self, tmp_path: Path) -> None:
    ...
    def test_write_empty_content_expected(self, tmp_path: Path) -> None:
    ...
    def test_write_creates_parent_dirs_expected(self, tmp_path: Path) -> None:
        """Test that parent directories are created."""
        test_file = tmp_path / "subdir" / "nested" / "file.txt"
        safe_write(test_file, "nested content")
        assert test_file.exists()

    def test_write_creates_backup_expected(self, tmp_path: Path) -> None:
    ...
    def test_write_no_backup_expected(self, tmp_path: Path) -> None:
    ...
    def test_non_atomic_write_expected(self, tmp_path: Path) -> None:
    ...
    def test_safe_write_cleanup_succeeds_expected(self, tmp_path: Path) -> None:
...
class TestEnsureDir:
    ...
    def test_create_new_directory_expected(self, tmp_path: Path) -> None:
    ...
    def test_create_nested_directories_expected(self, tmp_path: Path) -> None:
    ...
    def test_file_exists_error_when_path_is_file_expected(self, tmp_path: Path) -> None:
