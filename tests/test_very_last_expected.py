...
class TestGuardsOSErrorMocked:
    ...
    def test_very_last_guard_path_basic_works_expected(
        self, tmp_path: Path
    ) -> None:
...
class TestSanitizersResolveError:
    ...
    def test_very_last_sanitize_path_works_expected(
        self, tmp_path: Path
    ) -> None:
...
class TestFilesystemWriteError:
    ...
    def test_very_last_ensure_dir_with_traversal_expected(
        self, tmp_path: Path
    ) -> None:
