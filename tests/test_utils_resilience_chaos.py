...
def test_timeout_sync_chaos_nan_expected() -> None:
...
def test_timeout_sync_chaos_negative_expected() -> None:
...
@pytest.mark.asyncio
async def test_timeout_async_chaos_nan_expected() -> None:
...
@pytest.mark.asyncio
async def test_timeout_async_chaos_negative_expected() -> None:
