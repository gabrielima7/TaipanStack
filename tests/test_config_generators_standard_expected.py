...
class TestGeneratePyprojectConfig:
    ...
    def test_config_generators_generates_ruff_config_standard_expected(self) -> None:
    ...
    def test_config_generators_generates_mypy_config_standard_expected(self) -> None:
    ...
    def test_config_generators_generates_pytest_config_standard_expected(self) -> None:
...
class TestGenerateSecurityPolicy:
    ...
    def test_config_generators_generates_markdown_standard_expected(self) -> None:
...
class TestGeneratePreCommitConfig:
    ...
    def test_config_generators_pre_commit_paranoid_standard_expected(self) -> None:
