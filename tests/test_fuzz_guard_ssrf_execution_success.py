...
def test_fuzz_guard_ssrf_massive_strings_dos_returns_err_execution_success(
    url: str,
) -> None:
...
def test_fuzz_guard_ssrf_malformed_returns_ok_or_err_execution_success(s: str) -> None:
