...
class TestEncodeJWT:
    ...
    def test_security_jwt_encode_rejects_none_algorithm_standard_expected(self) -> None:
...
class TestDecodeJWT:
    ...
    def test_security_jwt_decode_rejects_none_algorithm_standard_expected(self) -> None:
    ...
    def test_security_jwt_decode_requires_exp_standard_expected(self) -> None:
    ...
    def test_security_jwt_decode_requires_aud_standard_expected(self) -> None:
    ...
    def test_security_jwt_decode_invalid_signature_standard_expected(self) -> None:
    ...
    def test_security_jwt_decode_expired_token_standard_expected(self) -> None:
    ...
    def test_security_jwt_decode_wrong_audience_standard_expected(self) -> None:
