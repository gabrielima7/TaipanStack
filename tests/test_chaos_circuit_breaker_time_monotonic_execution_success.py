...
def test_circuit_breaker_time_monotonic_exception_update_metrics_execution_success():
    # Setup
...
def test_circuit_breaker_time_monotonic_exception_handle_open_execution_success():
    # Setup
