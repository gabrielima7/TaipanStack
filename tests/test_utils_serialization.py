...
class TestDefaultEncoder:
    ...
    def test_utils_serialization_encode_err(self) -> None:
        """Test encoding Err."""
    ...
    def test_utils_serialization_encode_unsupported_type(self) -> None:
    ...
    def test_utils_serialization_default_encoder_direct_type_error(
        self,
    ) -> None:
    ...
    def test_utils_serialization_encode_ok_with_status_override(self) -> None:
