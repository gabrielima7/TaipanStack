...
class TestDefaultEncoder:
    ...
    def test_encode_ok_with_dict_expected(self) -> None:
    ...
    def test_encode_ok_with_scalar_expected(self) -> None:
    ...
    def test_encode_unsupported_type_expected(self) -> None:
    ...
    def test_encode_ok_with_status_override_expected(self) -> None:
