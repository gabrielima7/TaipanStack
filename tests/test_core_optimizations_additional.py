...
def test_core_optimizations_additional_core_optimizations_apply_gc_threshold_exception():
    ...
    with patch("taipanstack.core.optimizations.gc.set_threshold", side_effect=Exception("mocked error")):
...
def test_core_optimizations_additional_core_optimizations_apply_gc_freeze_exception():
    ...
    with patch("taipanstack.core.optimizations.gc.freeze", side_effect=Exception("mocked error")):
