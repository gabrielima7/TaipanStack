...
def test_utils_resilience_standard_utils_resilience_fallback_sync() -> None:
...
def test_utils_resilience_standard_utils_resilience_fallback_sync_unreachable() -> None:
...
@pytest.mark.asyncio
async def test_utils_resilience_standard_utils_resilience_fallback_async_unreachable() -> None:
...
@pytest.mark.asyncio
async def test_utils_resilience_standard_utils_resilience_fallback_async() -> None:
    """Test async fallback."""
...
def test_utils_resilience_standard_utils_resilience_timeout_sync() -> None:
...
@pytest.mark.asyncio
async def test_utils_resilience_standard_utils_resilience_timeout_async() -> None:
    """Test async timeout."""
