...
def test_chaos_circuit_breaker_time_corruption_circuit_breaker_chaos_time_corruption_execution_success(
...
def test_chaos_circuit_breaker_time_corruption_circuit_breaker_chaos_time_corruption_record_failure_execution_success(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
