...
def test_fuzz_project_name_malformed_max_length_standard_expected(
    max_length,
) -> None:
...
@settings(max_examples=100, suppress_health_check=[HealthCheck.too_slow])
def test_fuzz_project_name_malformed_allow_hyphen_standard_expected(
    allow_hyphen,
) -> None:
...
@settings(max_examples=100, suppress_health_check=[HealthCheck.too_slow])
def test_fuzz_project_name_malformed_allow_underscore_standard_expected(
    allow_underscore,
) -> None:
