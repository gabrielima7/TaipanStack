...
class TestGuardSsrfEmptyAndMalformed:
    ...
    def test_security_ssrf_disallowed_scheme_ftp_returns_err(
        self,
    ) -> None:
    ...
    def test_security_ssrf_disallowed_scheme_file_returns_err(
        self,
    ) -> None:
    ...
    def test_security_ssrf_unresolvable_hostname_returns_err(
        self,
    ) -> None:
...
def test_security_ssrf_guard_ssrf_invalid_control_characters_expected() -> None:
