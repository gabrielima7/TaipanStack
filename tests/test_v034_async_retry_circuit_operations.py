...
class TestRetryAsyncSupport:
    ...
    async def test_v034_async_retry_circuit_async_success_no_retry(self) -> None:
    ...
    async def test_v034_async_retry_circuit_async_retries_then_succeeds(self) -> None:
    ...
    async def test_v034_async_retry_circuit_async_raises_retry_error_after_max_attempts(self) -> None:
    ...
    async def test_v034_async_retry_circuit_async_does_not_catch_unspecified_exception(self) -> None:
    ...
    async def test_v034_async_retry_circuit_async_uses_asyncio_sleep_not_time_sleep(self) -> None:
    ...
    async def test_v034_async_retry_circuit_async_on_retry_callback_is_called(self) -> None:
    ...
    async def test_v034_async_retry_circuit_async_structlog_warning_called_without_callback(
        self,
    ) -> None:
    ...
    async def test_v034_async_retry_circuit_async_log_retries_false_skips_logging(self) -> None:
    ...
    async def test_v034_async_retry_circuit_async_reraise_false_still_raises_retry_error(self) -> None:
...
class TestCircuitBreakerAsyncSupport:
    ...
    async def test_v034_async_retry_circuit_async_success_keeps_closed(self) -> None:
    ...
    async def test_v034_async_retry_circuit_async_failures_open_circuit(self) -> None:
    ...
    async def test_v034_async_retry_circuit_async_half_open_success_closes_circuit(self) -> None:
    ...
    async def test_v034_async_retry_circuit_async_half_open_failure_reopens_circuit(self) -> None:
    ...
    async def test_v034_async_retry_circuit_circuit_breaker_decorator_async(self) -> None:
    ...
    async def test_v034_async_retry_circuit_async_excluded_exceptions_dont_trip(self) -> None:
    ...
    async def test_v034_async_retry_circuit_async_on_state_change_callback_called(self) -> None:
    ...
    async def test_v034_async_retry_circuit_async_structlog_called_on_state_change_no_callback(
        self,
    ) -> None:
