...
def test_stack_script_dry_run_does_not_create_files_expected(tmp_path):
    """
...
def test_stack_script_safe_write_creates_backup_expected(tmp_path):
    """
...
def test_stack_script_force_mode_overwrites_without_backup_expected(tmp_path):
    """
...
def test_stack_script_idempotency_for_pyproject_toml_expected(tmp_path):
    """
...
def test_stack_script_project_structure_creation_expected(tmp_path):
    """
...
def test_stack_script_optional_dependencies_flag_expected(tmp_path, monkeypatch):
    """
...
def test_stack_script_install_runtime_deps_flag_expected(tmp_path, monkeypatch):
    """
...
def test_stack_script_python_version_detection_expected(tmp_path):
    """
...
def test_stack_script_setup_pre_commit_expected():
    """
...
def test_stack_script_setup_pre_commit_dry_run_expected():
    """
