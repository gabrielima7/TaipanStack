...
def test_fuzz_extreme_limits_dos_fuzz_project_name_massive_dos_expected() -> None:
...
def test_fuzz_extreme_limits_dos_fuzz_url_massive_dos_expected() -> None:
...
def test_fuzz_extreme_limits_dos_fuzz_email_massive_dos_expected() -> None:
...
def test_fuzz_extreme_limits_dos_fuzz_url_hypothesis_dos_expected(url: str) -> None:
    """Fuzz validate_url with massive strings."""
    with pytest.raises(ValueError):
        validate_url(url)
...
def test_fuzz_extreme_limits_dos_fuzz_email_hypothesis_dos_expected(email: str) -> None:
    """Fuzz validate_email with massive strings."""
    with pytest.raises(ValueError):
        validate_email(email)
