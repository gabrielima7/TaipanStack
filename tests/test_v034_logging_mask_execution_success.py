...
class TestMaskSensitiveDataProcessor:
    ...
    def test_v034_logging_mask_password_key_is_redacted_execution_success(self) -> None:
    ...
    def test_v034_logging_mask_secret_key_is_redacted_execution_success(self) -> None:
    ...
    def test_v034_logging_mask_token_key_is_redacted_execution_success(self) -> None:
    ...
    def test_v034_logging_mask_authorization_key_is_redacted_execution_success(
        self,
    ) -> None:
    ...
    def test_v034_logging_mask_api_key_is_redacted_execution_success(self) -> None:
    ...
    def test_v034_logging_mask_case_insensitive_matching_password_execution_success(
        self,
    ) -> None:
    ...
    def test_v034_logging_mask_case_insensitive_matching_token_execution_success(
        self,
    ) -> None:
    ...
    def test_v034_logging_mask_case_insensitive_matching_secret_execution_success(
        self,
    ) -> None:
    ...
    def test_v034_logging_mask_partial_key_match_is_redacted_execution_success(
        self,
    ) -> None:
    ...
    def test_v034_logging_mask_non_sensitive_keys_are_untouched_execution_success(
        self,
    ) -> None:
    ...
    def test_v034_logging_mask_empty_event_dict_is_returned_unchanged_execution_success(
        self,
    ) -> None:
    ...
    def test_v034_logging_mask_returns_same_dict_object_execution_success(self) -> None:
        """Processor returns the same event_dict object (in-place mutation)."""
        event_dict = {"event": "test", "password": "secret"}
        result = mask_sensitive_data_processor(None, "info", event_dict)
        assert result is event_dict

    def test_v034_logging_mask_multiple_sensitive_keys_all_redacted_execution_success(
        self,
    ) -> None:
    ...
    def test_v034_logging_mask_logger_and_method_args_ignored_execution_success(
        self,
    ) -> None:
...
class TestSensitiveKeyPatternsConstant:
    ...
    def test_v034_logging_mask_contains_patterns_execution_success(self) -> None:
    ...
    def test_v034_logging_mask_patterns_are_lowercase_execution_success(self) -> None:
...
class TestMaskSensitiveDataProcessorStructlogIntegration:
    ...
    def test_v034_logging_mask_structlog_pipeline_masks_password_execution_success(
        self,
    ) -> None:
    ...
    def test_v034_logging_mask_structlog_pipeline_masks_authorization_header_execution_success(
        self,
    ) -> None:
    ...
    def test_v034_logging_mask_structlog_pipeline_preserves_non_sensitive_fields_execution_success(
        self,
    ) -> None:
    ...
    def test_v034_logging_mask_structlog_pipeline_masks_api_key_execution_success(
        self,
    ) -> None:
    ...
    def test_v034_logging_mask_structlog_pipeline_masks_token_execution_success(
        self,
    ) -> None:
