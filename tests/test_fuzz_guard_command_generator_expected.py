...
def test_fuzz_guard_command_generator_returns_ok_or_raises_error_expected(
    cmd_list,
):
    def gen():
        yield from cmd_list
...
def test_fuzz_guard_command_generator_guard_command_empty_generator_raises_error_expected():
    def empty_gen():
        yield from ()
