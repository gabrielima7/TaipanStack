...
def test_circuit_breaker_callback_exception_logging_standard_expected():
...
def test_circuit_breaker_notify_state_change_no_callback_no_structlog_standard_expected():
    cb = CircuitBreaker()
