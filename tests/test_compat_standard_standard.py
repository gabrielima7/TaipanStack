...
class TestVersionTier:
    ...
    def test_compat_version_tier_values_standard_expected(self) -> None:
    ...
    def test_compat_version_tier_is_str_standard_expected(self) -> None:
...
class TestExperimentalFeatures:
    ...
    def test_compat_experimental_disabled_by_default_standard_expected(self) -> None:
        """Test experimental features disabled by default."""
        with patch.dict(os.environ, {}, clear=True):
            assert not is_experimental_enabled(force_refresh=True)

    def test_compat_experimental_enabled_with_1_standard_expected(self) -> None:
...
class TestOptimizationLevel:
    ...
    def test_compat_default_optimization_level_standard_expected(self) -> None:
        """Test default optimization level is 1."""
        with patch.dict(os.environ, {}, clear=True):
            assert get_optimization_level(force_refresh=True) == 1

    def test_compat_optimization_level_0_standard_expected(self) -> None:
    ...
    def test_compat_optimization_level_2_standard_expected(self) -> None:
    ...
    def test_compat_optimization_level_clamped_low_standard_expected(self) -> None:
        """Test optimization level is clamped to minimum 0."""
        with patch.dict(os.environ, {"STACK_OPTIMIZATION_LEVEL": "-5"}):
            assert get_optimization_level(force_refresh=True) == 0

    def test_compat_optimization_level_clamped_high_standard_expected(self) -> None:
        """Test optimization level is clamped to maximum 2."""
        with patch.dict(os.environ, {"STACK_OPTIMIZATION_LEVEL": "99"}):
            assert get_optimization_level(force_refresh=True) == 2

    def test_compat_optimization_level_invalid_standard_expected(self) -> None:
...
class TestPythonFeatures:
    ...
    def test_compat_get_features_returns_features_standard_expected(self) -> None:
        """Test get_features returns PythonFeatures instance."""
        features = get_features()
        assert isinstance(features, PythonFeatures)

    def test_compat_features_version_standard_expected(self) -> None:
    ...
    def test_compat_features_tier_stable_standard_expected(self) -> None:
    ...
    def test_compat_features_tier_enhanced_standard_expected(self) -> None:
    ...
    def test_compat_features_tier_modern_standard_expected(self) -> None:
    ...
    def test_compat_features_tier_cutting_edge_standard_expected(self) -> None:
    ...
    def test_compat_features_language_311_standard_expected(self) -> None:
    ...
    def test_compat_features_language_312_standard_expected(self) -> None:
    ...
    def test_compat_features_language_313_standard_expected(self) -> None:
        """Test language features for Python 3.13."""
        features = get_features()
        if PY313:
            assert features.has_deprecated_decorator

    def test_compat_features_language_314_standard_expected(self) -> None:
        """Test language features for Python 3.14."""
        features = get_features()
        if PY314:
            assert features.has_deferred_annotations

    def test_compat_features_experimental_disabled_standard_expected(self) -> None:
    ...
    def test_compat_features_to_dict_standard_expected(self) -> None:
    ...
    def test_compat_features_cached_standard_expected(self) -> None:
        """Test features are cached after first call."""
        features1 = get_features()
        features2 = get_features()
        assert features1 is features2

    def test_compat_features_force_refresh_standard_expected(self) -> None:
...
class TestGetPythonInfo:
    ...
    def test_compat_python_info_structure_standard_expected(self) -> None:
    ...
    def test_compat_python_info_values_standard_expected(self) -> None:
    ...
    def test_compat_experimental_enabled_cached_standard_expected(self) -> None:
    ...
    def test_compat_optimization_level_cached_standard_expected(self) -> None:
