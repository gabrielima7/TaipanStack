...
def test_security_models_fuzz_security_models_max_depth_standard() -> None:
    class Container(SecureBaseModel):
        payload: object
...
def test_security_models_fuzz_security_models_max_depth_collections_standard() -> None:
    class Container(SecureBaseModel):
        payload: object
