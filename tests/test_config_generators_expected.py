...
class TestGenerateSecurityPolicy:
    ...
    def test_config_generators_includes_reporting_instructions_expected(
        self,
    ) -> None:
    ...
    def test_config_generators_includes_supported_versions_expected(
        self,
    ) -> None:
...
class TestGeneratePreCommitConfig:
    ...
    def test_config_generators_pre_commit_all_security_hooks_expected(
        self,
    ) -> None:
    ...
    def test_config_generators_pre_commit_no_security_hooks_expected(
        self,
    ) -> None:
