...
class TestGeneratePyprojectConfig:
    ...
    def test_config_generators_generates_ruff_config_is_generated(self) -> None:
    ...
    def test_config_generators_generates_mypy_config_is_generated(self) -> None:
    ...
    def test_config_generators_generates_pytest_config_is_generated(self) -> None:
...
class TestGenerateSecurityPolicy:
    ...
    def test_config_generators_generates_markdown_is_generated(self) -> None:
        """Test that Markdown is generated."""
        result = generate_security_policy()

        assert "# Security Policy" in result

    def test_config_generators_includes_reporting_instructions_are_included(
        self,
    ) -> None:
    ...
    def test_config_generators_includes_supported_versions_section_exists(
        self,
    ) -> None:
...
class TestGeneratePreCommitConfig:
    ...
    def test_config_generators_pre_commit_all_security_hooks_hooks_enabled(
        self,
    ) -> None:
    ...
    def test_config_generators_pre_commit_paranoid_extra_hooks(self) -> None:
    ...
    def test_config_generators_pre_commit_no_security_hooks_hooks_enabled(
        self,
    ) -> None:
