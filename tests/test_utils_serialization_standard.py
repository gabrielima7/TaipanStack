...
class TestDefaultEncoder:
    ...
    def test_utils_serialization_encode_ok_with_dict_standard_expected(self) -> None:
    ...
    def test_utils_serialization_encode_ok_with_scalar_standard_expected(self) -> None:
    ...
    def test_utils_serialization_encode_err_standard_expected(self) -> None:
        """Test encoding Err."""
    ...
    def test_utils_serialization_default_encoder_direct_type_error_standard_expected(
        self,
    ) -> None:
