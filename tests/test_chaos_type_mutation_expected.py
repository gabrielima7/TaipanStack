...
def test_rate_limiter_chaos_type_mutation_type_mutations():
...
def test_rate_limiter_chaos_type_mutation_new_tokens_expected():
    class CorruptFloat(float):
        def __mul__(self, other):
            raise RuntimeError("Chaos __mul__")
...
def test_rate_limiter_chaos_type_mutation_apply_tokens_expected():
    class CorruptFloat(float):
        def __add__(self, other):
            raise RuntimeError("Chaos __add__")
...
def test_rate_limiter_chaos_type_mutation_try_consume_expected():
    class CorruptFloat(float):
        def __ge__(self, other):
            raise RuntimeError("Chaos __ge__")
