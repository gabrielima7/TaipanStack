...
def test_chaos_retry_callback_retry_chaos_faulty_callback_execution_success():
...
def test_chaos_retry_callback_retry_chaos_faulty_callback_without_structlog_execution_success(
    monkeypatch,
):
    monkeypatch.setattr(
