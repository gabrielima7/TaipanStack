...
def test_security_sanitizers_additional_security_sanitizers_handle_normal_part():
    ...
    parts = []
    # Test safe_part == ".."
    with patch("taipanstack.security.sanitizers._is_safe_path_part", return_value=False):
...
def test_security_sanitizers_additional_security_sanitizers_process_path_part_dot():
