...
class TestValidateProjectName:
    ...
    def test_security_validators_name_must_start_with_letter(
        self,
    ) -> None:
    ...
    def test_security_validators_reserved_names_rejected(
        self,
    ) -> None:
...
class TestValidatePythonVersion:
    ...
    def test_security_validators_invalid_format_rejected(
        self,
    ) -> None:
    ...
    def test_security_validators_unsupported_version_rejected(
        self,
    ) -> None:
    ...
    def test_security_validators_massive_version_string_fuzzing(
        self,
    ) -> None:
...
class TestValidateUrl:
    ...
    def test_security_validators_missing_scheme_rejected(
        self,
    ) -> None:
    ...
    def test_security_validators_invalid_scheme_rejected(
        self,
    ) -> None:
...
def test_security_validators_type_error_message_for_tuple_expected_types() -> (
    None
):
