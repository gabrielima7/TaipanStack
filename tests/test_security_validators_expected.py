...
class TestValidateProjectName:
    ...
    def test_security_validators_name_must_start_with_letter_expected(
        self,
    ) -> None:
    ...
    def test_security_validators_reserved_names_rejected_expected(
        self,
    ) -> None:
...
class TestValidatePythonVersion:
    ...
    def test_security_validators_invalid_format_rejected_expected(
        self,
    ) -> None:
    ...
    def test_security_validators_unsupported_version_rejected_expected(
        self,
    ) -> None:
    ...
    def test_security_validators_massive_version_string_fuzzing_expected(
        self,
    ) -> None:
...
class TestValidateUrl:
    ...
    def test_security_validators_missing_scheme_rejected_expected(
        self,
    ) -> None:
    ...
    def test_security_validators_invalid_scheme_rejected_expected(
        self,
    ) -> None:
    ...
    def test_security_validators_invalid_format_parsing_error_expected(
        self,
    ) -> None:
    ...
    def test_security_validators_out_of_range_port_parsing_error_expected(
        self,
    ) -> None:
...
def test_security_validators_type_error_message_for_tuple_expected_types_expected() -> (
    None
):
