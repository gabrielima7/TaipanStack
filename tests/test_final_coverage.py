...
class TestGuardsComplete:
    ...
    def test_guard_env_variable_pattern_not_in_allowed_expected(
    ...
    def test_guard_env_variable_pattern_in_allowed_expected(
        self, monkeypatch: pytest.MonkeyPatch
    ) -> None:
...
class TestSubprocessComplete:
    ...
    def test_run_safe_command_with_all_options_expected(self) -> None:
        ...
        result = run_safe_command(
            ["echo", "hello"], timeout=30.0, capture_output=True, check=False
        )
...
class TestConfigModelsComplete:
    ...
    def test_stack_config_all_options_expected(self) -> None:
        ...
        config = StackConfig(
            project_name="myproject", python_version="3.11", dry_run=True, force=True
        )
