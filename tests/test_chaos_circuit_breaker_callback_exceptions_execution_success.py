...
def test_circuit_breaker_callback_exception_logging_execution_success():
...
def test_circuit_breaker_failure_count_property_execution_success():
    cb = CircuitBreaker()
...
def test_circuit_breaker_notify_state_change_no_callback_no_structlog_execution_success():
    cb = CircuitBreaker()
