...
def test_adaptive_breaker_evaluate_result_standard_expected():
...
def test_adaptive_breaker_reset_and_should_allow_standard_expected():
...
def test_adaptive_breaker_invalid_recovery_timeout_standard_expected():
    with pytest.raises(
...
def test_adaptive_breaker_evaluate_trip_returns_early_standard_expected():
...
def test_adaptive_breaker_evaluate_trip_with_half_open_standard_expected(monkeypatch):
    breaker = AdaptiveCircuitBreaker(recovery_timeout=0.0)
    breaker._state = CircuitState.OPEN
    breaker._last_opened_at = 0.0
...
def test_adaptive_breaker_evaluate_trip_with_min_throughput_standard_expected():
...
def test_adaptive_breaker_evaluate_trip_with_min_throughput_and_target_rate_standard_expected():
