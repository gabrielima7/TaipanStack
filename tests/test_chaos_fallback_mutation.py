...
@pytest.mark.asyncio
async def test_chaos_fallback_exceptions_tuple_mutation_async() -> (
    None
):
...
def test_chaos_fallback_exceptions_tuple_mutation_sync_result() -> (
    None
):
...
@pytest.mark.asyncio
async def test_chaos_fallback_exceptions_tuple_mutation_async_result() -> (
    None
):
