...
@pytest.mark.asyncio
async def test_chaos_fallback_mutation_chaos_fallback_exceptions_tuple_mutation_async() -> (
    None
):
...
@pytest.mark.asyncio
async def test_chaos_fallback_mutation_chaos_fallback_exceptions_tuple_mutation_async_result() -> (
    None
):
