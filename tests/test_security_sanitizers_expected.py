...
class TestSanitizeString:
    ...
    def test_security_sanitizers_empty_string_returns_empty(self) -> None:
        """Test empty string returns empty."""
        assert sanitize_string("") == ""

    def test_security_sanitizers_normal_string_unchanged_passes_through(
        self,
    ) -> None:
        """Test normal string passes through."""
        assert sanitize_string("Hello World") == "Hello World"

    def test_security_sanitizers_strips_whitespace_by_default(self) -> None:
    ...
    def test_security_sanitizers_strips_various_whitespace_stripped_correctly(
        self, whitespace: str
    ) -> None:
    ...
    def test_security_sanitizers_no_strip_whitespace_when_disabled(self) -> None:
        """Test whitespace preserved when disabled."""
        result = sanitize_string("  hello  ", strip_whitespace=False)
        assert result == "  hello  "

    def test_security_sanitizers_removes_null_bytes_are_removed(self) -> None:
        """Test null bytes are removed."""
        assert sanitize_string("hel\x00lo") == "hello"

    def test_security_sanitizers_removes_html_tags_by_default(self) -> None:
        """Test HTML tags are removed by default."""
        result = sanitize_string("<script>alert('xss')</script>")
        assert "<script>" not in result
        assert "alert" in result  # Text content preserved

    def test_security_sanitizers_allows_html_when_enabled_when_allowed(
        self,
    ) -> None:
    ...
    def test_security_sanitizers_removes_control_characters_are_removed(
        self,
    ) -> None:
    ...
    def test_security_sanitizers_preserves_newlines_are_preserved(self) -> None:
        """Test newlines are preserved."""
        result = sanitize_string("line1\nline2")
        assert "\n" in result

    def test_security_sanitizers_removes_unicode_when_disabled_not_allowed(
        self,
    ) -> None:
    ...
    def test_security_sanitizers_truncates_to_max_length_is_truncated(
        self,
    ) -> None:
    ...
    def test_security_sanitizers_escapes_html_entities_tag_removal(self) -> None:
...
class TestSanitizeFilename:
    ...
    def test_security_sanitizers_empty_filename_returns_unnamed(self) -> None:
        """Test empty filename returns 'unnamed'."""
        assert sanitize_filename("") == "unnamed"

    def test_security_sanitizers_normal_filename_passes_through(self) -> None:
        """Test normal filename passes through."""
        assert sanitize_filename("test.txt") == "test.txt"

    def test_security_sanitizers_removes_path_characters_are_removed(
        self,
    ) -> None:
    ...
    def test_security_sanitizers_removes_invalid_windows_chars_are_removed(
        self,
    ) -> None:
    ...
    def test_security_sanitizers_preserves_extension_by_default(self) -> None:
        """Test extension is preserved by default."""
        result = sanitize_filename("bad<file>name.txt")
        assert result.endswith(".txt")

    def test_security_sanitizers_no_preserve_extension_when_disabled(self) -> None:
        """Test extension not preserved when disabled."""
        result = sanitize_filename("test.txt", preserve_extension=False)
        assert result == "test"

    def test_security_sanitizers_handles_reserved_names_are_handled(self) -> None:
        """Test Windows reserved names are handled."""
        result = sanitize_filename("CON")
        assert result != "CON"
        assert result.upper() != "CON"

    def test_security_sanitizers_handles_dot_names_without_stripping(self) -> None:
    ...
    def test_security_sanitizers_max_length_with_extension_preserves_extension(
        self,
    ) -> None:
    ...
    def test_security_sanitizers_max_length_with_long_extension_than_maxlength(
        self,
    ) -> None:
    ...
    def test_security_sanitizers_custom_replacement_replacement_character(self) -> None:
        """Test custom replacement character."""
        result = sanitize_filename("bad:name.txt", replacement="-")
        assert ":" not in result
        assert "-" in result

    def test_security_sanitizers_collapses_multiple_replacements_single_replacement(
        self,
    ) -> None:
...
class TestSanitizePath:
    ...
    def test_security_sanitizers_sanitize_path_absolute_with_base_dir_is_given(
        self, tmp_path: Path
    ) -> None:
    ...
    def test_security_sanitizers_sanitize_path_absolute_with_parts_has_parts(
        self, tmp_path: Path
    ) -> None:
    ...
    def test_security_sanitizers_sanitize_path_empty_not_absolute(self) -> None:
    ...
    def test_security_sanitizers_simple_path_passes_through(self) -> None:
        """Test simple path passes through."""
        result = sanitize_path("test/file.txt")
        assert "test" in str(result)
        assert "file.txt" in str(result)

    def test_security_sanitizers_removes_traversal_is_removed(self) -> None:
    ...
    def test_security_sanitizers_max_depth_enforced_is_enforced(self) -> None:
        """Test max depth is enforced."""
        deep_path = "/".join(["dir"] * 20)
        with pytest.raises(ValueError, match="depth"):
            sanitize_path(deep_path, max_depth=5)

    def test_security_sanitizers_with_base_dir_base_directory(self, tmp_path: Path) -> None:
    ...
    def test_security_sanitizers_removes_parent_traversal_is_resolved(
        self,
    ) -> None:
    ...
    def test_security_sanitizers_removes_multiple_parent_traversals_parent_directories(
        self,
    ) -> None:
    ...
    def test_security_sanitizers_handles_empty_parts_after_sanitization(self) -> None:
    ...
    def test_security_sanitizers_handles_invalid_character_parts_invalid_characters(
        self,
    ) -> None:
    ...
    def test_security_sanitizers_resolve_with_base_dir_success_base_directory(
        self, tmp_path: Path
    ) -> None:
    ...
    def test_security_sanitizers_resolve_with_base_dir_error_on_error(
...
def test_security_sanitizers_sanitizers_re_error_coverage_on_reerror() -> None:
...
def test_security_sanitizers_sanitizers_re_error_coverage_no_slash_normal_replacement() -> None:
...
class TestSanitizerFallthrough:
    ...
    def test_security_sanitizers_sanitize_path_fallthroughs_path_sanitization(
        self,
    ) -> None:
