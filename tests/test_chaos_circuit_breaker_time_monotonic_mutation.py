...
def test_chaos_circuit_breaker_time_monotonic_mutation_survives_string_corruption(monkeypatch) -> None:
    cb = CircuitBreaker()
...
def test_chaos_circuit_breaker_time_monotonic_mutation_survives_none_corruption(monkeypatch) -> None:
    cb = CircuitBreaker()
    cb._state.state = CircuitState.OPEN
    cb._state.last_failure_time = 100.0
