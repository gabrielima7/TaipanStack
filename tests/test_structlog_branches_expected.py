...
class TestLoggingWithMockedStructlog:
    ...
    def test_structlog_branches_stack_logger_with_structured_true_and_usestructuredtrue(
        self,
    ) -> None:
    ...
    def test_structlog_branches_stack_logger_bind_with_structured_is_true(
        self,
    ) -> None:
    ...
    def test_structlog_branches_stack_logger_unbind_with_structured_is_true(
        self,
    ) -> None:
...
class TestSetupLoggingStructlog:
    ...
    def test_structlog_branches_setup_logging_with_structlog_and_usestructuredtrue(
        self,
    ) -> None:
...
class TestSubprocessTimeoutBranches:
    ...
    def test_structlog_branches_run_safe_command_with_failure_failing_command(
        self,
    ) -> None:
...
class TestGuardsRemainingBranches:
    ...
    def test_structlog_branches_guard_path_traversal_symlink_with_symlinks(
        self, tmp_path: Path
    ) -> None:
...
class TestFilesystemRemainingBranches:
    ...
    def test_structlog_branches_safe_write_create_parents_with_createparentstrue(self, tmp_path: Path) -> None:
    ...
    def test_structlog_branches_safe_write_atomic_with_existing_copies_permissions(
        self, tmp_path: Path
    ) -> None:
...
class TestSanitizersRemainingBranches:
    ...
    def test_structlog_branches_sanitize_path_absolute_absolute_path(self, tmp_path: Path) -> None:
    ...
    def test_structlog_branches_sanitize_path_relative_relative_path(self) -> None:
...
class TestValidatorsRemainingBranches:
    ...
    def test_structlog_branches_validate_project_name_starts_with_digit_with_digit(
        self,
    ) -> None:
    ...
    def test_structlog_branches_validate_project_name_max_length_maxlength_parameter(
        self,
    ) -> None:
