...
type_checking_block = """if TYPE_CHECKING:
    ...
    HttpxClientKwargs = dict  # type: ignore[misc, assignment]
    HttpxRequestKwargs = dict  # type: ignore[misc, assignment]
    HttpxSafeRequestKwargs = dict  # type: ignore[misc, assignment]
"""
...
# Fix __init__ kwarg passing to AsyncClient
content = content.replace(
    'self._client_kwargs.setdefault("timeout", 10.0)',
    'self._client_kwargs.setdefault("timeout", 10.0)  # type: ignore[misc]'
)
