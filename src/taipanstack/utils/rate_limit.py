...
def rate_limit(
    ...
    def decorator(
        ...
        if inspect.iscoroutinefunction(func):
            return _rate_limit_async_wrapper(
                cast(Callable[P, Awaitable[T]], func), limiter
            )

        return _rate_limit_sync_wrapper(cast(Callable[P, T], func), limiter)
