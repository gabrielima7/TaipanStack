...
def _check_traversal_patterns(path: Path) -> None:
...
def guard_path_traversal(
    ...
    *,
    ...
    _check_traversal_patterns(path)
...
def _check_env_denied(
    ...
    """Check if the environment variable name is explicitly denied."""
...
def _check_env_sensitive(
    ...
    """Check if the environment variable name matches sensitive patterns."""
...
def guard_env_variable(
    ...
    *,
    ...
    _check_env_denied(name, name_upper, denied_names)
    _check_env_sensitive(name, name_upper, allowed_names)
