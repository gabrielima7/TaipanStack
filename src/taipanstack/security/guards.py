...
# Pre-compiled static patterns for performance optimization
...
_DEFAULT_DENIED_EXTENSIONS: frozenset[str] = frozenset(
    (
        "exe",
        "dll",
        "so",
...
_DEFAULT_DENIED_ENV_VARS: frozenset[str] = frozenset(
    (
