...
class CircuitBreaker:
    ...
    def _get_failure_state_change(self) -> tuple[CircuitState, CircuitState] | None:
        """Get the state change resulting from a failure."""
    ...
    def _do_decrement_half_open(self) -> None:
        """Perform the actual decrement of half-open attempts."""
        try:
            if (
