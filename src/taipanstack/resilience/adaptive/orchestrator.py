...
class ResilienceOrchestrator(Generic[P, T]):
    ...
    def with_timeout(self, seconds: float) -> ResilienceOrchestrator[P, T]:
        """Add a timeout.
    ...
    def with_fallback(self, value: T) -> ResilienceOrchestrator[P, T]:
